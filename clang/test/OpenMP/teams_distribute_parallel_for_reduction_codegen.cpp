...
// CHECK2-NEXT:    call void @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l68(i64 [[TMP1]]) #[[ATTR2:[0-9]+]]
...
// CHECK4-NEXT:    call void @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l68(i32 [[TMP1]]) #[[ATTR2:[0-9]+]]
...
// CHECK9-NEXT:    [[TMP14:%.*]] = getelementptr inbounds [1 x i8*], [1 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 0
// CHECK9-NEXT:    [[TMP15:%.*]] = bitcast i32* [[SIVAR1]] to i8*
// CHECK9-NEXT:    store i8* [[TMP15]], i8** [[TMP14]], align 8
// CHECK9-NEXT:    [[TMP16:%.*]] = bitcast [1 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]] to i8*
// CHECK9-NEXT:    [[TMP17:%.*]] = call i32 @__kmpc_reduce_nowait(%struct.ident_t* @[[GLOB3:[0-9]+]], i32 [[TMP2]], i32 1, i64 8, i8* [[TMP16]], void (i8*, i8*)* @.omp.reduction.reduction_func.2, [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK9-NEXT:    switch i32 [[TMP17]], label [[DOTOMP_REDUCTION_DEFAULT:%.*]] [
// CHECK9-NEXT:    i32 1, label [[DOTOMP_REDUCTION_CASE1:%.*]]
// CHECK9-NEXT:    i32 2, label [[DOTOMP_REDUCTION_CASE2:%.*]]
// CHECK9-NEXT:    ]
// CHECK9:       .omp.reduction.case1:
// CHECK9-NEXT:    [[TMP18:%.*]] = load i32, i32* [[TMP0]], align 4
...
// CHECK9-NEXT:    [[TMP21:%.*]] = atomicrmw add i32* [[TMP0]], i32 [[TMP20]] monotonic, align 4
// CHECK9-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
...
// CHECK9-NEXT:    [[TMP16:%.*]] = bitcast i32* [[SIVAR2]] to i8*
// CHECK9-NEXT:    store i8* [[TMP16]], i8** [[TMP15]], align 8
// CHECK9-NEXT:    [[TMP17:%.*]] = bitcast [1 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]] to i8*
// CHECK9-NEXT:    [[TMP18:%.*]] = call i32 @__kmpc_reduce_nowait(%struct.ident_t* @[[GLOB3]], i32 [[TMP4]], i32 1, i64 8, i8* [[TMP17]], void (i8*, i8*)* @.omp.reduction.reduction_func, [8 x i32]* @.gomp_critical_user_.reduction.var)
...
// CHECK9-NEXT:    [[TMP20:%.*]] = load i32, i32* [[SIVAR2]], align 4
// CHECK9-NEXT:    [[ADD6:%.*]] = add nsw i32 [[TMP19]], [[TMP20]]
...
// CHECK9-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK9:       .omp.reduction.case2:
// CHECK9-NEXT:    [[TMP21:%.*]] = load i32, i32* [[SIVAR2]], align 4
...
// CHECK10-NEXT:    [[TMP14:%.*]] = getelementptr inbounds [1 x i8*], [1 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 0
// CHECK10-NEXT:    [[TMP15:%.*]] = bitcast i32* [[SIVAR1]] to i8*
// CHECK10-NEXT:    store i8* [[TMP15]], i8** [[TMP14]], align 8
// CHECK10-NEXT:    [[TMP16:%.*]] = bitcast [1 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]] to i8*
// CHECK10-NEXT:    [[TMP17:%.*]] = call i32 @__kmpc_reduce_nowait(%struct.ident_t* @[[GLOB3:[0-9]+]], i32 [[TMP2]], i32 1, i64 8, i8* [[TMP16]], void (i8*, i8*)* @.omp.reduction.reduction_func.2, [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK10-NEXT:    switch i32 [[TMP17]], label [[DOTOMP_REDUCTION_DEFAULT:%.*]] [
...
// CHECK10-NEXT:    [[TMP18:%.*]] = load i32, i32* [[TMP0]], align 4
// CHECK10-NEXT:    [[TMP19:%.*]] = load i32, i32* [[SIVAR1]], align 4
// CHECK10-NEXT:    [[ADD3:%.*]] = add nsw i32 [[TMP18]], [[TMP19]]
...
// CHECK10-NEXT:    [[TMP21:%.*]] = atomicrmw add i32* [[TMP0]], i32 [[TMP20]] monotonic, align 4
// CHECK10-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
...
// CHECK10-NEXT:    [[TMP16:%.*]] = bitcast i32* [[SIVAR2]] to i8*
// CHECK10-NEXT:    store i8* [[TMP16]], i8** [[TMP15]], align 8
// CHECK10-NEXT:    [[TMP17:%.*]] = bitcast [1 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]] to i8*
// CHECK10-NEXT:    [[TMP18:%.*]] = call i32 @__kmpc_reduce_nowait(%struct.ident_t* @[[GLOB3]], i32 [[TMP4]], i32 1, i64 8, i8* [[TMP17]], void (i8*, i8*)* @.omp.reduction.reduction_func, [8 x i32]* @.gomp_critical_user_.reduction.var)
...
// CHECK10-NEXT:    [[TMP20:%.*]] = load i32, i32* [[SIVAR2]], align 4
// CHECK10-NEXT:    [[ADD6:%.*]] = add nsw i32 [[TMP19]], [[TMP20]]
...
// CHECK10-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK10:       .omp.reduction.case2:
// CHECK10-NEXT:    [[TMP21:%.*]] = load i32, i32* [[SIVAR2]], align 4

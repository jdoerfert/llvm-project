...
// CHECK1-NEXT:    store double 1.000000e+00, double* [[G2]], align 8
// CHECK1-NEXT:    [[TMP13:%.*]] = load double*, double** [[_TMP4]], align 8
// CHECK1-NEXT:    store volatile double 1.000000e+00, double* [[TMP13]], align 8
// CHECK1-NEXT:    store i32 3, i32* [[SVAR5]], align 4
// CHECK1-NEXT:    store float 4.000000e+00, float* [[SFVAR6]], align 4
// CHECK1-NEXT:    [[TMP14:%.*]] = getelementptr inbounds [[CLASS_ANON_0]], %class.anon.0* [[REF_TMP]], i32 0, i32 0
// CHECK1-NEXT:    store double* [[G2]], double** [[TMP14]], align 8
...
// CHECK1-NEXT:    [[TMP22:%.*]] = load double, double* [[G2]], align 8
// CHECK1-NEXT:    store volatile double [[TMP22]], double* [[TMP0]], align 8
// CHECK1-NEXT:    [[TMP23:%.*]] = load double*, double** [[_TMP4]], align 8
// CHECK1-NEXT:    [[TMP24:%.*]] = load double, double* [[TMP23]], align 8
// CHECK1-NEXT:    store volatile double [[TMP24]], double* [[TMP4]], align 8
// CHECK1-NEXT:    [[TMP25:%.*]] = load i32, i32* [[SVAR5]], align 4
// CHECK1-NEXT:    store i32 [[TMP25]], i32* [[TMP2]], align 4
// CHECK1-NEXT:    [[TMP26:%.*]] = load float, float* [[SFVAR6]], align 4
...
// CHECK2-NEXT:    store double 1.000000e+00, double* [[G2]], align 8
// CHECK2-NEXT:    [[TMP13:%.*]] = load double*, double** [[_TMP4]], align 8
// CHECK2-NEXT:    store volatile double 1.000000e+00, double* [[TMP13]], align 8
// CHECK2-NEXT:    store i32 3, i32* [[SVAR5]], align 4
// CHECK2-NEXT:    store float 4.000000e+00, float* [[SFVAR6]], align 4
// CHECK2-NEXT:    [[TMP14:%.*]] = getelementptr inbounds [[CLASS_ANON_0]], %class.anon.0* [[REF_TMP]], i32 0, i32 0
// CHECK2-NEXT:    store double* [[G2]], double** [[TMP14]], align 8
...
// CHECK2-NEXT:    [[TMP22:%.*]] = load double, double* [[G2]], align 8
// CHECK2-NEXT:    store volatile double [[TMP22]], double* [[TMP0]], align 8
// CHECK2-NEXT:    [[TMP23:%.*]] = load double*, double** [[_TMP4]], align 8
// CHECK2-NEXT:    [[TMP24:%.*]] = load double, double* [[TMP23]], align 8
// CHECK2-NEXT:    store volatile double [[TMP24]], double* [[TMP4]], align 8
// CHECK2-NEXT:    [[TMP25:%.*]] = load i32, i32* [[SVAR5]], align 4
// CHECK2-NEXT:    store i32 [[TMP25]], i32* [[TMP2]], align 4
// CHECK2-NEXT:    [[TMP26:%.*]] = load float, float* [[SFVAR6]], align 4
...
// CHECK3-NEXT:    store volatile double [[TMP24]], double* [[TMP4]], align 4
...
// CHECK4-NEXT:    store volatile double [[TMP24]], double* [[TMP4]], align 4
...
// CHECK9-NEXT:    [[TMP14:%.*]] = load i32, i32* [[T_VAR2]], align 4
...
// CHECK9-NEXT:    [[TMP16:%.*]] = load %struct.S*, %struct.S** [[_TMP6]], align 8
...
// CHECK9-NEXT:    [[TMP28:%.*]] = bitcast [2 x %struct.S]* [[S_ARR4]] to %struct.S*
// CHECK9-NEXT:    [[TMP29:%.*]] = getelementptr [[STRUCT_S]], %struct.S* [[ARRAY_BEGIN12]], i64 2
// CHECK9-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq %struct.S* [[ARRAY_BEGIN12]], [[TMP29]]
...
// CHECK9-NEXT:    [[TMP32:%.*]] = load %struct.S*, %struct.S** [[_TMP6]], align 8
// CHECK9-NEXT:    [[TMP33:%.*]] = bitcast %struct.S* [[TMP5]] to i8*
...
// CHECK9-NEXT:    [[TMP35:%.*]] = load i32, i32* [[SVAR7]], align 4
...
// CHECK9-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK9-NEXT:    store i32 [[ADD]], i32* [[I]], align 4
// CHECK9-NEXT:    [[TMP13:%.*]] = load i32, i32* [[T_VAR2]], align 4
// CHECK9-NEXT:    [[TMP14:%.*]] = load i32, i32* [[I]], align 4
// CHECK9-NEXT:    [[IDXPROM:%.*]] = sext i32 [[TMP14]] to i64
// CHECK9-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], [2 x i32]* [[VEC3]], i64 0, i64 [[IDXPROM]]
// CHECK9-NEXT:    store i32 [[TMP13]], i32* [[ARRAYIDX]], align 4
// CHECK9-NEXT:    [[TMP15:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP6]], align 8
...
// CHECK9-NEXT:    [[TMP27:%.*]] = bitcast [2 x %struct.S.0]* [[S_ARR4]] to %struct.S.0*
// CHECK9-NEXT:    [[TMP28:%.*]] = getelementptr [[STRUCT_S_0]], %struct.S.0* [[ARRAY_BEGIN11]], i64 2
// CHECK9-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq %struct.S.0* [[ARRAY_BEGIN11]], [[TMP28]]
...
// CHECK9-NEXT:    [[TMP31:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP6]], align 8
// CHECK9-NEXT:    [[TMP32:%.*]] = bitcast %struct.S.0* [[TMP4]] to i8*
...
// CHECK10-NEXT:    [[TMP14:%.*]] = load i32, i32* [[T_VAR2]], align 4
...
// CHECK10-NEXT:    [[TMP16:%.*]] = load %struct.S*, %struct.S** [[_TMP6]], align 8
...
// CHECK10-NEXT:    [[TMP28:%.*]] = bitcast [2 x %struct.S]* [[S_ARR4]] to %struct.S*
// CHECK10-NEXT:    [[TMP29:%.*]] = getelementptr [[STRUCT_S]], %struct.S* [[ARRAY_BEGIN12]], i64 2
// CHECK10-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq %struct.S* [[ARRAY_BEGIN12]], [[TMP29]]
...
// CHECK10-NEXT:    [[TMP32:%.*]] = load %struct.S*, %struct.S** [[_TMP6]], align 8
// CHECK10-NEXT:    [[TMP33:%.*]] = bitcast %struct.S* [[TMP5]] to i8*
...
// CHECK10-NEXT:    [[TMP35:%.*]] = load i32, i32* [[SVAR7]], align 4
...
// CHECK10-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK10-NEXT:    store i32 [[ADD]], i32* [[I]], align 4
// CHECK10-NEXT:    [[TMP13:%.*]] = load i32, i32* [[T_VAR2]], align 4
// CHECK10-NEXT:    [[TMP14:%.*]] = load i32, i32* [[I]], align 4
// CHECK10-NEXT:    [[IDXPROM:%.*]] = sext i32 [[TMP14]] to i64
// CHECK10-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], [2 x i32]* [[VEC3]], i64 0, i64 [[IDXPROM]]
// CHECK10-NEXT:    store i32 [[TMP13]], i32* [[ARRAYIDX]], align 4
// CHECK10-NEXT:    [[TMP15:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP6]], align 8
...
// CHECK10-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP17]], i8* align 4 [[TMP18]], i64 4, i1 false)
// CHECK10-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK10:       omp.body.continue:
// CHECK10-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK10:       omp.inner.for.inc:
...
// CHECK10-NEXT:    [[TMP27:%.*]] = bitcast [2 x %struct.S.0]* [[S_ARR4]] to %struct.S.0*
// CHECK10-NEXT:    [[TMP28:%.*]] = getelementptr [[STRUCT_S_0]], %struct.S.0* [[ARRAY_BEGIN11]], i64 2
// CHECK10-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq %struct.S.0* [[ARRAY_BEGIN11]], [[TMP28]]
...
// CHECK10-NEXT:    [[TMP31:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP6]], align 8
// CHECK10-NEXT:    [[TMP32:%.*]] = bitcast %struct.S.0* [[TMP4]] to i8*
...
// CHECK11-NEXT:    [[TMP14:%.*]] = load i32, i32* [[T_VAR2]], align 4
...
// CHECK11-NEXT:    store i32 [[TMP14]], i32* [[ARRAYIDX]], align 4
// CHECK11-NEXT:    [[TMP16:%.*]] = load %struct.S*, %struct.S** [[_TMP6]], align 4
...
// CHECK11-NEXT:    store i32 [[TMP25]], i32* [[TMP1]], align 4
...
// CHECK11-NEXT:    [[TMP33:%.*]] = bitcast %struct.S* [[TMP5]] to i8*
...
// CHECK11-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK11-NEXT:    store i32 [[ADD]], i32* [[I]], align 4
// CHECK11-NEXT:    [[TMP13:%.*]] = load i32, i32* [[T_VAR2]], align 4
...
// CHECK11-NEXT:    store i32 [[TMP13]], i32* [[ARRAYIDX]], align 4
// CHECK11-NEXT:    [[TMP15:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP6]], align 4
...
// CHECK11-NEXT:    [[TMP27:%.*]] = bitcast [2 x %struct.S.0]* [[S_ARR4]] to %struct.S.0*
// CHECK11-NEXT:    [[TMP28:%.*]] = getelementptr [[STRUCT_S_0]], %struct.S.0* [[ARRAY_BEGIN10]], i32 2
// CHECK11-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq %struct.S.0* [[ARRAY_BEGIN10]], [[TMP28]]
...
// CHECK11-NEXT:    [[TMP31:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP6]], align 4
// CHECK11-NEXT:    [[TMP32:%.*]] = bitcast %struct.S.0* [[TMP4]] to i8*
...
// CHECK12-NEXT:    [[TMP14:%.*]] = load i32, i32* [[T_VAR2]], align 4
...
// CHECK12-NEXT:    [[TMP16:%.*]] = load %struct.S*, %struct.S** [[_TMP6]], align 4
...
// CHECK12-NEXT:    store i32 [[TMP25]], i32* [[TMP1]], align 4
...
// CHECK12-NEXT:    [[TMP33:%.*]] = bitcast %struct.S* [[TMP5]] to i8*
...
// CHECK12-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK12-NEXT:    store i32 [[ADD]], i32* [[I]], align 4
// CHECK12-NEXT:    [[TMP13:%.*]] = load i32, i32* [[T_VAR2]], align 4
...
// CHECK12-NEXT:    store i32 [[TMP13]], i32* [[ARRAYIDX]], align 4
// CHECK12-NEXT:    [[TMP15:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP6]], align 4
...
// CHECK12-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 4 [[TMP17]], i8* align 4 [[TMP18]], i32 4, i1 false)
// CHECK12-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK12:       omp.body.continue:
// CHECK12-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK12:       omp.inner.for.inc:
...
// CHECK12-NEXT:    [[TMP27:%.*]] = bitcast [2 x %struct.S.0]* [[S_ARR4]] to %struct.S.0*
// CHECK12-NEXT:    [[TMP28:%.*]] = getelementptr [[STRUCT_S_0]], %struct.S.0* [[ARRAY_BEGIN10]], i32 2
// CHECK12-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq %struct.S.0* [[ARRAY_BEGIN10]], [[TMP28]]
...
// CHECK12-NEXT:    [[TMP31:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP6]], align 4
// CHECK12-NEXT:    [[TMP32:%.*]] = bitcast %struct.S.0* [[TMP4]] to i8*

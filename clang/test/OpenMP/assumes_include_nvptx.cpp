...
// CHECK: %call = call float @_Z3sinf(float 0.000000e+00) [[attr2:#[0-9]*]]
// CHECK: declare i32 @__kmpc_target_init
// CHECK-NOT: #
...
// CHECK: %call = call double @_Z3sind(double 0.000000e+00) [[attr2]]

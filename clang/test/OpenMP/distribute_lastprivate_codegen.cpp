...
// CHECK1-NEXT:    [[TMP23:%.*]] = load double, double* [[G3]], align 8
// CHECK1-NEXT:    store volatile double [[TMP23]], double* [[TMP0]], align 8
// CHECK1-NEXT:    [[TMP24:%.*]] = load double*, double** [[_TMP5]], align 8
// CHECK1-NEXT:    [[TMP25:%.*]] = load double, double* [[TMP24]], align 8
// CHECK1-NEXT:    store volatile double [[TMP25]], double* [[TMP5]], align 8
// CHECK1-NEXT:    [[TMP26:%.*]] = load i32, i32* [[SVAR6]], align 4
// CHECK1-NEXT:    store i32 [[TMP26]], i32* [[TMP2]], align 4
// CHECK1-NEXT:    [[TMP27:%.*]] = load float, float* [[SFVAR7]], align 4
...
// CHECK2-NEXT:    [[TMP23:%.*]] = load double, double* [[G3]], align 8
// CHECK2-NEXT:    store volatile double [[TMP23]], double* [[TMP0]], align 8
// CHECK2-NEXT:    [[TMP24:%.*]] = load double*, double** [[_TMP5]], align 8
// CHECK2-NEXT:    [[TMP25:%.*]] = load double, double* [[TMP24]], align 8
// CHECK2-NEXT:    store volatile double [[TMP25]], double* [[TMP5]], align 8
// CHECK2-NEXT:    [[TMP26:%.*]] = load i32, i32* [[SVAR6]], align 4
// CHECK2-NEXT:    store i32 [[TMP26]], i32* [[TMP2]], align 4
// CHECK2-NEXT:    [[TMP27:%.*]] = load float, float* [[SFVAR7]], align 4
...
// CHECK3-NEXT:    [[TMP23:%.*]] = load double, double* [[G3]], align 8
// CHECK3-NEXT:    store volatile double [[TMP23]], double* [[TMP0]], align 8
// CHECK3-NEXT:    [[TMP24:%.*]] = load double*, double** [[_TMP5]], align 4
// CHECK3-NEXT:    [[TMP25:%.*]] = load double, double* [[TMP24]], align 4
// CHECK3-NEXT:    store volatile double [[TMP25]], double* [[TMP5]], align 4
// CHECK3-NEXT:    [[TMP26:%.*]] = load i32, i32* [[SVAR6]], align 4
// CHECK3-NEXT:    store i32 [[TMP26]], i32* [[TMP2]], align 4
// CHECK3-NEXT:    [[TMP27:%.*]] = load float, float* [[SFVAR7]], align 4
// CHECK3-NEXT:    store float [[TMP27]], float* [[TMP3]], align 4
...
// CHECK4-NEXT:    [[TMP23:%.*]] = load double, double* [[G3]], align 8
// CHECK4-NEXT:    store volatile double [[TMP23]], double* [[TMP0]], align 8
// CHECK4-NEXT:    [[TMP24:%.*]] = load double*, double** [[_TMP5]], align 4
// CHECK4-NEXT:    [[TMP25:%.*]] = load double, double* [[TMP24]], align 4
// CHECK4-NEXT:    store volatile double [[TMP25]], double* [[TMP5]], align 4
// CHECK4-NEXT:    [[TMP26:%.*]] = load i32, i32* [[SVAR6]], align 4
// CHECK4-NEXT:    store i32 [[TMP26]], i32* [[TMP2]], align 4
// CHECK4-NEXT:    [[TMP27:%.*]] = load float, float* [[SFVAR7]], align 4
// CHECK4-NEXT:    store float [[TMP27]], float* [[TMP3]], align 4
...
// CHECK9-NEXT:    [[TMP29:%.*]] = bitcast [2 x %struct.S]* [[S_ARR5]] to %struct.S*
// CHECK9-NEXT:    [[TMP30:%.*]] = getelementptr [[STRUCT_S]], %struct.S* [[ARRAY_BEGIN13]], i64 2
// CHECK9-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq %struct.S* [[ARRAY_BEGIN13]], [[TMP30]]
...
// CHECK9-NEXT:    [[TMP33:%.*]] = load %struct.S*, %struct.S** [[_TMP7]], align 8
// CHECK9-NEXT:    [[TMP34:%.*]] = bitcast %struct.S* [[TMP6]] to i8*
...
// CHECK9-NEXT:    [[TMP36:%.*]] = load i32, i32* [[SVAR8]], align 4
...
// CHECK9-NEXT:    [[TMP37:%.*]] = getelementptr inbounds [[STRUCT_S]], %struct.S* [[ARRAY_BEGIN15]], i64 2
// CHECK9-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK9:       arraydestroy.body:
...
// CHECK9-NEXT:    [[TMP28:%.*]] = bitcast [2 x %struct.S.0]* [[S_ARR5]] to %struct.S.0*
// CHECK9-NEXT:    [[TMP29:%.*]] = getelementptr [[STRUCT_S_0]], %struct.S.0* [[ARRAY_BEGIN12]], i64 2
// CHECK9-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq %struct.S.0* [[ARRAY_BEGIN12]], [[TMP29]]
...
// CHECK9-NEXT:    [[TMP32:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP7]], align 8
// CHECK9-NEXT:    [[TMP33:%.*]] = bitcast %struct.S.0* [[TMP5]] to i8*
...
// CHECK9-NEXT:    [[TMP35:%.*]] = getelementptr inbounds [[STRUCT_S_0]], %struct.S.0* [[ARRAY_BEGIN14]], i64 2
// CHECK9-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK9:       arraydestroy.body:
...
// CHECK10-NEXT:    call void @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l98(i64 [[TMP3]], [2 x i32]* [[VEC]], [2 x %struct.S]* [[S_ARR]], %struct.S* [[TMP4]], i64 [[TMP6]]) #[[ATTR4:[0-9]+]]
...
// CHECK10-NEXT:    [[TMP29:%.*]] = bitcast [2 x %struct.S]* [[S_ARR5]] to %struct.S*
// CHECK10-NEXT:    [[TMP30:%.*]] = getelementptr [[STRUCT_S]], %struct.S* [[ARRAY_BEGIN13]], i64 2
// CHECK10-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq %struct.S* [[ARRAY_BEGIN13]], [[TMP30]]
...
// CHECK10-NEXT:    [[TMP33:%.*]] = load %struct.S*, %struct.S** [[_TMP7]], align 8
// CHECK10-NEXT:    [[TMP34:%.*]] = bitcast %struct.S* [[TMP6]] to i8*
...
// CHECK10-NEXT:    [[TMP36:%.*]] = load i32, i32* [[SVAR8]], align 4
...
// CHECK10-NEXT:    [[TMP37:%.*]] = getelementptr inbounds [[STRUCT_S]], %struct.S* [[ARRAY_BEGIN15]], i64 2
// CHECK10-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK10:       arraydestroy.body:
...
// CHECK10-NEXT:    [[TMP28:%.*]] = bitcast [2 x %struct.S.0]* [[S_ARR5]] to %struct.S.0*
// CHECK10-NEXT:    [[TMP29:%.*]] = getelementptr [[STRUCT_S_0]], %struct.S.0* [[ARRAY_BEGIN12]], i64 2
// CHECK10-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq %struct.S.0* [[ARRAY_BEGIN12]], [[TMP29]]
...
// CHECK10-NEXT:    [[TMP32:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP7]], align 8
// CHECK10-NEXT:    [[TMP33:%.*]] = bitcast %struct.S.0* [[TMP5]] to i8*
...
// CHECK10-NEXT:    [[TMP35:%.*]] = getelementptr inbounds [[STRUCT_S_0]], %struct.S.0* [[ARRAY_BEGIN14]], i64 2
// CHECK10-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK10:       arraydestroy.body:
...
// CHECK11-NEXT:    store i32 [[TMP26]], i32* [[TMP0]], align 4
// CHECK11-NEXT:    [[TMP27:%.*]] = bitcast [2 x i32]* [[TMP1]] to i8*
// CHECK11-NEXT:    [[TMP28:%.*]] = bitcast [2 x i32]* [[VEC4]] to i8*
...
// CHECK11-NEXT:    [[TMP29:%.*]] = bitcast [2 x %struct.S]* [[S_ARR5]] to %struct.S*
// CHECK11-NEXT:    [[TMP30:%.*]] = getelementptr [[STRUCT_S]], %struct.S* [[ARRAY_BEGIN12]], i32 2
// CHECK11-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq %struct.S* [[ARRAY_BEGIN12]], [[TMP30]]
// CHECK11-NEXT:    br i1 [[OMP_ARRAYCPY_ISEMPTY]], label [[OMP_ARRAYCPY_DONE13:%.*]], label [[OMP_ARRAYCPY_BODY:%.*]]
// CHECK11:       omp.arraycpy.body:
// CHECK11-NEXT:    [[OMP_ARRAYCPY_SRCELEMENTPAST:%.*]] = phi %struct.S* [ [[TMP29]], [[DOTOMP_LASTPRIVATE_THEN]] ], [ [[OMP_ARRAYCPY_SRC_ELEMENT:%.*]], [[OMP_ARRAYCPY_BODY]] ]
...
// CHECK11-NEXT:    [[TMP31:%.*]] = bitcast %struct.S* [[OMP_ARRAYCPY_DESTELEMENTPAST]] to i8*
// CHECK11-NEXT:    [[TMP32:%.*]] = bitcast %struct.S* [[OMP_ARRAYCPY_SRCELEMENTPAST]] to i8*
...
// CHECK11-NEXT:    [[OMP_ARRAYCPY_DONE:%.*]] = icmp eq %struct.S* [[OMP_ARRAYCPY_DEST_ELEMENT]], [[TMP30]]
// CHECK11-NEXT:    br i1 [[OMP_ARRAYCPY_DONE]], label [[OMP_ARRAYCPY_DONE13]], label [[OMP_ARRAYCPY_BODY]]
// CHECK11:       omp.arraycpy.done13:
// CHECK11-NEXT:    [[TMP33:%.*]] = load %struct.S*, %struct.S** [[_TMP7]], align 4
// CHECK11-NEXT:    [[TMP34:%.*]] = bitcast %struct.S* [[TMP6]] to i8*
// CHECK11-NEXT:    [[TMP35:%.*]] = bitcast %struct.S* [[TMP33]] to i8*
// CHECK11-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 4 [[TMP34]], i8* align 4 [[TMP35]], i32 4, i1 false)
// CHECK11-NEXT:    [[TMP36:%.*]] = load i32, i32* [[SVAR8]], align 4
// CHECK11-NEXT:    store i32 [[TMP36]], i32* [[TMP4]], align 4
...
// CHECK11-NEXT:    [[TMP37:%.*]] = getelementptr inbounds [[STRUCT_S]], %struct.S* [[ARRAY_BEGIN14]], i32 2
// CHECK11-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK11:       arraydestroy.body:
// CHECK11-NEXT:    [[ARRAYDESTROY_ELEMENTPAST:%.*]] = phi %struct.S* [ [[TMP37]], [[DOTOMP_LASTPRIVATE_DONE]] ], [ [[ARRAYDESTROY_ELEMENT:%.*]], [[ARRAYDESTROY_BODY]] ]
// CHECK11-NEXT:    [[ARRAYDESTROY_ELEMENT]] = getelementptr inbounds [[STRUCT_S]], %struct.S* [[ARRAYDESTROY_ELEMENTPAST]], i32 -1
// CHECK11-NEXT:    call void @_ZN1SIfED1Ev(%struct.S* nonnull align 4 dereferenceable(4) [[ARRAYDESTROY_ELEMENT]]) #[[ATTR4]]
...
// CHECK11-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK11-NEXT:    store i32 [[ADD]], i32* [[I]], align 4
// CHECK11-NEXT:    [[TMP14:%.*]] = load i32, i32* [[T_VAR3]], align 4
...
// CHECK11-NEXT:    [[TMP16:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP7]], align 4
...
// CHECK11-NEXT:    [[TMP28:%.*]] = bitcast [2 x %struct.S.0]* [[S_ARR5]] to %struct.S.0*
// CHECK11-NEXT:    [[TMP29:%.*]] = getelementptr [[STRUCT_S_0]], %struct.S.0* [[ARRAY_BEGIN11]], i32 2
// CHECK11-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq %struct.S.0* [[ARRAY_BEGIN11]], [[TMP29]]
...
// CHECK11-NEXT:    [[TMP32:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP7]], align 4
// CHECK11-NEXT:    [[TMP33:%.*]] = bitcast %struct.S.0* [[TMP5]] to i8*
...
// CHECK11-NEXT:    [[TMP35:%.*]] = getelementptr inbounds [[STRUCT_S_0]], %struct.S.0* [[ARRAY_BEGIN13]], i32 2
// CHECK11-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK11:       arraydestroy.body:
...
// CHECK12-NEXT:    call void @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}_main_l98(i32 [[TMP3]], [2 x i32]* [[VEC]], [2 x %struct.S]* [[S_ARR]], %struct.S* [[TMP4]], i32 [[TMP6]]) #[[ATTR4:[0-9]+]]
...
// CHECK12-NEXT:    [[TMP26:%.*]] = load i32, i32* [[T_VAR3]], align 4
// CHECK12-NEXT:    store i32 [[TMP26]], i32* [[TMP0]], align 4
// CHECK12-NEXT:    [[TMP27:%.*]] = bitcast [2 x i32]* [[TMP1]] to i8*
// CHECK12-NEXT:    [[TMP28:%.*]] = bitcast [2 x i32]* [[VEC4]] to i8*
...
// CHECK12-NEXT:    [[TMP29:%.*]] = bitcast [2 x %struct.S]* [[S_ARR5]] to %struct.S*
// CHECK12-NEXT:    [[TMP30:%.*]] = getelementptr [[STRUCT_S]], %struct.S* [[ARRAY_BEGIN12]], i32 2
// CHECK12-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq %struct.S* [[ARRAY_BEGIN12]], [[TMP30]]
// CHECK12-NEXT:    br i1 [[OMP_ARRAYCPY_ISEMPTY]], label [[OMP_ARRAYCPY_DONE13:%.*]], label [[OMP_ARRAYCPY_BODY:%.*]]
// CHECK12:       omp.arraycpy.body:
// CHECK12-NEXT:    [[OMP_ARRAYCPY_SRCELEMENTPAST:%.*]] = phi %struct.S* [ [[TMP29]], [[DOTOMP_LASTPRIVATE_THEN]] ], [ [[OMP_ARRAYCPY_SRC_ELEMENT:%.*]], [[OMP_ARRAYCPY_BODY]] ]
...
// CHECK12-NEXT:    [[TMP31:%.*]] = bitcast %struct.S* [[OMP_ARRAYCPY_DESTELEMENTPAST]] to i8*
// CHECK12-NEXT:    [[TMP32:%.*]] = bitcast %struct.S* [[OMP_ARRAYCPY_SRCELEMENTPAST]] to i8*
...
// CHECK12-NEXT:    [[OMP_ARRAYCPY_DONE:%.*]] = icmp eq %struct.S* [[OMP_ARRAYCPY_DEST_ELEMENT]], [[TMP30]]
// CHECK12-NEXT:    br i1 [[OMP_ARRAYCPY_DONE]], label [[OMP_ARRAYCPY_DONE13]], label [[OMP_ARRAYCPY_BODY]]
// CHECK12:       omp.arraycpy.done13:
// CHECK12-NEXT:    [[TMP33:%.*]] = load %struct.S*, %struct.S** [[_TMP7]], align 4
// CHECK12-NEXT:    [[TMP34:%.*]] = bitcast %struct.S* [[TMP6]] to i8*
// CHECK12-NEXT:    [[TMP35:%.*]] = bitcast %struct.S* [[TMP33]] to i8*
// CHECK12-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 4 [[TMP34]], i8* align 4 [[TMP35]], i32 4, i1 false)
// CHECK12-NEXT:    [[TMP36:%.*]] = load i32, i32* [[SVAR8]], align 4
// CHECK12-NEXT:    store i32 [[TMP36]], i32* [[TMP4]], align 4
...
// CHECK12-NEXT:    [[TMP37:%.*]] = getelementptr inbounds [[STRUCT_S]], %struct.S* [[ARRAY_BEGIN14]], i32 2
// CHECK12-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK12:       arraydestroy.body:
// CHECK12-NEXT:    [[ARRAYDESTROY_ELEMENTPAST:%.*]] = phi %struct.S* [ [[TMP37]], [[DOTOMP_LASTPRIVATE_DONE]] ], [ [[ARRAYDESTROY_ELEMENT:%.*]], [[ARRAYDESTROY_BODY]] ]
// CHECK12-NEXT:    [[ARRAYDESTROY_ELEMENT]] = getelementptr inbounds [[STRUCT_S]], %struct.S* [[ARRAYDESTROY_ELEMENTPAST]], i32 -1
// CHECK12-NEXT:    call void @_ZN1SIfED1Ev(%struct.S* nonnull align 4 dereferenceable(4) [[ARRAYDESTROY_ELEMENT]]) #[[ATTR4]]
...
// CHECK12-NEXT:    [[TMP28:%.*]] = bitcast [2 x %struct.S.0]* [[S_ARR5]] to %struct.S.0*
// CHECK12-NEXT:    [[TMP29:%.*]] = getelementptr [[STRUCT_S_0]], %struct.S.0* [[ARRAY_BEGIN11]], i32 2
// CHECK12-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq %struct.S.0* [[ARRAY_BEGIN11]], [[TMP29]]
...
// CHECK12-NEXT:    [[TMP32:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP7]], align 4
// CHECK12-NEXT:    [[TMP33:%.*]] = bitcast %struct.S.0* [[TMP5]] to i8*
...
// CHECK12-NEXT:    [[TMP35:%.*]] = getelementptr inbounds [[STRUCT_S_0]], %struct.S.0* [[ARRAY_BEGIN13]], i32 2
// CHECK12-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK12:       arraydestroy.body:

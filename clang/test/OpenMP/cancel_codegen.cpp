...
// OMP_IRB-NEXT:    [[DOTOMP_SECTIONS_LB_14:%.*]] = alloca i32, align 4
// OMP_IRB-NEXT:    [[DOTOMP_SECTIONS_UB_15:%.*]] = alloca i32, align 4
// OMP_IRB-NEXT:    [[DOTOMP_SECTIONS_ST_16:%.*]] = alloca i32, align 4
// OMP_IRB-NEXT:    [[DOTOMP_SECTIONS_IL_17:%.*]] = alloca i32, align 4
// OMP_IRB-NEXT:    [[DOTOMP_SECTIONS_IV_18:%.*]] = alloca i32, align 4
...
// OMP_IRB-NEXT:    [[DOTCAPTURE_EXPR_40:%.*]] = alloca i32, align 4
...
// OMP_IRB-NEXT:    [[I43:%.*]] = alloca i32, align 4
...
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM9:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB5:[0-9]+]])
// OMP_IRB-NEXT:    call void @__kmpc_for_static_init_4(%struct.ident_t* @[[GLOB3:[0-9]+]], i32 [[OMP_GLOBAL_THREAD_NUM9]], i32 34, i32* [[DOTOMP_SECTIONS_IL_]], i32* [[DOTOMP_SECTIONS_LB_]], i32* [[DOTOMP_SECTIONS_UB_]], i32* [[DOTOMP_SECTIONS_ST_]], i32 1, i32 1)
...
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM10:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB7:[0-9]+]])
// OMP_IRB-NEXT:    [[TMP7:%.*]] = call i32 @__kmpc_cancel(%struct.ident_t* @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM10]], i32 3)
// OMP_IRB-NEXT:    [[TMP8:%.*]] = icmp ne i32 [[TMP7]], 0
// OMP_IRB-NEXT:    br i1 [[TMP8]], label [[DOTCANCEL_EXIT:%.*]], label [[DOTCANCEL_CONTINUE:%.*]]
// OMP_IRB:       .cancel.exit:
...
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM12:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB9:[0-9]+]])
// OMP_IRB-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB3]], i32 [[OMP_GLOBAL_THREAD_NUM12]])
// OMP_IRB-NEXT:    br label [[CANCEL_CONT:%.*]]
// OMP_IRB:       cancel.cont:
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM13:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB1]])
// OMP_IRB-NEXT:    call void @__kmpc_barrier(%struct.ident_t* @[[GLOB10:[0-9]+]], i32 [[OMP_GLOBAL_THREAD_NUM13]])
// OMP_IRB-NEXT:    store i32 0, i32* [[DOTOMP_SECTIONS_LB_14]], align 4
// OMP_IRB-NEXT:    store i32 1, i32* [[DOTOMP_SECTIONS_UB_15]], align 4
// OMP_IRB-NEXT:    store i32 1, i32* [[DOTOMP_SECTIONS_ST_16]], align 4
// OMP_IRB-NEXT:    store i32 0, i32* [[DOTOMP_SECTIONS_IL_17]], align 4
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM19:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB12:[0-9]+]])
// OMP_IRB-NEXT:    call void @__kmpc_for_static_init_4(%struct.ident_t* @[[GLOB3]], i32 [[OMP_GLOBAL_THREAD_NUM19]], i32 34, i32* [[DOTOMP_SECTIONS_IL_17]], i32* [[DOTOMP_SECTIONS_LB_14]], i32* [[DOTOMP_SECTIONS_UB_15]], i32* [[DOTOMP_SECTIONS_ST_16]], i32 1, i32 1)
// OMP_IRB-NEXT:    [[TMP10:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_UB_15]], align 4
// OMP_IRB-NEXT:    [[TMP11:%.*]] = icmp slt i32 [[TMP10]], 1
// OMP_IRB-NEXT:    [[TMP12:%.*]] = select i1 [[TMP11]], i32 [[TMP10]], i32 1
// OMP_IRB-NEXT:    store i32 [[TMP12]], i32* [[DOTOMP_SECTIONS_UB_15]], align 4
// OMP_IRB-NEXT:    [[TMP13:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_LB_14]], align 4
// OMP_IRB-NEXT:    store i32 [[TMP13]], i32* [[DOTOMP_SECTIONS_IV_18]], align 4
// OMP_IRB-NEXT:    br label [[OMP_INNER_FOR_COND20:%.*]]
// OMP_IRB:       omp.inner.for.cond20:
// OMP_IRB-NEXT:    [[TMP14:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_IV_18]], align 4
// OMP_IRB-NEXT:    [[TMP15:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_UB_15]], align 4
// OMP_IRB-NEXT:    [[CMP21:%.*]] = icmp sle i32 [[TMP14]], [[TMP15]]
// OMP_IRB-NEXT:    br i1 [[CMP21]], label [[OMP_INNER_FOR_BODY22:%.*]], label [[OMP_INNER_FOR_END34:%.*]]
// OMP_IRB:       omp.inner.for.body22:
// OMP_IRB-NEXT:    [[TMP16:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_IV_18]], align 4
// OMP_IRB-NEXT:    switch i32 [[TMP16]], label [[DOTOMP_SECTIONS_EXIT31:%.*]] [
// OMP_IRB-NEXT:    i32 0, label [[DOTOMP_SECTIONS_CASE23:%.*]]
// OMP_IRB-NEXT:    i32 1, label [[DOTOMP_SECTIONS_CASE27:%.*]]
// OMP_IRB-NEXT:    ]
// OMP_IRB:       .omp.sections.case23:
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM24:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB14:[0-9]+]])
// OMP_IRB-NEXT:    [[TMP17:%.*]] = call i32 @__kmpc_cancel(%struct.ident_t* @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM24]], i32 3)
// OMP_IRB-NEXT:    [[TMP18:%.*]] = icmp ne i32 [[TMP17]], 0
// OMP_IRB-NEXT:    br i1 [[TMP18]], label [[DOTCANCEL_EXIT25:%.*]], label [[DOTCANCEL_CONTINUE26:%.*]]
// OMP_IRB:       .cancel.exit25:
// OMP_IRB-NEXT:    br label [[CANCEL_EXIT35:%.*]]
// OMP_IRB:       cancel.exit:
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM11:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB9]])
// OMP_IRB-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB3]], i32 [[OMP_GLOBAL_THREAD_NUM11]])
// OMP_IRB-NEXT:    br label [[CANCEL_CONT]]
// OMP_IRB:       .cancel.continue26:
// OMP_IRB-NEXT:    br label [[DOTOMP_SECTIONS_EXIT31]]
// OMP_IRB:       .omp.sections.case27:
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM28:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB16:[0-9]+]])
// OMP_IRB-NEXT:    [[TMP19:%.*]] = call i32 @__kmpc_cancel(%struct.ident_t* @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM28]], i32 3)
// OMP_IRB-NEXT:    [[TMP20:%.*]] = icmp ne i32 [[TMP19]], 0
// OMP_IRB-NEXT:    br i1 [[TMP20]], label [[DOTCANCEL_EXIT29:%.*]], label [[DOTCANCEL_CONTINUE30:%.*]]
// OMP_IRB:       .cancel.exit29:
// OMP_IRB-NEXT:    br label [[CANCEL_EXIT35]]
// OMP_IRB:       .cancel.continue30:
// OMP_IRB-NEXT:    br label [[DOTOMP_SECTIONS_EXIT31]]
// OMP_IRB:       .omp.sections.exit31:
// OMP_IRB-NEXT:    br label [[OMP_INNER_FOR_INC32:%.*]]
// OMP_IRB:       omp.inner.for.inc32:
// OMP_IRB-NEXT:    [[TMP21:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_IV_18]], align 4
// OMP_IRB-NEXT:    [[INC33:%.*]] = add nsw i32 [[TMP21]], 1
// OMP_IRB-NEXT:    store i32 [[INC33]], i32* [[DOTOMP_SECTIONS_IV_18]], align 4
// OMP_IRB-NEXT:    br label [[OMP_INNER_FOR_COND20]]
// OMP_IRB:       omp.inner.for.end34:
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM37:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB18:[0-9]+]])
// OMP_IRB-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB3]], i32 [[OMP_GLOBAL_THREAD_NUM37]])
// OMP_IRB-NEXT:    br label [[CANCEL_CONT38:%.*]]
// OMP_IRB:       cancel.cont38:
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM39:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB1]])
// OMP_IRB-NEXT:    call void @__kmpc_barrier(%struct.ident_t* @[[GLOB10]], i32 [[OMP_GLOBAL_THREAD_NUM39]])
// OMP_IRB-NEXT:    [[TMP22:%.*]] = load i32, i32* [[ARGC_ADDR]], align 4
// OMP_IRB-NEXT:    store i32 [[TMP22]], i32* [[DOTCAPTURE_EXPR_]], align 4
// OMP_IRB-NEXT:    [[TMP23:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// OMP_IRB-NEXT:    [[SUB:%.*]] = sub nsw i32 [[TMP23]], 0
// OMP_IRB-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB]], 1
// OMP_IRB-NEXT:    [[SUB41:%.*]] = sub nsw i32 [[DIV]], 1
// OMP_IRB-NEXT:    store i32 [[SUB41]], i32* [[DOTCAPTURE_EXPR_40]], align 4
// OMP_IRB-NEXT:    store i32 0, i32* [[I]], align 4
// OMP_IRB-NEXT:    [[TMP24:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// OMP_IRB-NEXT:    [[CMP42:%.*]] = icmp slt i32 0, [[TMP24]]
// OMP_IRB-NEXT:    br i1 [[CMP42]], label [[OMP_PRECOND_THEN:%.*]], label [[OMP_PRECOND_END:%.*]]
// OMP_IRB:       omp.precond.then:
// OMP_IRB-NEXT:    store i32 0, i32* [[DOTOMP_LB]], align 4
// OMP_IRB-NEXT:    [[TMP25:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_40]], align 4
// OMP_IRB-NEXT:    store i32 [[TMP25]], i32* [[DOTOMP_UB]], align 4
// OMP_IRB-NEXT:    store i32 1, i32* [[DOTOMP_STRIDE]], align 4
// OMP_IRB-NEXT:    store i32 0, i32* [[DOTOMP_IS_LAST]], align 4
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM44:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB21:[0-9]+]])
// OMP_IRB-NEXT:    call void @__kmpc_for_static_init_4(%struct.ident_t* @[[GLOB19:[0-9]+]], i32 [[OMP_GLOBAL_THREAD_NUM44]], i32 34, i32* [[DOTOMP_IS_LAST]], i32* [[DOTOMP_LB]], i32* [[DOTOMP_UB]], i32* [[DOTOMP_STRIDE]], i32 1, i32 1)
// OMP_IRB-NEXT:    [[TMP26:%.*]] = load i32, i32* [[DOTOMP_UB]], align 4
// OMP_IRB-NEXT:    [[TMP27:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_40]], align 4
// OMP_IRB-NEXT:    [[CMP45:%.*]] = icmp sgt i32 [[TMP26]], [[TMP27]]
// OMP_IRB-NEXT:    br i1 [[CMP45]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// OMP_IRB:       cond.true:
// OMP_IRB-NEXT:    [[TMP28:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_40]], align 4
// OMP_IRB-NEXT:    br label [[COND_END:%.*]]
// OMP_IRB:       cond.false:
// OMP_IRB-NEXT:    [[TMP29:%.*]] = load i32, i32* [[DOTOMP_UB]], align 4
// OMP_IRB-NEXT:    br label [[COND_END]]
// OMP_IRB:       cond.end:
// OMP_IRB-NEXT:    [[COND:%.*]] = phi i32 [ [[TMP28]], [[COND_TRUE]] ], [ [[TMP29]], [[COND_FALSE]] ]
// OMP_IRB-NEXT:    store i32 [[COND]], i32* [[DOTOMP_UB]], align 4
// OMP_IRB-NEXT:    [[TMP30:%.*]] = load i32, i32* [[DOTOMP_LB]], align 4
// OMP_IRB-NEXT:    store i32 [[TMP30]], i32* [[DOTOMP_IV]], align 4
// OMP_IRB-NEXT:    br label [[OMP_INNER_FOR_COND46:%.*]]
// OMP_IRB:       omp.inner.for.cond46:
// OMP_IRB-NEXT:    [[TMP31:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// OMP_IRB-NEXT:    [[TMP32:%.*]] = load i32, i32* [[DOTOMP_UB]], align 4
// OMP_IRB-NEXT:    [[CMP47:%.*]] = icmp sle i32 [[TMP31]], [[TMP32]]
// OMP_IRB-NEXT:    br i1 [[CMP47]], label [[OMP_INNER_FOR_BODY48:%.*]], label [[OMP_INNER_FOR_END56:%.*]]
// OMP_IRB:       omp.inner.for.body48:
// OMP_IRB-NEXT:    [[TMP33:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// OMP_IRB-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP33]], 1
// OMP_IRB-NEXT:    [[ADD49:%.*]] = add nsw i32 0, [[MUL]]
// OMP_IRB-NEXT:    store i32 [[ADD49]], i32* [[I43]], align 4
// OMP_IRB-NEXT:    [[TMP34:%.*]] = load float, float* @flag, align 4
// OMP_IRB-NEXT:    [[TOBOOL50:%.*]] = fcmp une float [[TMP34]], 0.000000e+00
// OMP_IRB-NEXT:    br i1 [[TOBOOL50]], label [[OMP_IF_THEN:%.*]], label [[OMP_IF_ELSE:%.*]]
// OMP_IRB:       omp_if.then:
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM51:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB23:[0-9]+]])
// OMP_IRB-NEXT:    [[TMP35:%.*]] = call i32 @__kmpc_cancel(%struct.ident_t* @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM51]], i32 2)
// OMP_IRB-NEXT:    [[TMP36:%.*]] = icmp ne i32 [[TMP35]], 0
// OMP_IRB-NEXT:    br i1 [[TMP36]], label [[DOTCANCEL_EXIT52:%.*]], label [[DOTCANCEL_CONTINUE53:%.*]]
// OMP_IRB:       .cancel.exit52:
// OMP_IRB-NEXT:    br label [[CANCEL_EXIT57:%.*]]
// OMP_IRB:       cancel.exit35:
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM36:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB18]])
// OMP_IRB-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB3]], i32 [[OMP_GLOBAL_THREAD_NUM36]])
// OMP_IRB-NEXT:    br label [[CANCEL_CONT38]]
// OMP_IRB:       .cancel.continue53:
...
// OMP_IRB-NEXT:    br label [[OMP_INNER_FOR_INC54:%.*]]
// OMP_IRB:       omp.inner.for.inc54:
// OMP_IRB-NEXT:    [[TMP37:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// OMP_IRB-NEXT:    [[ADD55:%.*]] = add nsw i32 [[TMP37]], 1
// OMP_IRB-NEXT:    store i32 [[ADD55]], i32* [[DOTOMP_IV]], align 4
// OMP_IRB-NEXT:    br label [[OMP_INNER_FOR_COND46]]
// OMP_IRB:       omp.inner.for.end56:
// OMP_IRB-NEXT:    br label [[OMP_LOOP_EXIT:%.*]]
// OMP_IRB:       omp.loop.exit:
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM59:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB25:[0-9]+]])
// OMP_IRB-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB19]], i32 [[OMP_GLOBAL_THREAD_NUM59]])
// OMP_IRB-NEXT:    br label [[OMP_PRECOND_END]]
// OMP_IRB:       cancel.exit57:
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM58:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB25]])
// OMP_IRB-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB19]], i32 [[OMP_GLOBAL_THREAD_NUM58]])
// OMP_IRB-NEXT:    br label [[CANCEL_CONT60:%.*]]
// OMP_IRB:       omp.precond.end:
// OMP_IRB-NEXT:    br label [[CANCEL_CONT60]]
// OMP_IRB:       cancel.cont60:
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM61:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB1]])
// OMP_IRB-NEXT:    call void @__kmpc_barrier(%struct.ident_t* @[[GLOB26:[0-9]+]], i32 [[OMP_GLOBAL_THREAD_NUM61]])
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM62:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB30:[0-9]+]])
// OMP_IRB-NEXT:    [[TMP38:%.*]] = call i8* @__kmpc_omp_task_alloc(%struct.ident_t* @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM62]], i32 1, i64 40, i64 1, i32 (i32, i8*)* bitcast (i32 (i32, %struct.kmp_task_t_with_privates*)* @.omp_task_entry. to i32 (i32, i8*)*))
// OMP_IRB-NEXT:    [[TMP39:%.*]] = bitcast i8* [[TMP38]] to %struct.kmp_task_t_with_privates*
// OMP_IRB-NEXT:    [[TMP40:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASK_T_WITH_PRIVATES:%.*]], %struct.kmp_task_t_with_privates* [[TMP39]], i32 0, i32 0
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM63:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB30]])
// OMP_IRB-NEXT:    [[TMP41:%.*]] = call i32 @__kmpc_omp_task(%struct.ident_t* @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM63]], i8* [[TMP38]])
...
// OMP_IRB-NEXT:    [[TMP42:%.*]] = load i32, i32* [[ARGC_ADDR]], align 4
// OMP_IRB-NEXT:    ret i32 [[TMP42]]
//
//
...
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM_I:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB28:[0-9]+]]) #[[ATTR2:[0-9]+]]
...
// OMP_IRB-NEXT:    store i32 1, i32* [[DOTOMP_SECTIONS_ST_]], align 4
// OMP_IRB-NEXT:    store i32 0, i32* [[DOTOMP_SECTIONS_IL_]], align 4
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB32:[0-9]+]])
// OMP_IRB-NEXT:    call void @__kmpc_for_static_init_4(%struct.ident_t* @[[GLOB3]], i32 [[OMP_GLOBAL_THREAD_NUM]], i32 34, i32* [[DOTOMP_SECTIONS_IL_]], i32* [[DOTOMP_SECTIONS_LB_]], i32* [[DOTOMP_SECTIONS_UB_]], i32* [[DOTOMP_SECTIONS_ST_]], i32 1, i32 1)
// OMP_IRB-NEXT:    [[TMP0:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_UB_]], align 4
// OMP_IRB-NEXT:    [[TMP1:%.*]] = icmp slt i32 [[TMP0]], 0
// OMP_IRB-NEXT:    [[TMP2:%.*]] = select i1 [[TMP1]], i32 [[TMP0]], i32 0
// OMP_IRB-NEXT:    store i32 [[TMP2]], i32* [[DOTOMP_SECTIONS_UB_]], align 4
...
// OMP_IRB-NEXT:    ]
// OMP_IRB:       .omp.sections.case:
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM1:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB34:[0-9]+]])
...
// OMP_IRB-NEXT:    br label [[OMP_INNER_FOR_COND]]
// OMP_IRB:       omp.inner.for.end:
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM3:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB36:[0-9]+]])
// OMP_IRB-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB3]], i32 [[OMP_GLOBAL_THREAD_NUM3]])
// OMP_IRB-NEXT:    br label [[CANCEL_CONT:%.*]]
// OMP_IRB:       cancel.cont:
// OMP_IRB-NEXT:    ret void
// OMP_IRB:       cancel.exit:
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM2:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB36]])
// OMP_IRB-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB3]], i32 [[OMP_GLOBAL_THREAD_NUM2]])
// OMP_IRB-NEXT:    br label [[CANCEL_CONT]]
//
//
...
// OMP_IRB-NEXT:    store i32 1, i32* [[DOTOMP_SECTIONS_ST_]], align 4
// OMP_IRB-NEXT:    store i32 0, i32* [[DOTOMP_SECTIONS_IL_]], align 4
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB38:[0-9]+]])
// OMP_IRB-NEXT:    call void @__kmpc_for_static_init_4(%struct.ident_t* @[[GLOB3]], i32 [[OMP_GLOBAL_THREAD_NUM]], i32 34, i32* [[DOTOMP_SECTIONS_IL_]], i32* [[DOTOMP_SECTIONS_LB_]], i32* [[DOTOMP_SECTIONS_UB_]], i32* [[DOTOMP_SECTIONS_ST_]], i32 1, i32 1)
// OMP_IRB-NEXT:    [[TMP0:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_UB_]], align 4
...
// OMP_IRB-NEXT:    ]
// OMP_IRB:       .omp.sections.case:
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM1:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB40:[0-9]+]])
// OMP_IRB-NEXT:    [[TMP7:%.*]] = call i32 @__kmpc_cancel(%struct.ident_t* @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM1]], i32 3)
// OMP_IRB-NEXT:    [[TMP8:%.*]] = icmp ne i32 [[TMP7]], 0
// OMP_IRB-NEXT:    br i1 [[TMP8]], label [[DOTCANCEL_EXIT:%.*]], label [[DOTCANCEL_CONTINUE:%.*]]
// OMP_IRB:       .cancel.exit:
...
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM3:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB42:[0-9]+]])
// OMP_IRB-NEXT:    [[TMP9:%.*]] = call i32 @__kmpc_cancel(%struct.ident_t* @[[GLOB1]], i32 [[OMP_GLOBAL_THREAD_NUM3]], i32 3)
// OMP_IRB-NEXT:    [[TMP10:%.*]] = icmp ne i32 [[TMP9]], 0
// OMP_IRB-NEXT:    br i1 [[TMP10]], label [[DOTCANCEL_EXIT4:%.*]], label [[DOTCANCEL_CONTINUE5:%.*]]
// OMP_IRB:       .cancel.exit4:
// OMP_IRB-NEXT:    br label [[CANCEL_EXIT]]
// OMP_IRB:       .cancel.continue5:
// OMP_IRB-NEXT:    br label [[DOTOMP_SECTIONS_EXIT]]
// OMP_IRB:       .omp.sections.exit:
// OMP_IRB-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// OMP_IRB:       omp.inner.for.inc:
...
// OMP_IRB-NEXT:    br label [[OMP_INNER_FOR_COND]]
// OMP_IRB:       omp.inner.for.end:
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM7:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB44:[0-9]+]])
// OMP_IRB-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB3]], i32 [[OMP_GLOBAL_THREAD_NUM7]])
// OMP_IRB-NEXT:    br label [[CANCEL_CONT:%.*]]
// OMP_IRB:       cancel.cont:
// OMP_IRB-NEXT:    ret void
// OMP_IRB:       cancel.exit:
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM6:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB44]])
// OMP_IRB-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB3]], i32 [[OMP_GLOBAL_THREAD_NUM6]])
// OMP_IRB-NEXT:    br label [[CANCEL_CONT]]
//
//
...
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB46:[0-9]+]])
// OMP_IRB-NEXT:    call void @__kmpc_for_static_init_4(%struct.ident_t* @[[GLOB19]], i32 [[OMP_GLOBAL_THREAD_NUM]], i32 34, i32* [[DOTOMP_IS_LAST]], i32* [[DOTOMP_LB]], i32* [[DOTOMP_UB]], i32* [[DOTOMP_STRIDE]], i32 1, i32 1)
...
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM7:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB48:[0-9]+]])
...
// OMP_IRB-NEXT:    br label [[OMP_LOOP_EXIT:%.*]]
// OMP_IRB:       omp.loop.exit:
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM11:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB50:[0-9]+]])
// OMP_IRB-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB19]], i32 [[OMP_GLOBAL_THREAD_NUM11]])
...
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM12:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB50]])
// OMP_IRB-NEXT:    [[TMP21:%.*]] = bitcast [1 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]] to i8*
// OMP_IRB-NEXT:    [[TMP22:%.*]] = call i32 @__kmpc_reduce_nowait(%struct.ident_t* @[[GLOB51:[0-9]+]], i32 [[OMP_GLOBAL_THREAD_NUM12]], i32 1, i64 8, i8* [[TMP21]], void (i8*, i8*)* @.omp.reduction.reduction_func, [8 x i32]* @.gomp_critical_user_.reduction.var)
...
// OMP_IRB-NEXT:    call void @__kmpc_end_reduce_nowait(%struct.ident_t* @[[GLOB51]], i32 [[OMP_GLOBAL_THREAD_NUM12]], [8 x i32]* @.gomp_critical_user_.reduction.var)
// OMP_IRB-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// OMP_IRB:       cancel.exit:
// OMP_IRB-NEXT:    [[OMP_GLOBAL_THREAD_NUM10:%.*]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB50]])
// OMP_IRB-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB19]], i32 [[OMP_GLOBAL_THREAD_NUM10]])
// OMP_IRB-NEXT:    br label [[CANCEL_CONT:%.*]]

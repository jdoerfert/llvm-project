...
#ifdef NO_JMP_BUF
extern long setjmp(long *);   // expected-warning {{declaration of built-in function 'setjmp' requires the declaration of the 'jmp_buf' type, commonly proived in the header <setjmp.h>.}}
#else

...
entry:
  ...
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %0, i8* %pchMsg, i32 %u) #12
...
; Function Attrs: nounwind uwtable
define dso_local void @ReadDict(i8* %pchFile) local_unnamed_addr #0 {
entry:
  %statBuf = alloca %struct.stat, align 8
  %0 = bitcast %struct.stat* %statBuf to i8*
  call void @llvm.lifetime.start.p0i8(i64 144, i8* nonnull %0) #14
  %call.i = call i32 @__xstat(i32 1, i8* nonnull %pchFile, %struct.stat* nonnull %statBuf) #14
  %tobool.not = icmp eq i32 %call.i, 0
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %1 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !2
  %call.i61 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i64 0, i64 0), i32 0) #15
  call void @exit(i32 1) #13
  unreachable

if.end:                                           ; preds = %entry
  %st_size = getelementptr inbounds %struct.stat, %struct.stat* %statBuf, i64 0, i32 8
  %2 = load i64, i64* %st_size, align 8, !tbaa !6
  %add = add i64 %2, 52000
  %call1 = call noalias i8* @malloc(i64 %add) #14
...
if.then2:                                         ; preds = %if.end
  ...
  %call.i62 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %3, i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.1, i64 0, i64 0), i32 0) #15
  call void @exit(i32 1) #13
  unreachable
...
while.cond.preheader:                             ; preds = %if.end3
  %call868 = call i32 @feof(%struct._IO_FILE* nonnull %call4) #14
  %tobool9.not69 = icmp eq i32 %call868, 0
  br i1 %tobool9.not69, label %while.body, label %while.end25

if.then6:                                         ; preds = %if.end3
  %4 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !2
  %call.i64 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %4, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.3, i64 0, i64 0), i32 0) #15
  call void @exit(i32 1) #13
  unreachable

while.body:                                       ; preds = %while.cond.preheader, %while.end
  %cWords.071 = phi i32 [ %inc24, %while.end ], [ 0, %while.cond.preheader ]
  %pchBase.070 = phi i8* [ %incdec.ptr20, %while.end ], [ %call1, %while.cond.preheader ]
  %add.ptr = getelementptr inbounds i8, i8* %pchBase.070, i64 2
...
while.cond10:                                     ; preds = %while.body14, %while.body
  ...
  %call11 = call i32 @fgetc(%struct._IO_FILE* nonnull %call4)
...
while.body14:                                     ; preds = %while.cond10
  ...
  %5 = load i16*, i16** %call15, align 8, !tbaa !2
  ...
  %spec.select = add i32 %cLetters.0, %8
...
while.end:                                        ; preds = %while.cond10, %while.cond10
  ...
  %sub.ptr.rhs.cast = ptrtoint i8* %pchBase.070 to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
  %conv21 = trunc i64 %sub.ptr.sub to i8
  store i8 %conv21, i8* %pchBase.070, align 1, !tbaa !13
  %conv22 = trunc i32 %cLetters.0 to i8
  %arrayidx23 = getelementptr inbounds i8, i8* %pchBase.070, i64 1
  store i8 %conv22, i8* %arrayidx23, align 1, !tbaa !13
  %inc24 = add i32 %cWords.071, 1
  %call8 = call i32 @feof(%struct._IO_FILE* nonnull %call4) #14
  %tobool9.not = icmp eq i32 %call8, 0
  br i1 %tobool9.not, label %while.body, label %while.end25

while.end25:                                      ; preds = %while.end, %while.cond.preheader
  %pchBase.0.lcssa = phi i8* [ %call1, %while.cond.preheader ], [ %incdec.ptr20, %while.end ]
  %cWords.0.lcssa = phi i32 [ 0, %while.cond.preheader ], [ %inc24, %while.end ]
  %call26 = call i32 @fclose(%struct._IO_FILE* nonnull %call4)
  store i8 0, i8* %pchBase.0.lcssa, align 1, !tbaa !13
  %9 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !2
  %call28 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %9, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.4, i64 0, i64 0), i32 %cWords.0.lcssa) #12
...
if.then31:                                        ; preds = %while.end25
  ...
  %call.i66 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %10, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.5, i64 0, i64 0), i32 0) #15
  call void @exit(i32 1) #13
  unreachable
...
if.end32:                                         ; preds = %while.end25
  ...
  %12 = load i64, i64* bitcast (i8** @pchDictionary to i64*), align 8, !tbaa !2
  %sub.ptr.lhs.cast33 = ptrtoint i8* %incdec.ptr27 to i64
  %sub.ptr.sub35.neg = sub i64 %add, %sub.ptr.lhs.cast33
  %sub = add i64 %sub.ptr.sub35.neg, %12
  %call36 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %11, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.6, i64 0, i64 0), i64 %sub) #12
...
; Function Attrs: nounwind uwtable
define dso_local void @BuildMask(i8* nocapture readonly %pchPhrase) local_unnamed_addr #0 {
entry:
  ...
  %cmp.not118 = icmp eq i8 %0, 0
  br i1 %cmp.not118, label %for.body.preheader, label %while.body.lr.ph
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end15
  ...
  %pchPhrase.pn = phi i8* [ %pchPhrase, %while.body.lr.ph ], [ %incdec.ptr119, %if.end15 ]
  %incdec.ptr119 = getelementptr inbounds i8, i8* %pchPhrase.pn, i64 1
...
if.end15:                                         ; preds = %if.end, %while.body
  ...
  %8 = load i8, i8* %incdec.ptr119, align 1, !tbaa !13
...
for.body:                                         ; preds = %for.body.preheader, %for.inc74
  ...
  %cbtUsed.0127 = phi i32 [ %cbtUsed.2, %for.inc74 ], [ 0, %for.body.preheader ]
  %iq.0126 = phi i32 [ %iq.2, %for.inc74 ], [ 0, %for.body.preheader ]
...
for.inc:                                          ; preds = %for.inc.for.inc_crit_edge, %for.inc.preheader
  %qNeed.0123 = phi i64 [ %shl, %for.inc.for.inc_crit_edge ], [ 1, %for.inc.preheader ]
  %inc37.phi = phi i32 [ %inc37.0, %for.inc.for.inc_crit_edge ], [ %inc37.1, %for.inc.preheader ]
  %shl = shl i64 %qNeed.0123, 1
...
for.end:                                          ; preds = %for.inc
  %add = add nsw i32 %inc37.phi, %cbtUsed.0127
  %cmp39 = icmp ugt i32 %add, 64
  br i1 %cmp39, label %if.then41, label %if.end47

if.then41:                                        ; preds = %for.end
  %inc42 = add i32 %iq.0126, 1
  %cmp43 = icmp ugt i32 %inc42, 1
  br i1 %cmp43, label %if.then45, label %if.end47

if.then45:                                        ; preds = %if.then41
  %10 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !2
  %call.i115 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %10, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.7, i64 0, i64 0), i32 0) #15
  tail call void @exit(i32 1) #13
  unreachable

if.end47:                                         ; preds = %if.then41, %for.end
  %iq.1 = phi i32 [ %iq.0126, %for.end ], [ %inc42, %if.then41 ]
  %cbtUsed.1 = phi i32 [ %cbtUsed.0127, %for.end ], [ 0, %if.then41 ]
  ...
  %12 = load i64, i64* %arrayidx57, align 8, !tbaa !18
  %or = or i64 %12, %spec.select
  store i64 %or, i64* %arrayidx57, align 8, !tbaa !18
  %shl63 = shl i64 %conv33, %sh_prom
  %arrayidx65 = getelementptr inbounds [2 x i64], [2 x i64]* @aqMainMask, i64 0, i64 %idxprom56
  %13 = load i64, i64* %arrayidx65, align 8, !tbaa !18
  %or66 = or i64 %13, %shl63
...
for.inc74:                                        ; preds = %if.then23, %if.end47
  %iq.2 = phi i32 [ %iq.0126, %if.then23 ], [ %iq.1, %if.end47 ]
  %cbtUsed.2 = phi i32 [ %cbtUsed.0127, %if.then23 ], [ %add72, %if.end47 ]
...
; Function Attrs: nounwind uwtable
define dso_local noalias %struct.Word* @NewWord() local_unnamed_addr #0 {
entry:
  %call = tail call noalias dereferenceable_or_null(32) i8* @malloc(i64 32) #14
...
if.then:                                          ; preds = %entry
  ...
  %1 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !2
  %call.i = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.8, i64 0, i64 0), i32 %0) #15
  tail call void @exit(i32 1) #13
  unreachable

if.end:                                           ; preds = %entry
  %2 = bitcast i8* %call to %struct.Word*
  ret %struct.Word* %2
}

; Function Attrs: nofree nounwind uwtable
define dso_local void @wprint(i8* %pch) local_unnamed_addr #6 {
entry:
...
; Function Attrs: nounwind uwtable
define dso_local %struct.Word* @NextWord() local_unnamed_addr #0 {
entry:
  %0 = load i32, i32* @cpwCand, align 4, !tbaa !14
...
if.then:                                          ; preds = %entry
  %1 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !2
  %call.i = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.10, i64 0, i64 0), i32 0) #15
  tail call void @exit(i32 1) #13
  unreachable
...
if.end3:                                          ; preds = %if.end
  %call.i11 = tail call noalias dereferenceable_or_null(32) i8* @malloc(i64 32) #14
  %cmp.i = icmp eq i8* %call.i11, null
  br i1 %cmp.i, label %if.then.i, label %NewWord.exit

if.then.i:                                        ; preds = %if.end3
  %3 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !2
  %call.i.i = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %3, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.8, i64 0, i64 0), i32 %inc) #15
  tail call void @exit(i32 1) #13
  unreachable

NewWord.exit:                                     ; preds = %if.end3
  %4 = bitcast i8* %call.i11 to %struct.Word*
  %5 = bitcast %struct.Word** %arrayidx to i8**
  store i8* %call.i11, i8** %5, align 8, !tbaa !2
  br label %cleanup
...
; Function Attrs: nounwind uwtable
define dso_local void @BuildWord(i8* %pchWord) local_unnamed_addr #0 {
entry:
  %cchFrequency = alloca [26 x i8], align 16
  %0 = getelementptr inbounds [26 x i8], [26 x i8]* %cchFrequency, i64 0, i64 0
  call void @llvm.lifetime.start.p0i8(i64 26, i8* nonnull %0) #14
...
if.then.i:                                        ; preds = %for.cond.preheader
  ...
  %call.i.i = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %44, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.10, i64 0, i64 0), i32 0) #15
  tail call void @exit(i32 1) #13
  unreachable

if.end.i:                                         ; preds = %for.cond.preheader
  %inc.i = add nuw nsw i32 %37, 1
  store i32 %inc.i, i32* @cpwCand, align 4, !tbaa !14
  %idxprom.i84 = zext i32 %37 to i64
...
if.end3.i:                                        ; preds = %if.end.i
  %call.i11.i = tail call noalias dereferenceable_or_null(32) i8* @malloc(i64 32) #14
  %cmp.i.i = icmp eq i8* %call.i11.i, null
...
if.then.i.i:                                      ; preds = %if.end3.i
  ...
  %call.i.i.i = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %46, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.8, i64 0, i64 0), i32 %inc.i) #15
  tail call void @exit(i32 1) #13
  unreachable

NewWord.exit.i:                                   ; preds = %if.end3.i
  %47 = bitcast i8* %call.i11.i to %struct.Word*
  %48 = bitcast %struct.Word** %arrayidx.i85 to i8**
  store i8* %call.i11.i, i8** %48, align 8, !tbaa !2
...
cleanup:                                          ; preds = %if.end12, %NextWord.exit
  call void @llvm.lifetime.end.p0i8(i64 26, i8* nonnull %0) #14
  ret void
}

; Function Attrs: nounwind uwtable
define dso_local void @AddWords() local_unnamed_addr #0 {
entry:
...
while.end:                                        ; preds = %while.end.loopexit, %entry
  ...
  %10 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !2
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %10, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.11, i64 0, i64 0), i32 %9) #12
  ret void
}

; Function Attrs: nofree nounwind uwtable
define dso_local void @DumpCandidates() local_unnamed_addr #6 {
entry:
  %0 = load i32, i32* @cpwCand, align 4, !tbaa !14
...
; Function Attrs: nofree nounwind uwtable
define dso_local void @DumpWords() local_unnamed_addr #6 {
entry:
...
for.body:                                         ; preds = %for.cond.preheader, %for.body
  ...
  %call.i = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.9, i64 0, i64 0), i8* %3) #14
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
; Function Attrs: nounwind uwtable
define dso_local void @FindAnagram(i64* nocapture readonly %pqMask, %struct.Word** %ppwStart, i32 %iLetter) local_unnamed_addr #0 {
entry:
...
for.body.i:                                       ; preds = %for.cond.preheader.i, %for.body.i
  ...
  %call.i.i = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.9, i64 0, i64 0), i8* %29) #14
...
for.end.i:                                        ; preds = %for.body.i, %for.cond.preheader.i
  %putchar.i = tail call i32 @putchar(i32 10) #14
  br label %if.end50
...
define dso_local i32 @CompareFrequency(i8* nocapture readonly %pch1, i8* nocapture readonly %pch2) #7 {
entry:
...
; Function Attrs: nofree nounwind uwtable
define dso_local void @SortCandidates() local_unnamed_addr #6 {
entry:
  ...
  tail call void @qsort(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @achByFrequency, i64 0, i64 0), i64 26, i64 1, i32 (i8*, i8*)* nonnull @CompareFrequency) #14
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !2
  %1 = tail call i64 @fwrite(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.14, i64 0, i64 0), i64 24, i64 1, %struct._IO_FILE* %0) #12
...
declare dso_local void @qsort(i8* noundef, i64 noundef, i64 noundef, i32 (i8*, i8*)* nocapture noundef) local_unnamed_addr #8

; Function Attrs: nofree nounwind
declare dso_local noundef i32 @fputc(i32 noundef, %struct._IO_FILE* nocapture noundef) local_unnamed_addr #1

; Function Attrs: nounwind uwtable
define dso_local i8* @GetPhrase(i8* returned %pch, i32 %size) local_unnamed_addr #0 {
entry:
...
; Function Attrs: nounwind uwtable
define dso_local i32 @main(i32 %cpchArgc, i8** nocapture readonly %ppchArgv) local_unnamed_addr #0 {
entry:
...
if.then:                                          ; preds = %entry
  %1 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !2
  %call.i = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.16, i64 0, i64 0), i32 0) #15
  call void @exit(i32 1) #13
  unreachable
...
while.body:                                       ; preds = %if.end.i
  ...
  %7 = load i16*, i16** %call9, align 8, !tbaa !2
  %8 = load i8, i8* getelementptr inbounds ([255 x i8], [255 x i8]* @achPhrase, i64 0, i64 0), align 16, !tbaa !13
  %idxprom = sext i8 %8 to i64
  %arrayidx10 = getelementptr inbounds i16, i16* %7, i64 %idxprom
  %9 = load i16, i16* %arrayidx10, align 2, !tbaa !11
  %10 = and i16 %9, 2048
  %tobool.not = icmp eq i16 %10, 0
  br i1 %tobool.not, label %if.else, label %if.then12

if.then12:                                        ; preds = %while.body
  %call.i38 = call i64 @strtol(i8* nocapture nonnull getelementptr inbounds ([255 x i8], [255 x i8]* @achPhrase, i64 0, i64 0), i8** null, i32 10) #14
  %conv.i39 = trunc i64 %call.i38 to i32
  store i32 %conv.i39, i32* @cchMinLength, align 4, !tbaa !14
  %call14 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([16 x i8], [16 x i8]* @.str.17, i64 0, i64 0), i32 %conv.i39)
  br label %while.cond.backedge
...
if.then18:                                        ; preds = %if.else
  %11 = load i32, i32* @cpwCand, align 4, !tbaa !14
...
for.body.i:                                       ; preds = %if.then18, %for.body.i
  ...
  %12 = load %struct.Word*, %struct.Word** %arrayidx.i, align 8, !tbaa !2
  %pchWord.i = getelementptr inbounds %struct.Word, %struct.Word* %12, i64 0, i32 1
  %13 = load i8*, i8** %pchWord.i, align 8, !tbaa !21
  %rem9.i = and i64 %indvars.iv.i, 3
  %cmp1.i = icmp eq i64 %rem9.i, 3
  %cond.i = select i1 %cmp1.i, i32 10, i32 32
  %call.i40 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str.12, i64 0, i64 0), i8* %13, i32 %cond.i) #14
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %14 = load i32, i32* @cpwCand, align 4, !tbaa !14
  %15 = zext i32 %14 to i64
  %cmp.i41 = icmp ult i64 %indvars.iv.next.i, %15
  br i1 %cmp.i41, label %for.body.i, label %DumpCandidates.exit

DumpCandidates.exit:                              ; preds = %for.body.i, %if.then18
  %putchar.i42 = call i32 @putchar(i32 10) #14
  br label %while.cond.backedge

if.else19:                                        ; preds = %if.else
  call void @BuildMask(i8* getelementptr inbounds ([255 x i8], [255 x i8]* @achPhrase, i64 0, i64 0))
  %16 = load i8*, i8** @pchDictionary, align 8, !tbaa !2
  store i32 0, i32* @cpwCand, align 4, !tbaa !14
  %17 = load i8, i8* %16, align 1, !tbaa !13
  %tobool.not19.i = icmp eq i8 %17, 0
  br i1 %tobool.not19.i, label %AddWords.exit, label %while.body.i

while.body.i:                                     ; preds = %if.else19, %if.end.i47
  %18 = phi i8 [ %24, %if.end.i47 ], [ %17, %if.else19 ]
  %pch.020.i = phi i8* [ %add.ptr11.i, %if.end.i47 ], [ %16, %if.else19 ]
  %arrayidx.i43 = getelementptr inbounds i8, i8* %pch.020.i, i64 1
  %19 = load i8, i8* %arrayidx.i43, align 1, !tbaa !13
  %conv.i44 = sext i8 %19 to i32
  %20 = load i32, i32* @cchMinLength, align 4, !tbaa !14
  %cmp.not.i = icmp sgt i32 %20, %conv.i44
...
land.lhs.true.i:                                  ; preds = %while.body.i
  %add.i = add nsw i32 %20, %conv.i44
  %21 = load i32, i32* @cchPhraseLength, align 4, !tbaa !14
  %cmp4.not.i = icmp sgt i32 %add.i, %21
  br i1 %cmp4.not.i, label %lor.lhs.false.i, label %if.then.i45

lor.lhs.false.i:                                  ; preds = %land.lhs.true.i, %while.body.lor.lhs.false_crit_edge.i
  %22 = phi i32 [ %.pre.i, %while.body.lor.lhs.false_crit_edge.i ], [ %21, %land.lhs.true.i ]
  %cmp8.i = icmp eq i32 %22, %conv.i44
  br i1 %cmp8.i, label %if.then.i45, label %if.end.i47

if.then.i45:                                      ; preds = %lor.lhs.false.i, %land.lhs.true.i
  %add.ptr.i = getelementptr inbounds i8, i8* %pch.020.i, i64 2
  call void @BuildWord(i8* nonnull %add.ptr.i) #14
  %.pre21.i = load i8, i8* %pch.020.i, align 1, !tbaa !13
  br label %if.end.i47

if.end.i47:                                       ; preds = %if.then.i45, %lor.lhs.false.i
  %23 = phi i8 [ %.pre21.i, %if.then.i45 ], [ %18, %lor.lhs.false.i ]
  %idx.ext.i = sext i8 %23 to i64
  %add.ptr11.i = getelementptr inbounds i8, i8* %pch.020.i, i64 %idx.ext.i
  %24 = load i8, i8* %add.ptr11.i, align 1, !tbaa !13
  %tobool.not.i46 = icmp eq i8 %24, 0
  br i1 %tobool.not.i46, label %while.end.loopexit.i, label %while.body.i
...
AddWords.exit:                                    ; preds = %if.else19, %while.end.loopexit.i
  ...
  %call.i48 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %26, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.11, i64 0, i64 0), i32 %25) #15
  %27 = load i32, i32* @cpwCand, align 4, !tbaa !14
...
if.end25:                                         ; preds = %AddWords.exit
  ...
  %call26 = call i32 @_setjmp(%struct.__jmp_buf_tag* getelementptr inbounds ([1 x %struct.__jmp_buf_tag], [1 x %struct.__jmp_buf_tag]* @jbAnagram, i64 0, i64 0)) #17
...
declare dso_local i32 @isatty(i32) local_unnamed_addr #9

; Function Attrs: nounwind returns_twice
declare dso_local i32 @_setjmp(%struct.__jmp_buf_tag*) local_unnamed_addr #10
...
attributes #6 = { nofree nounwind uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="skylake" "target-features"="+64bit,+adx,+aes,+avx,+avx2,+bmi,+bmi2,+clflushopt,+cmov,+cx16,+cx8,+f16c,+fma,+fsgsbase,+fxsr,+invpcid,+lzcnt,+mmx,+movbe,+pclmul,+popcnt,+prfchw,+rdrnd,+rdseed,+rtm,+sahf,+sgx,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave,+xsavec,+xsaveopt,+xsaves,-amx-bf16,-amx-int8,-amx-tile,-avx512bf16,-avx512bitalg,-avx512bw,-avx512cd,-avx512dq,-avx512er,-avx512f,-avx512ifma,-avx512pf,-avx512vbmi,-avx512vbmi2,-avx512vl,-avx512vnni,-avx512vp2intersect,-avx512vpopcntdq,-cldemote,-clwb,-clzero,-enqcmd,-fma4,-gfni,-lwp,-movdir64b,-movdiri,-mwaitx,-pconfig,-pku,-prefetchwt1,-ptwrite,-rdpid,-serialize,-sha,-shstk,-sse4a,-tbm,-tsxldtrk,-vaes,-vpclmulqdq,-waitpkg,-wbnoinvd,-xop" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
attributes #8 = { nofree "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="skylake" "target-features"="+64bit,+adx,+aes,+avx,+avx2,+bmi,+bmi2,+clflushopt,+cmov,+cx16,+cx8,+f16c,+fma,+fsgsbase,+fxsr,+invpcid,+lzcnt,+mmx,+movbe,+pclmul,+popcnt,+prfchw,+rdrnd,+rdseed,+rtm,+sahf,+sgx,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave,+xsavec,+xsaveopt,+xsaves,-amx-bf16,-amx-int8,-amx-tile,-avx512bf16,-avx512bitalg,-avx512bw,-avx512cd,-avx512dq,-avx512er,-avx512f,-avx512ifma,-avx512pf,-avx512vbmi,-avx512vbmi2,-avx512vl,-avx512vnni,-avx512vp2intersect,-avx512vpopcntdq,-cldemote,-clwb,-clzero,-enqcmd,-fma4,-gfni,-lwp,-movdir64b,-movdiri,-mwaitx,-pconfig,-pku,-prefetchwt1,-ptwrite,-rdpid,-serialize,-sha,-shstk,-sse4a,-tbm,-tsxldtrk,-vaes,-vpclmulqdq,-waitpkg,-wbnoinvd,-xop" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #9 = { nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="skylake" "target-features"="+64bit,+adx,+aes,+avx,+avx2,+bmi,+bmi2,+clflushopt,+cmov,+cx16,+cx8,+f16c,+fma,+fsgsbase,+fxsr,+invpcid,+lzcnt,+mmx,+movbe,+pclmul,+popcnt,+prfchw,+rdrnd,+rdseed,+rtm,+sahf,+sgx,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave,+xsavec,+xsaveopt,+xsaves,-amx-bf16,-amx-int8,-amx-tile,-avx512bf16,-avx512bitalg,-avx512bw,-avx512cd,-avx512dq,-avx512er,-avx512f,-avx512ifma,-avx512pf,-avx512vbmi,-avx512vbmi2,-avx512vl,-avx512vnni,-avx512vp2intersect,-avx512vpopcntdq,-cldemote,-clwb,-clzero,-enqcmd,-fma4,-gfni,-lwp,-movdir64b,-movdiri,-mwaitx,-pconfig,-pku,-prefetchwt1,-ptwrite,-rdpid,-serialize,-sha,-shstk,-sse4a,-tbm,-tsxldtrk,-vaes,-vpclmulqdq,-waitpkg,-wbnoinvd,-xop" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #10 = { nounwind returns_twice "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="skylake" "target-features"="+64bit,+adx,+aes,+avx,+avx2,+bmi,+bmi2,+clflushopt,+cmov,+cx16,+cx8,+f16c,+fma,+fsgsbase,+fxsr,+invpcid,+lzcnt,+mmx,+movbe,+pclmul,+popcnt,+prfchw,+rdrnd,+rdseed,+rtm,+sahf,+sgx,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave,+xsavec,+xsaveopt,+xsaves,-amx-bf16,-amx-int8,-amx-tile,-avx512bf16,-avx512bitalg,-avx512bw,-avx512cd,-avx512dq,-avx512er,-avx512f,-avx512ifma,-avx512pf,-avx512vbmi,-avx512vbmi2,-avx512vl,-avx512vnni,-avx512vp2intersect,-avx512vpopcntdq,-cldemote,-clwb,-clzero,-enqcmd,-fma4,-gfni,-lwp,-movdir64b,-movdiri,-mwaitx,-pconfig,-pku,-prefetchwt1,-ptwrite,-rdpid,-serialize,-sha,-shstk,-sse4a,-tbm,-tsxldtrk,-vaes,-vpclmulqdq,-waitpkg,-wbnoinvd,-xop" "unsafe-fp-math"="false" "use-soft-float"="false" }

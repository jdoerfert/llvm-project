...
// NDEBG:   main
// DEBUG:   main {{.*}}double_free_many_prior.c:27
//
// CHECK: Last deallocation:
// CHECK:  dataDelete
// CHECK:  omp_target_free
// NDEBG:  main
// DEBUG:  main {{.*}}double_free_many_prior.c:26
//
// CHECK: Last allocation of size 8:
// CHECK:  dataAlloc
// CHECK:  omp_target_alloc
// NDEBG:  main
// DEBUG:  main {{.*}}double_free_many_prior.c:25
//
...
// CHECK:  omp_target_free
// NDEBG:  main
// DEBUG:  main {{.*}}double_free_many_prior.c:24
//
// CHECK: #0 Prior allocation:
// CHECK:  dataAlloc
// CHECK:  omp_target_alloc
// NDEBG:  main
// DEBUG:  main {{.*}}double_free_many_prior.c:22
//
// CHECK: #1 Prior deallocation of size 8:
// CHECK:  dataDelete
// CHECK:  omp_target_free
// NDEBG:  main
// DEBUG:  main {{.*}}double_free_many_prior.c:21
//
...
// DEBUG:  main {{.*}}double_free_many_prior.c:22
//
// CHECK: Ommitted 7 prior allocations with the same base pointer.

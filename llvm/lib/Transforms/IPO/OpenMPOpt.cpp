...
KERNEL_ENVIRONMENT_CONFIGURATION_IDX(HasReductionContinuation, 3)
KERNEL_ENVIRONMENT_CONFIGURATION_IDX(MinThreads, 4)
KERNEL_ENVIRONMENT_CONFIGURATION_IDX(MaxThreads, 5)
KERNEL_ENVIRONMENT_CONFIGURATION_IDX(MinTeams, 6)
KERNEL_ENVIRONMENT_CONFIGURATION_IDX(MaxTeams, 7)

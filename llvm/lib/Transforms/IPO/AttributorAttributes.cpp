...
struct AAPointerInfoImpl
  ...
  bool forallInterferingAccesses(
    ...
    hasAssumedIRAttr<Attribute::NoRecurse>(
    ...
    if (auto *AI = dyn_cast<AllocaInst>(&getAssociatedValue())) {
      ...
      bool IsKnownNoRecurse;
      if (hasAssumedIRAttr<Attribute::NoRecurse>(
...
struct AAPointerInfoCallSiteArgument final : AAPointerInfoFloating {
  ...
  ChangeStatus updateImpl(Attributor &A) override {
    ...
    if (!hasAssumedIRAttr<Attribute::NoCapture>(
  ...
  ChangeStatus updateImpl(Attributor &A) override {
    ...
    auto CheckForNoUnwind = [&](Instruction &I) {
      ...
      if (const auto *CB = dyn_cast<CallBase>(&I)) {
        bool IsKnown;
        return hasAssumedIRAttr<Attribute::NoUnwind>(
...
struct AANoSyncCallSite final : AANoSyncImpl {
  ...
  ChangeStatus updateImpl(Attributor &A) override {
    ...
    const IRPosition &FnPos = IRPosition::function(*F);
    bool IsKnownNoSycn;
    if (!hasAssumedIRAttr<Attribute::NoSync>(
            A, *this, getIRPosition(), DepClassTy::REQUIRED, IsKnownNoSycn))
      return indicatePessimisticFixpoint();
    return ChangeStatus::UNCHANGED;
  }
...
struct AANoFreeImpl : public AANoFree {
  ...
  ChangeStatus updateImpl(Attributor &A) override {
    auto CheckForNoFree = [&](Instruction &I) {
      bool IsKnown;
      return hasAssumedIRAttr<Attribute::NoFree>(
...
struct AANoFreeCallSite final : AANoFreeImpl {
  ...
  ChangeStatus updateImpl(Attributor &A) override {
    ...
    const IRPosition &FnPos = IRPosition::function(*F);
    bool IsKnown;
    if (hasAssumedIRAttr<Attribute::NoFree>(A, *this, FnPos,
                                            DepClassTy::REQUIRED, IsKnown))
      return ChangeStatus::UNCHANGED;
    return indicatePessimisticFixpoint();
  }
...
struct AANoFreeFloating : AANoFreeImpl {
  ...
  ChangeStatus updateImpl(Attributor &A) override {
    ...
    bool IsKnown;
    if (hasAssumedIRAttr<Attribute::NoFree>(A, *this,
...
struct AANoFreeCallSiteArgument final : AANoFreeFloating {
  ...
  ChangeStatus updateImpl(Attributor &A) override {
    ...
    const IRPosition &ArgPos = IRPosition::argument(*Arg);
    bool IsKnown;
    if (hasAssumedIRAttr<Attribute::NoFree>(A, *this, ArgPos,
                                            DepClassTy::REQUIRED, IsKnown))
      return ChangeStatus::UNCHANGED;
    return indicatePessimisticFixpoint();
  }
...
static int64_t getKnownNonNullAndDerefBytesForUse(
  ...
  if (const auto *CB = dyn_cast<CallBase>(I)) {
    ...
    return DerefAA && DerefAA->getKnownDereferenceableBytes();
  }
...
struct AAMustProgressFunction final : AAMustProgressImpl {
  ...
  ChangeStatus updateImpl(Attributor &A) override {
    bool IsKnown;
    if (hasAssumedIRAttr<Attribute::WillReturn>(
    ...
    auto CheckForMustProgress = [&](AbstractCallSite ACS) {
      ...
      return hasAssumedIRAttr<Attribute::MustProgress>(
...
struct AAMustProgressCallSite final : AAMustProgressImpl {
  ...
  ChangeStatus updateImpl(Attributor &A) override {
    ...
    bool IsKnownMustProgress;
    if (!hasAssumedIRAttr<Attribute::MustProgress>(
...
struct AAWillReturnImpl : public AAWillReturn {
  ...
  ChangeStatus updateImpl(Attributor &A) override {
    ...
    auto CheckForWillReturn = [&](Instruction &I) {
      ...
      bool IsKnownNoRecurse;
      return hasAssumedIRAttr<Attribute::NoRecurse>(
    ...
    if (!CheckedUnboundCycles && mayContainUnboundedCycle(*F, A))
      return indicatePessimisticFixpoint();
    CheckedUnboundCycles = true;
    return ChangeStatus::UNCHANGED;
  }
  ...
  bool CheckedUnboundCycles = false;
};
...
struct AAWillReturnCallSite final : AAWillReturnImpl {
  ...
  ChangeStatus updateImpl(Attributor &A) override {
    ...
    const IRPosition &FnPos = IRPosition::function(*F);
    bool IsKnown;
    if (hasAssumedIRAttr<Attribute::WillReturn>(A, *this, FnPos,
                                                DepClassTy::REQUIRED, IsKnown))
      return ChangeStatus::UNCHANGED;
    return indicatePessimisticFixpoint();
  }
...
struct AANoAliasFloating final : AANoAliasImpl {
  ...
  void initialize(Attributor &A) override {
    ...
    if (isa<AllocaInst>(Val))
      ...
      bool IsKnownNoAlias;
      hasAssumedIRAttr<Attribute::NoAlias>(A, *this, IRPosition::value(*Val),
                                           DepClassTy::OPTIONAL,
                                           IsKnownNoAlias);
      if (IsKnownNoAlias)
        indicateOptimisticFixpoint();
...
struct AANoAliasReturned final : AANoAliasImpl {
  ...
  ChangeStatus updateImpl(Attributor &A) override {
    ...
    auto CheckReturnValue = [&](Value &RV) -> bool {
      ...
      bool IsKnownNoAlias;
      if (!hasAssumedIRAttr<Attribute::NoAlias>(
  ...
  if (hasAssumedIRAttr<Attribute::NoUnwind>(A, *this, FnPos,
    ...
    if (IsVoidTy || CheckReturnedArgs(*RVAA)) {
      ...
      if (T.isKnown(NOT_CAPTURED_IN_MEM))
        return ChangeStatus::UNCHANGED;
      if (IsKnown && (IsVoidTy || RVAA->getState().isAtFixpoint())) {
...
struct AANoCaptureCallSiteArgument final : AANoCaptureImpl {
  ...
  ChangeStatus updateImpl(Attributor &A) override {
    ...
    const IRPosition &ArgPos = IRPosition::argument(*Arg);
    bool IsKnown;
    if (hasAssumedIRAttr<Attribute::NoCapture>(A, *this, ArgPos,
                                               DepClassTy::REQUIRED, IsKnown))
      return ChangeStatus::UNCHANGED;
    return indicatePessimisticFixpoint();
  }
  ...
  auto UsesCheck = [&](AllocationInfo &AI) {
    ...
    auto Pred = [&](const Use &U, bool &Follow) -> bool {
      ...
      if (auto *CB = dyn_cast<CallBase>(UserI)) {
        ...
        bool IsKnownNoCapture;
        bool IsAssumedNoCapture = hasAssumedIRAttr<Attribute::NoCapture>(
            A, *this, CBIRP, DepClassTy::OPTIONAL, IsKnownNoCapture);

        // If a call site argument use is nofree, we are fine.
        bool IsKnownNoFree;
        bool IsAssumedNoFree = hasAssumedIRAttr<Attribute::NoFree>(
...
bool AAMemoryBehaviorFloating::followUsersOfUseIn(Attributor &A, const Use &U,
  ...
  if (U.get()->getType()->isPointerTy()) {
    unsigned ArgNo = CB->getArgOperandNo(&U);
    bool IsKnownNoCapture;
    return hasAssumedIRAttr<Attribute::NoCapture>(
        A, *this, IRPosition::callsite_argument(*CB, ArgNo),
        DepClassTy::OPTIONAL, IsKnownNoCapture);
  }
  ...
  if (auto *CB = dyn_cast<CallBase>(&I)) {
    ...
    if (CBMemLocationAA) {
      ...
      if (CBMemLocationAA->isAssumedInaccessibleMemOnly()) {
        updateStateAndAccessesMap(AccessedLocs, NO_INACCESSIBLE_MEM, &I,
                                  nullptr, Changed, getAccessKindFromInst(&I));
        return AccessedLocs.getAssumed();
      }
    }

    uint32_t CBAssumedNotAccessedLocs =
        CBMemLocationAA && CBMemLocationAA->getAssumedNotAccessedLocation();
    ...
    if (HasGlobalAccesses) {
      ...
      if (!CBMemLocationAA ||
          !CBMemLocationAA->checkForAllAccessesToMemoryKind(
...
struct AAMemoryLocationCallSite final : AAMemoryLocationImpl {
  ...
  ChangeStatus updateImpl(Attributor &A) override {
    ...
    if (!FnAA ||
        !FnAA->checkForAllAccessesToMemoryKind(AccessPred, ALL_LOCATIONS))
      return indicatePessimisticFixpoint();
    return Changed ? ChangeStatus::CHANGED : ChangeStatus::UNCHANGED;
  }
...
struct AAValueConstantRangeFloating : AAValueConstantRangeImpl {
  ...
  calculateCmpInst(Attributor &A, CmpInst *CmpI, IntegerRangeState &T,
    ...
    auto *LHSAA = A.getAAFor<AAValueConstantRange>(
        *this, IRPosition::value(*LHS, getCallBaseContext()),
        DepClassTy::REQUIRED);
		if (!LHSAA) return false;
    QuerriedAAs.push_back(LHSAA);
    auto *RHSAA = A.getAAFor<AAValueConstantRange>(
        *this, IRPosition::value(*RHS, getCallBaseContext()),
        DepClassTy::REQUIRED);
		if (!RHSAA) return false;
    QuerriedAAs.push_back(RHSAA);
    auto LHSAARange = LHSAA->getAssumedConstantRange(A, CtxI);
    auto RHSAARange = RHSAA->getAssumedConstantRange(A, CtxI);
...
struct AAInterFnReachabilityFunction
  ...
  bool isReachableImpl(Attributor &A, RQITy &RQI,
    ...
    auto CheckCallBase = [&](Instruction &CBInst) {
      if (!IntraFnReachability || !IntraFnReachability->isAssumedReachable(A, *RQI.From, CBInst,
                                                  RQI.ExclusionSet))
        return true;
...
struct AAAssumptionInfoCallSite final : AAAssumptionInfoImpl {
  ...
  ChangeStatus updateImpl(Attributor &A) override {
    ...
    auto *AssumptionAA =
        A.getAAFor<AAAssumptionInfo>(*this, FnPos, DepClassTy::REQUIRED);
						if (!AssumptionAA ) return indicatePessimisticFixpoint();

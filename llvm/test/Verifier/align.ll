...
; CHECK: Wrong types for attribute: inalloca nest noalias nocapture nonnull readnone readonly signext sret zeroext byref(void) byval(void) preallocated(void) align 1 dereferenceable(1) dereferenceable_or_null(1)

...
; CHECK-LABEL: @test1(
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[H1:%.*]] = getelementptr <4 x i32>, <4 x i32>* [[H:%.*]], i64 1
; CHECK-NEXT:    [[VL:%.*]] = load <4 x i32>, <4 x i32>* [[H1]], align 16
; CHECK-NEXT:    [[V0:%.*]] = load <4 x i32>, <4 x i32>* [[H]], align 16
; CHECK-NEXT:    [[A:%.*]] = add <4 x i32> [[V0]], [[VL]]
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[H1:%.*]] = getelementptr <4 x i32>, <4 x i32>* [[H:%.*]], i64 1
; CHECK-NEXT:    store <4 x i32> [[D:%.*]], <4 x i32>* [[H1]], align 16
; CHECK-NEXT:    [[V0:%.*]] = load <4 x i32>, <4 x i32>* [[H]], align 16

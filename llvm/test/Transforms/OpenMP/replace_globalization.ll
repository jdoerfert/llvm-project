...
; CHECK-NEXT:    call void @use.internalized(ptr nofree readnone [[X]]) #[[ATTR3:[0-9]+]]
...
; CHECK:       master1:
; CHECK-NEXT:    call void @use.internalized(ptr nofree readnone addrspacecast (ptr addrspace(3) @x_shared to ptr)) #[[ATTR7:[0-9]+]]
...
; CHECK:       master2:
; CHECK-NEXT:    call void @use.internalized(ptr nofree readnone addrspacecast (ptr addrspace(3) @y_shared to ptr)) #[[ATTR3]]
...
; CHECK-NEXT:    call void @use.internalized(ptr nofree readnone [[Z]]) #[[ATTR3]]

...
; CHECK-NEXT:    br i1 [[EXEC_USER_CODE]], label [[USER_CODE_ENTRY:%.*]], label [[WORKER_EXIT:%.*]]
; CHECK:       user_code.entry:
; CHECK-NEXT:    call void @generic_helper() #[[ATTR8:[0-9]+]]
; CHECK-NEXT:    call void @__kmpc_target_deinit(ptr @[[GLOB1]], i8 2)
; CHECK-NEXT:    ret void
; CHECK:       worker.exit:
; CHECK-NEXT:    ret void
...
; CHECK-DISABLE-SPMDIZATION-NEXT:    br i1 [[EXEC_USER_CODE]], label [[USER_CODE_ENTRY:%.*]], label [[WORKER_EXIT:%.*]]
; CHECK-DISABLE-SPMDIZATION:       user_code.entry:
; CHECK-DISABLE-SPMDIZATION-NEXT:    call void @generic_helper() #[[ATTR8:[0-9]+]]
; CHECK-DISABLE-SPMDIZATION-NEXT:    call void @__kmpc_target_deinit(ptr @[[GLOB1]], i8 1)
; CHECK-DISABLE-SPMDIZATION-NEXT:    ret void
; CHECK-DISABLE-SPMDIZATION:       worker.exit:
; CHECK-DISABLE-SPMDIZATION-NEXT:    ret void
...
; CHECK-DISABLE-SPMDIZATION-NEXT:    call void @unknown() #[[ATTR9:[0-9]+]]
; CHECK-DISABLE-SPMDIZATION-NEXT:    ret void
;
entry:
...
; CHECK-DISABLE-SPMDIZATION-SAME: (i16 zeroext [[TMP0:%.*]], i32 [[TMP1:%.*]]) #[[ATTR3:[0-9]+]] {
; CHECK-DISABLE-SPMDIZATION-NEXT:  entry:
...
; CHECK-DISABLE-SPMDIZATION-SAME: () #[[ATTR6:[0-9]+]] {
; CHECK-DISABLE-SPMDIZATION-NEXT:  entry:
...
; CHECK-SAME: () #[[ATTR6]] {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    call void @leaf() #[[ATTR11:[0-9]+]]
; CHECK-NEXT:    ret void
;
; CHECK-DISABLE-SPMDIZATION-LABEL: define {{[^@]+}}@generic_helper
; CHECK-DISABLE-SPMDIZATION-SAME: () #[[ATTR6]] {
; CHECK-DISABLE-SPMDIZATION-NEXT:  entry:
; CHECK-DISABLE-SPMDIZATION-NEXT:    call void @leaf() #[[ATTR11:[0-9]+]]
; CHECK-DISABLE-SPMDIZATION-NEXT:    ret void
;
entry:
  call void @leaf() #5
...
; CHECK: attributes #[[ATTR8]] = { convergent nosync nounwind memory(write, inaccessiblemem: none) }
; CHECK: attributes #[[ATTR9]] = { convergent }
; CHECK: attributes #[[ATTR10]] = { nounwind memory(readwrite, argmem: none) }
; CHECK: attributes #[[ATTR11]] = { convergent nosync nounwind }
;.
...
; CHECK-DISABLE-SPMDIZATION: attributes #[[ATTR2]] = { memory(readwrite, argmem: none) }
...
; CHECK-DISABLE-SPMDIZATION: attributes #[[ATTR8]] = { convergent nosync nounwind memory(write, inaccessiblemem: none) }
; CHECK-DISABLE-SPMDIZATION: attributes #[[ATTR9]] = { convergent }
; CHECK-DISABLE-SPMDIZATION: attributes #[[ATTR10]] = { nounwind memory(readwrite, argmem: none) }
; CHECK-DISABLE-SPMDIZATION: attributes #[[ATTR11]] = { convergent nosync nounwind }
;.

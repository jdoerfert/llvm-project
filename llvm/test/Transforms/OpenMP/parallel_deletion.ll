...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    call void @unknown() #[[ATTR16:[0-9]+]]
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    call void @readonly() #[[ATTR14:[0-9]+]]
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    call void @readnone() #[[ATTR16]]
; CHECK-NEXT:    ret void
;
...
; CHECK-SAME: (ptr noalias nocapture nofree readnone [[DOTGLOBAL_TID_:%.*]], ptr noalias nocapture nofree readnone [[DOTBOUND_TID_:%.*]]) #[[ATTR4:[0-9]+]] {
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    call void @readonly() #[[ATTR14]]
; CHECK-NEXT:    ret void
;
...
; CHECK-SAME: (ptr noalias nocapture nofree readnone [[DOTGLOBAL_TID_:%.*]], ptr noalias nocapture nofree readnone [[DOTBOUND_TID_:%.*]]) #[[ATTR6:[0-9]+]] {
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 dereferenceable(4) [[A]]) #[[ATTR17:[0-9]+]]
...
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull [[A]]) #[[ATTR18:[0-9]+]]
; CHECK-NEXT:    ret void
;
...
; CHECK-SAME: (ptr noalias nocapture nofree readnone [[DOTGLOBAL_TID_:%.*]], ptr noalias nocapture nofree readnone [[DOTBOUND_TID_:%.*]], ptr nocapture nofree noundef nonnull align 4 dereferenceable(4) [[A:%.*]]) #[[ATTR7:[0-9]+]] {
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[OMP_GLOBAL_THREAD_NUM:%.*]] = call i32 @__kmpc_global_thread_num(ptr noundef nonnull readonly @[[GLOB0]]) #[[ATTR20:[0-9]+]]
; CHECK-NEXT:    [[TMP:%.*]] = load i32, ptr [[DOTGLOBAL_TID_]], align 4
...
; CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 noundef 4, ptr noundef nonnull align 4 [[A1]]) #[[ATTR17]]
...
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 noundef 4, ptr noundef nonnull [[A1]]) #[[ATTR18]]
; CHECK-NEXT:    ret void
;
...
; CHECK-SAME: (ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) [[ARG:%.*]], ptr nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) [[ARG1:%.*]]) #[[ATTR11:[0-9]+]] {
; CHECK-NEXT:  entry:

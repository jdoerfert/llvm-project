...
; CHECK: @[[GLOB1:[0-9]+]] = private unnamed_addr global [[STRUCT_IDENT_T:%.*]] { i32 0, i32 322, i32 0, i32 0, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i32 0, i32 0) }, align 8
; CHECK: @[[_GOMP_CRITICAL_USER__REDUCTION_VAR:[a-zA-Z0-9_$"\\.-]+]] = common global [8 x i32] zeroinitializer
; CHECK: @[[GLOB2:[0-9]+]] = private unnamed_addr global [[STRUCT_IDENT_T:%.*]] { i32 0, i32 18, i32 0, i32 0, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i32 0, i32 0) }, align 8
;.
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[CALL:%.*]] = call i32 @omp_get_thread_num() #[[ATTR12:[0-9]+]]
...
; CHECK-SAME: (i8* nocapture nofree nonnull readonly align 8 dereferenceable(8) [[ARG:%.*]], i8* nocapture nofree nonnull readonly align 8 dereferenceable(8) [[ARG1:%.*]]) #[[ATTR9:[0-9]+]] {
; CHECK-NEXT:  entry:
...
; CHECK: attributes #[[ATTR1]] = { readonly willreturn }
; CHECK: attributes #[[ATTR2]] = { nosync readnone willreturn }
; CHECK: attributes #[[ATTR3]] = { nofree nosync nounwind readnone willreturn }
; CHECK: attributes #[[ATTR4]] = { readonly }
; CHECK: attributes #[[ATTR5]] = { nosync readnone }
; CHECK: attributes #[[ATTR6]] = { inaccessiblemem_or_argmemonly nofree nosync nounwind }
; CHECK: attributes #[[ATTR7:[0-9]+]] = { argmemonly nofree nosync nounwind willreturn }
; CHECK: attributes #[[ATTR8:[0-9]+]] = { nounwind }
; CHECK: attributes #[[ATTR9]] = { nofree nosync nounwind willreturn }
; CHECK: attributes #[[ATTR10:[0-9]+]] = { convergent nounwind }
; CHECK: attributes #[[ATTR11:[0-9]+]] = { readnone }
; CHECK: attributes #[[ATTR12]] = { nounwind readonly }
;.
; CHECK: [[META0:![0-9]+]] = !{!1}

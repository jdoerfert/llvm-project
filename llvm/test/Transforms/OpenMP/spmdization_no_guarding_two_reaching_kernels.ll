...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    store i32 42, ptr addrspace(5) @G, align 4
; CHECK-NEXT:    ret void
;
; CHECK-DISABLE-SPMDIZATION-LABEL: define {{[^@]+}}@leaf
; CHECK-DISABLE-SPMDIZATION-SAME: () #[[ATTR5:[0-9]+]] {
; CHECK-DISABLE-SPMDIZATION-NEXT:  entry:
; CHECK-DISABLE-SPMDIZATION-NEXT:    store i32 42, ptr addrspace(5) @G, align 4
; CHECK-DISABLE-SPMDIZATION-NEXT:    ret void
;
entry:
  store i32 42, ptr addrspace(5) @G, align 4
  ret void
}
...
; CHECK: attributes #[[ATTR6]] = { convergent noinline nounwind memory(write) "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="sm_53" "target-features"="+ptx32,+sm_53" }
; CHECK: attributes #[[ATTR7]] = { convergent nounwind }
; CHECK: attributes #[[ATTR8]] = { convergent nosync nounwind }
;.
...
; CHECK-DISABLE-SPMDIZATION: attributes #[[ATTR6]] = { convergent noinline nounwind memory(write) "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="sm_53" "target-features"="+ptx32,+sm_53" }
; CHECK-DISABLE-SPMDIZATION: attributes #[[ATTR7]] = { convergent nounwind }
; CHECK-DISABLE-SPMDIZATION: attributes #[[ATTR8]] = { convergent nosync nounwind }
;.

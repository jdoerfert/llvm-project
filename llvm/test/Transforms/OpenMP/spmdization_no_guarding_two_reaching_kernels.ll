...
; CHECK-NEXT:    call void @__omp_outlined__(ptr readnone [[DOTADDR1]], ptr readnone [[DOTZERO_ADDR]]) #[[ATTR9:[0-9]+]]
; CHECK-NEXT:    ret void
;
...
; CHECK-DISABLE-SPMDIZATION-NEXT:    call void @__omp_outlined__(ptr readnone [[DOTADDR1]], ptr readnone [[DOTZERO_ADDR]]) #[[ATTR9:[0-9]+]]
; CHECK-DISABLE-SPMDIZATION-NEXT:    ret void
;
entry:
...
; CHECK: attributes #[[ATTR9]] = { nosync nounwind memory(write, argmem: none, inaccessiblemem: none) }
;.
...
; CHECK-DISABLE-SPMDIZATION: attributes #[[ATTR9]] = { nosync nounwind memory(write, argmem: none, inaccessiblemem: none) }
;.

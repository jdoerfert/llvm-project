; NOTE: Assertions have been autogenerated by utils/update_test_checks.py UTC_ARGS: -p --function-signature --scrub-attributes --check-globals
...
; CHECK: @.__omp_offloading_heavyComputation1.region_id = weak constant i8 0
; CHECK: @.offload_sizes.1 = private unnamed_addr constant [1 x i64] [i64 8]
; CHECK: @.offload_maptypes.2 = private unnamed_addr constant [1 x i64] [i64 800]
; CHECK: @.__omp_offloading_heavyComputation2.region_id = weak constant i8 0
; CHECK: @.offload_maptypes.3 = private unnamed_addr constant [2 x i64] [i64 35, i64 35]
; CHECK: @.__omp_offloading_heavyComputation3.region_id = weak constant i8 0
; CHECK: @.offload_sizes.2 = private unnamed_addr constant [2 x i64] [i64 4, i64 0]
; CHECK: @.offload_maptypes.4 = private unnamed_addr constant [2 x i64] [i64 800, i64 544]
; CHECK: @.offload_maptypes.5 = private unnamed_addr constant [1 x i64] [i64 33]
; CHECK: @0 = private unnamed_addr global %struct.ident_t { i32 0, i32 34, i32 0, i32 0, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str0, i32 0, i32 0) }, align 8
; CHECK: @.str0 = private unnamed_addr constant [23 x i8] c"
;.

...
; CHECK-NEXT:    tail call void @use(i32 [[TMP1]])
; CHECK-NEXT:    tail call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* nonnull @[[GLOB0]], i32 0, void (i32*, i32*, ...)* bitcast (void (i32*, i32*)* @.omp_outlined. to void (i32*, i32*, ...)*))
...
; CHECK: attributes #[[ATTR1]] = { "no_openmp" }
; CHECK: attributes #[[ATTR2]] = { "no_openmp_routines" }
;.
; CHECK: [[META0:![0-9]+]] = !{!1}

...
; CHECK:      call i8 @__kmpc_target_region_kernel_init(%struct.ident_t* @{{[a-zA-Z0-9]*}}, i1 true,
; CHECK:      call void @__kmpc_target_region_kernel_parallel(%struct.ident_t* @{{[a-zA-Z0-9]*}}, i1 true,
; CHECK-NEXT: call void @__kmpc_barrier_simple_spmd(%struct.ident_t* @{{[a-zA-Z0-9]*}}, i32 0)
; CHECK:      call void @__kmpc_target_region_kernel_deinit(%struct.ident_t* @{{[a-zA-Z0-9]*}}, i1 true,
;
...
for.body:                                         ; preds = %for.cond
  ...
  store i32* %i, i32** %8
  call void @__kmpc_target_region_kernel_parallel(%struct.ident_t* @0, i1 false, i1 true, void (i8*, i8*)* @.omp_TRegion._wrapper, i8* undef, i16 0, i8* %5, i16 24, i1 false)
  br label %for.inc
...
declare !callback !17 void @__kmpc_target_region_kernel_parallel(%struct.ident_t*, i1, i1, void (i8*, i8*)* nocapture, i8* nocapture, i16, i8* nocapture readonly, i16, i1)
...
.execute:                                         ; preds = %entry
  ...
  call void @__kmpc_target_region_kernel_parallel(%struct.ident_t* @0, i1 false, i1 true, void (i8*, i8*)* @.omp_TRegion.1_wrapper, i8* undef, i16 0, i8* %2, i16 16, i1 false)
  ...
  store i32** %B.addr, i32*** %7
  call void @__kmpc_target_region_kernel_parallel(%struct.ident_t* @0, i1 false, i1 true, void (i8*, i8*)* @.omp_TRegion.2_wrapper, i8* undef, i16 0, i8* %5, i16 16, i1 false)
  ...
  call void @__kmpc_target_region_kernel_parallel(%struct.ident_t* @0, i1 false, i1 true, void (i8*, i8*)* @.omp_TRegion.3_wrapper, i8* undef, i16 0, i8* %8, i16 16, i1 false)
  br label %.omp.deinit
...
entry:
  ...
  call void @__kmpc_target_region_kernel_parallel(%struct.ident_t* @0, i1 false, i1 true, void (i8*, i8*)* @.omp_TRegion.4_wrapper, i8* undef, i16 0, i8* %0, i16 24, i1 false)
  ret void
}
; Function Attrs: nounwind

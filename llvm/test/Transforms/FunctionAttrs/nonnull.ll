...
; RUN: opt -attributor --attributor-disable=false -attributor-max-iterations-verify -attributor-max-iterations=24 -S < %s | FileCheck %s --check-prefixes=BOTH,ATTRIBUTOR
...
declare void @use_i8_ptr(i8* readnone nocapture)

...
; ALL-LABEL: define {{[^@]+}}@callee_t0f
; ALL-SAME: (i8* nocapture readnone [[TP13:%.*]], i8* nocapture readnone [[TP14:%.*]], i8* nocapture readnone [[TP15:%.*]], i8* nocapture readnone [[TP16:%.*]], i8* nocapture readnone [[TP17:%.*]], ...)
; ALL-NEXT:  entry:
; ALL-NEXT:    ret void
;
entry:

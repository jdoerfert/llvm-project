...
; ATTRIBUTOR-NEXT:    store i32 [[TMP0:%.*]], i32* [[DATA_PRIV_CAST]]
=======
; ATTRIBUTOR-NEXT:    store i32 [[TMP0]], i32* [[DATA_PRIV_CAST]], align 8
...
=======
; ATTRIBUTOR-NEXT:    store i32 [[TMP1]], i32* [[DATA_PRIV_0_1]]
; ATTRIBUTOR-NEXT:    [[TMP3:%.*]] = call i8* @foo(%pair* nonnull align 8 dereferenceable(8) [[DATA_PRIV]])
>>>>>>> 2bf5733254a... FIXES FIXES FIXES
...
; ATTRIBUTOR-NEXT:    [[DATA_CAST:%.*]] = bitcast %pair* [[DATA:%.*]] to i32*
=======
; ATTRIBUTOR-SAME: (%pair* nocapture readonly byval [[DATA:%.*]])
; ATTRIBUTOR-NEXT:    [[DATA_CAST:%.*]] = bitcast %pair* [[DATA]] to i32*
>>>>>>> 2bf5733254a... FIXES FIXES FIXES

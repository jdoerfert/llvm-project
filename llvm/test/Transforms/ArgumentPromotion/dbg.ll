...
; ARGPROMOTION-NEXT:    ret void
;
; ATTRIBUTOR-LABEL: define {{[^@]+}}@test_byval
...
; ATTRIBUTOR-NEXT:    store i32 [[TMP0:%.*]], i32* [[P_PRIV_CAST]]
=======
; ATTRIBUTOR-NEXT:    store i32 [[TMP0]], i32* [[P_PRIV_CAST]], align 8
>>>>>>> 2bf5733254a... FIXES FIXES FIXES
...
=======
; ATTRIBUTOR-NEXT:    store i32 [[TMP1]], i32* [[P_PRIV_0_1]]
; ATTRIBUTOR-NEXT:    call void @use(%struct.pair* nonnull align 8 dereferenceable(8) [[P_PRIV]])
>>>>>>> 2bf5733254a... FIXES FIXES FIXES
; ATTRIBUTOR-NEXT:    ret void
;
  call void @use(%struct.pair* %P)
  ret void
}
...
; ATTRIBUTOR-NEXT:    [[P_CAST:%.*]] = bitcast %struct.pair* [[P:%.*]] to i32*, !dbg !5
=======
; ATTRIBUTOR-SAME: (i32** nocapture readonly [[Y:%.*]], %struct.pair* nocapture readonly [[P:%.*]])
; ATTRIBUTOR-NEXT:    call void @test(i32** nocapture readonly [[Y]]), !dbg !4
; ATTRIBUTOR-NEXT:    [[P_CAST:%.*]] = bitcast %struct.pair* [[P]] to i32*, !dbg !5
>>>>>>> 2bf5733254a... FIXES FIXES FIXES
...
; ATTRIBUTOR-NEXT:    call void @test_byval(i32 [[TMP1]], i32 [[TMP2]]), !dbg !5
; ATTRIBUTOR-NEXT:    ret void
;

...
; ALL-SAME: (<8 x i64>* [[ARG:%.*]], <8 x i64> [[ARG1_VAL:%.*]]) #0
; ALL-NEXT:  bb:
...
; ALL-SAME: (<8 x i64>* [[ARG:%.*]], <8 x i64> [[ARG1_VAL:%.*]]) #1
; ALL-NEXT:  bb:
; ALL-NEXT:    store <8 x i64> [[ARG1_VAL:%.*]], <8 x i64>* [[ARG:%.*]]
; ALL-NEXT:    ret void
;
...
; ALL-SAME: (<8 x i64>* [[ARG:%.*]], <8 x i64>* readonly [[ARG1:%.*]]) #1
; ALL-NEXT:  bb:
...
; ALL-SAME: (<8 x i64>* [[ARG:%.*]], <8 x i64>* readonly [[ARG1:%.*]]) #2
; ALL-NEXT:  bb:
; ALL-NEXT:    [[TMP:%.*]] = load <8 x i64>, <8 x i64>* [[ARG1:%.*]]
; ALL-NEXT:    store <8 x i64> [[TMP]], <8 x i64>* [[ARG:%.*]]
; ALL-NEXT:    ret void
...
; ALL-SAME: (<8 x i64>* [[ARG:%.*]], <8 x i64> [[ARG1_VAL:%.*]]) #3
; ALL-NEXT:  bb:
; ALL-NEXT:    store <8 x i64> [[ARG1_VAL:%.*]], <8 x i64>* [[ARG:%.*]]
; ALL-NEXT:    ret void
;
...
; ALL-SAME: (<8 x i64>* [[ARG:%.*]], <8 x i64> [[ARG1_VAL:%.*]]) #4
; ALL-NEXT:  bb:
; ALL-NEXT:    store <8 x i64> [[ARG1_VAL:%.*]], <8 x i64>* [[ARG:%.*]]
; ALL-NEXT:    ret void
;

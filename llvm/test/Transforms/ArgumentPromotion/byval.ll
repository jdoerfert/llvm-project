...
; ARGPROMOTION-SAME: (i32 [[B_0:%.*]], i64 [[B_1:%.*]]) #0
...
; ARGPROMOTION-LABEL: define {{[^@]+}}@main() #0
; ARGPROMOTION-NEXT:  entry:
...
; ARGPROMOTION-NEXT:    call void @f(i32 [[S_0_VAL]], i64 [[S_1_VAL]]) #0
...
; ARGPROMOTION-NEXT:    call void @g(i32 [[S_01_VAL]], i64 [[S_12_VAL]]) #0

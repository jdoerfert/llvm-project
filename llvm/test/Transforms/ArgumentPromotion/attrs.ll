...
; It is unclear why we should not promote the byval but argument promotion doesn't:
...
; ATTRIBUTOR-SAME: (i32* nocapture readnone [[X:%.*]])
; ATTRIBUTOR-NEXT:  entry:
<<<<<<< HEAD
...
; ATTRIBUTOR-NEXT:    call void @f(i32 [[TMP0]], i64 [[TMP1]], i32 [[TMP2]])
=======
; ATTRIBUTOR-NEXT:    [[TMP0:%.*]] = load i32, i32* [[X]]

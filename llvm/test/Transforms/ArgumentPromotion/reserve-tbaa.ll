...
; ARGPROMOTION-NEXT:  entry:
; ARGPROMOTION-NEXT:    [[TMP0:%.*]] = load i32**, i32*** @e, align 8, !tbaa !3
; ARGPROMOTION-NEXT:    store i32* @g, i32** [[TMP0]], align 8, !tbaa !3
; ARGPROMOTION-NEXT:    [[TMP1:%.*]] = load i32*, i32** @a, align 8, !tbaa !3
; ARGPROMOTION-NEXT:    store i32 1, i32* [[TMP1]], align 4, !tbaa !5
; ARGPROMOTION-NEXT:    [[G_VAL:%.*]] = load i32, i32* @g, align 4, !tbaa !5
; ARGPROMOTION-NEXT:    [[C_VAL:%.*]] = load i64, i64* @c, align 8, !tbaa !7

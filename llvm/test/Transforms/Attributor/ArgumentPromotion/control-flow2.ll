...
; IS__CGSCC_OPM-SAME: (i1 noundef [[C:%.*]], i32* noalias nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) [[P:%.*]]) #[[ATTR0:[0-9]+]] {
...
; IS__CGSCC_NPM-SAME: (i1 noundef [[C:%.*]], i32 noundef [[TMP0:%.*]]) #[[ATTR0:[0-9]+]] {
...
; IS__CGSCC_OPM-NEXT:    [[X:%.*]] = call i32 @callee(i1 noundef false, i32* noalias nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) [[A]]) #[[ATTR2:[0-9]+]]
; IS__CGSCC_OPM-NEXT:    ret i32 [[X]]
;
; IS__CGSCC_NPM: Function Attrs: nofree norecurse nosync nounwind readnone willreturn
...
; IS__CGSCC_NPM-NEXT:    [[X:%.*]] = call i32 @callee(i1 noundef false, i32 noundef 17) #[[ATTR1:[0-9]+]]
; IS__CGSCC_NPM-NEXT:    ret i32 [[X]]
;

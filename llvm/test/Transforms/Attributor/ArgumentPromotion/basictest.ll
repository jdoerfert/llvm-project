...
; CGSCC-NEXT:    [[C:%.*]] = call i32 @test(i32 noundef 1, ptr noalias nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) [[B_PRIV]])
; CGSCC-NEXT:    ret i32 [[C]]
;
  %A = alloca i32
  store i32 1, ptr %A
...
; CGSCC-NEXT:    [[X:%.*]] = call i32 @caller(i32 noundef 2)

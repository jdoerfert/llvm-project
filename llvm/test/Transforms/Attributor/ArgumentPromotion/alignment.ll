...
; IS__CGSCC_NPM-SAME: (i32 [[TMP0:%.*]], i64 noundef [[TMP1:%.*]]) #[[ATTR0:[0-9]+]] {
...
; IS__CGSCC_NPM-SAME: (i32 noundef [[TMP0:%.*]]) #[[ATTR0]] {
; IS__CGSCC_NPM-NEXT:    [[A_PRIV:%.*]] = alloca i32, align 4
...
; IS__CGSCC_NPM-NEXT:    [[C:%.*]] = call i32 @test(i32 [[TMP2]], i64 noundef 1) #[[ATTR1:[0-9]+]]
; IS__CGSCC_NPM-NEXT:    ret i32 [[C]]
;
  %B = alloca i64
  store i64 1, i64* %B
...
; IS__CGSCC_NPM-NEXT:    [[X:%.*]] = call i32 @caller(i32 noundef 2) #[[ATTR2:[0-9]+]]

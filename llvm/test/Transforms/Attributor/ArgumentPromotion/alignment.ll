...
; TUNIT-NEXT:    call void @g(i32 [[TMP0]]) #[[ATTR0:[0-9]+]]
; TUNIT-NEXT:    ret void
;
...
; CGSCC-NEXT:    [[C:%.*]] = call i32 @test(ptr noalias nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) [[A_PRIV]], i64 noundef 1) #[[ATTR4:[0-9]+]]
; CGSCC-NEXT:    ret i32 [[C]]
;
  %B = alloca i64
  store i64 1, ptr %B
...
; CGSCC-NEXT:    [[X:%.*]] = call i32 @caller(i32 noundef 2) #[[ATTR5:[0-9]+]]
...
;.
; TUNIT: attributes #[[ATTR0]] = { memory(readwrite, argmem: read) }
; TUNIT: attributes #[[ATTR1]] = { mustprogress nofree norecurse nosync nounwind willreturn memory(none) }
;.
; CGSCC: attributes #[[ATTR0]] = { memory(readwrite, argmem: read) }

...
; IS__TUNIT____-SAME: (i1 noundef [[C:%.*]], i32* nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) [[A:%.*]]) #[[ATTR0:[0-9]+]] {
...
; IS__CGSCC____-SAME: (i1 noundef [[C:%.*]], i32* nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) [[A:%.*]]) #[[ATTR0:[0-9]+]] {
...
; IS__TUNIT____-NEXT:    [[X:%.*]] = call i32 @callee(i1 noundef false, i32* nocapture nofree readonly align 4 [[A]]) #[[ATTR1:[0-9]+]]
...
; IS__CGSCC____-NEXT:    [[X:%.*]] = call i32 @callee(i1 noundef false, i32* nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) [[A]]) #[[ATTR1:[0-9]+]]

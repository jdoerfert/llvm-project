...
; IS__CGSCC____-SAME: (%T* noalias nocapture nofree noundef nonnull readnone align 8 dereferenceable(16) [[P:%.*]]) #[[ATTR0:[0-9]+]] {
...
; IS__CGSCC____-NEXT:  entry:
; IS__CGSCC____-NEXT:    [[V:%.*]] = call i32 @test(%T* noalias nocapture nofree noundef nonnull readnone align 8 dereferenceable(16) @G) #[[ATTR1:[0-9]+]]
; IS__CGSCC____-NEXT:    ret i32 [[V]]
;
entry:
  %v = call i32 @test(%T* @G)

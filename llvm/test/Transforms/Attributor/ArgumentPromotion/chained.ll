...
; IS__TUNIT____-SAME: (i32** nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) [[X:%.*]]) #[[ATTR0:[0-9]+]] {
...
; IS__CGSCC____-SAME: (i32** noalias nocapture nofree noundef nonnull readnone align 8 dereferenceable(8) [[X:%.*]]) #[[ATTR0:[0-9]+]] {
...
; IS__TUNIT____-NEXT:  entry:
; IS__TUNIT____-NEXT:    [[X:%.*]] = call i32 @test(i32** nocapture nofree noundef nonnull readonly align 8 dereferenceable(8) @G2) #[[ATTR0]]
...
; IS__CGSCC____-NEXT:  entry:
; IS__CGSCC____-NEXT:    [[X:%.*]] = call i32 @test(i32** noalias nocapture nofree noundef nonnull readnone align 8 dereferenceable(8) @G2) #[[ATTR1:[0-9]+]]

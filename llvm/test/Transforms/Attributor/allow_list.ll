...
; CHECK_DISABLED: Function Attrs: nofree noinline nosync nounwind readnone uwtable willreturn
; CHECK_DISABLED-LABEL: define {{[^@]+}}@range_use1
; CHECK_DISABLED-SAME: () [[ATTR0:#.*]] {
; CHECK_DISABLED-NEXT:    ret i32 1
;
; CHECK_ENABLED: Function Attrs: nofree noinline nosync nounwind readnone uwtable willreturn
; CHECK_ENABLED-LABEL: define {{[^@]+}}@range_use1
; CHECK_ENABLED-SAME: () [[ATTR0:#.*]] {
; CHECK_ENABLED-NEXT:    ret i32 1
;
; CHECK_DISABLED_FUNCTION: Function Attrs: nofree noinline nosync nounwind readnone uwtable willreturn
; CHECK_DISABLED_FUNCTION-LABEL: define {{[^@]+}}@range_use1
; CHECK_DISABLED_FUNCTION-SAME: () [[ATTR0:#.*]] {
; CHECK_DISABLED_FUNCTION-NEXT:    ret i32 1
;

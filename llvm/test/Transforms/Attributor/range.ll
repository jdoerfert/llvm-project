...
; IS________NPM-NEXT:    [[CALL:%.*]] = tail call i32 @test4-f1(i32 [[U]]) #[[ATTR4:[0-9]+]], !range [[RNG3:![0-9]+]]
...
; IS________NPM-SAME: (i32 [[U:%.*]]) #[[ATTR1]] {
; IS________NPM-NEXT:  entry:
; IS________NPM-NEXT:    [[CALL:%.*]] = tail call i32 @test4-f2(i32 [[U]]) #[[ATTR4]], !range [[RNG4:![0-9]+]]
; IS________NPM-NEXT:    ret i32 [[CALL]]
;
entry:
...
;
; IS________NPM-LABEL: define {{[^@]+}}@test-5() {
; IS________NPM-NEXT:  entry:
; IS________NPM-NEXT:    [[CALL:%.*]] = call noundef i32 @rec(i32 noundef 0), !range [[RNG5:![0-9]+]]
; IS________NPM-NEXT:    ret i32 [[CALL]]
;
; IS__CGSCC_OPM-LABEL: define {{[^@]+}}@test-5() {
; IS__CGSCC_OPM-NEXT:  entry:
; IS__CGSCC_OPM-NEXT:    [[CALL:%.*]] = call noundef i32 @rec(i32 noundef 0), !range [[RNG4:![0-9]+]]
...
; IS________NPM-NEXT:    [[R1:%.*]] = call i32 @ret1or2(i1 [[C1]]) #[[ATTR4]], !range [[RNG6:![0-9]+]]
; IS________NPM-NEXT:    [[R2:%.*]] = call i32 @ret1or2(i1 [[C2]]) #[[ATTR4]], !range [[RNG6]]
...
; IS________NPM:       t:
; IS________NPM-NEXT:    [[RET1:%.*]] = call noundef i32 @func(i1 noundef true) #[[ATTR4]], !range [[RNG5]]
; IS________NPM-NEXT:    ret i32 [[RET1]]
; IS________NPM:       f:
; IS________NPM-NEXT:    [[RET2:%.*]] = call noundef i32 @func(i1 noundef false) #[[ATTR4]], !range [[RNG5]]
...
; CHECK: Function Attrs: nofree norecurse nosync nounwind readnone willreturn
; CHECK-LABEL: define {{[^@]+}}@non_zero
; CHECK-SAME: (i8 [[V:%.*]]) #[[ATTR1]] {
...
; IS________NPM-NEXT:    br i1 [[C]], label [[T:%.*]], label [[F:%.*]]
; IS________NPM:       t:
; IS________NPM-NEXT:    [[R:%.*]] = call i1 @non_zero(i8 [[L]]) #[[ATTR4]]
...
; IS________NPM: [[RNG3]] = !{i32 0, i32 -2147483648}
; IS________NPM: [[RNG4]] = !{i32 1, i32 -2147483648}
; IS________NPM: [[RNG5]] = !{i32 0, i32 2}
; IS________NPM: [[RNG6]] = !{i32 1, i32 3}
;.

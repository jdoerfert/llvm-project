...
; OLD_PM-NEXT:    [[A:%.*]] = tail call i32 @test0(i32* noalias nocapture nofree readonly [[P]]) #{{[0-9]+}}, !range !0
; OLD_PM-NEXT:    ret i32 [[A]]
;
; NEW_PM-LABEL: define {{[^@]+}}@test0-range-check
; NEW_PM-SAME: (i32* nocapture nofree readonly [[P:%.*]])
; NEW_PM-NEXT:    [[A:%.*]] = tail call i32 @test0(i32* noalias nocapture nofree readonly [[P]]) #{{[0-9]+}}, !range !0
...
; MODULE-NEXT:    [[A:%.*]] = tail call i32 @test0(i32* noalias nocapture nofree readonly [[P]]) #{{[0-9]+}}, !range !0
...
; OLD_PM-SAME: (i32* nocapture nofree readonly [[P:%.*]])
; OLD_PM-NEXT:    [[RET:%.*]] = tail call i32 @test0(i32* noalias nocapture nofree readonly [[P]]) #{{[0-9]+}}, !range !0
...
; NEW_PM-SAME: (i32* nocapture nofree readonly [[P:%.*]])
; NEW_PM-NEXT:    [[RET:%.*]] = tail call i32 @test0(i32* noalias nocapture nofree readonly [[P]]) #{{[0-9]+}}, !range !0
...
; MODULE-SAME: (i32* nocapture nofree readonly [[P:%.*]])
; MODULE-NEXT:    [[RET:%.*]] = tail call i32 @test0(i32* noalias nocapture nofree readonly [[P]]) #{{[0-9]+}}, !range !0
...
; OLD_PM-SAME: (i32* nocapture nofree readonly [[P:%.*]])
; OLD_PM-NEXT:    [[RES:%.*]] = tail call i32 @test1(i32* noalias nocapture nofree readonly [[P]]) #{{[0-9]+}}, !range !2
; OLD_PM-NEXT:    [[CMP:%.*]] = icmp eq i32 [[RES]], 500
; OLD_PM-NEXT:    ret i1 [[CMP]]
;
; NEW_PM-LABEL: define {{[^@]+}}@test1-check
; NEW_PM-SAME: (i32* nocapture nofree readonly [[P:%.*]])
; NEW_PM-NEXT:    [[RES:%.*]] = tail call i32 @test1(i32* noalias nocapture nofree readonly [[P]]) #{{[0-9]+}}, !range !2
...
; MODULE-SAME: (i32* nocapture nofree readonly [[P:%.*]])
; MODULE-NEXT:    [[RES:%.*]] = tail call i32 @test1(i32* noalias nocapture nofree readonly [[P]]) #{{[0-9]+}}, !range !2

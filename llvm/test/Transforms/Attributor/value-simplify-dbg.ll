...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = call i32 @speculatable()
; CHECK-NEXT:    [[TMP1:%.*]] = add i32 [[TMP0]], 1
; CHECK-NEXT:    [[TMP2:%.*]] = call i32 @speculatable()
; CHECK-NEXT:    [[TMP3:%.*]] = add i32 [[TMP2]], 1
; CHECK-NEXT:    call void @use(i32 noundef [[TMP3]]), !dbg [[DBG19:![0-9]+]]
...
; CHECK-SAME: () #[[ATTR0:[0-9]+]] !dbg [[DBG21:![0-9]+]] {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[CALL:%.*]] = call i32 @speculatable(), !dbg [[DBG22:![0-9]+]]
...
; CHECK: [[META18:![0-9]+]] = !{}
; CHECK: [[DBG19]] = !DILocation(line: 5, column: 5, scope: !15)
; CHECK: [[DBG20]] = !DILocation(line: 6, column: 1, scope: !15)
; CHECK: [[DBG21]] = distinct !DISubprogram(name: "src", scope: !5, file: !5, line: 9, type: !16, scopeLine: 9, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !18)
; CHECK: [[DBG22]] = !DILocation(line: 10, column: 9, scope: !21)
; CHECK: [[DBG23]] = !DILocation(line: 11, column: 1, scope: !21)
;.

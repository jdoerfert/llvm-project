...
; CHECK-NEXT:    call void @c2(i32* nofree writeonly [[Q]]) #[[ATTR17:[0-9]+]]
; CHECK-NEXT:    ret void
;
  call void @c2(i32* %q)
  ret void
...
; CHECK-NEXT:    [[PTR:%.*]] = call i1* @lookup_bit(i32* noalias nofree readnone [[Q]], i32 [[BITNO]]) #[[ATTR18:[0-9]+]]
...
; IS__TUNIT____-NEXT:    [[TMP1:%.*]] = call i32 @nc1(i32* nofree [[Q]], i32* nocapture nofree [[P]], i1 noundef false) #[[ATTR19:[0-9]+]]
...
; IS__TUNIT____-NEXT:    call void @external(i8* readonly [[P]]) #[[ATTR20:[0-9]+]]
; IS__TUNIT____-NEXT:    ret void
;
...
; CHECK-SAME: (i32* nocapture nofree noundef nonnull dereferenceable(4) [[P:%.*]]) #[[ATTR9:[0-9]+]] {
...
; CHECK-SAME: (i32** nocapture nofree noundef nonnull dereferenceable(8) [[P:%.*]], i32* nofree [[Q:%.*]]) #[[ATTR9]] {
...
; CHECK-SAME: (i32* nocapture nofree noundef nonnull dereferenceable(4) [[P:%.*]]) #[[ATTR9]] {
...
; CHECK-SAME: (i32* nofree align 4 [[X:%.*]]) #[[ATTR9]] {
; CHECK-NEXT:  entry:
...
; IS__TUNIT____-NEXT:    [[B:%.*]] = call i8* @llvm.launder.invariant.group.p0i8(i8* nofree [[P]]) #[[ATTR21:[0-9]+]]
...
; IS__TUNIT____-NEXT:    [[B:%.*]] = call i8* @llvm.launder.invariant.group.p0i8(i8* nofree [[P]]) #[[ATTR21]]
...
; IS__TUNIT____-NEXT:  entry:
; IS__TUNIT____-NEXT:    [[B:%.*]] = call i8* @llvm.strip.invariant.group.p0i8(i8* noalias nofree readnone [[P]]) #[[ATTR22:[0-9]+]]
; IS__TUNIT____-NEXT:    store i8 42, i8* [[B]], align 1
; IS__TUNIT____-NEXT:    ret void
;
...
; IS__TUNIT____-NEXT:    [[B:%.*]] = call i8* @llvm.strip.invariant.group.p0i8(i8* noalias nofree readnone [[P]]) #[[ATTR22]]
...
; CHECK-SAME: (i32* nofree readnone dereferenceable_or_null(4) [[X:%.*]]) #[[ATTR12:[0-9]+]] {
; CHECK-NEXT:    [[TMP1:%.*]] = bitcast i32* [[X]] to i8*
; CHECK-NEXT:    [[TMP2:%.*]] = icmp eq i8* [[TMP1]], null
; CHECK-NEXT:    ret i1 [[TMP2]]
;
...
; CHECK-SAME: (i8* [[PTR:%.*]], i8* nocapture nofree noundef nonnull writeonly dereferenceable(1) [[WPTR:%.*]]) #[[ATTR14:[0-9]+]] {
...
; IS__TUNIT____: attributes #[[ATTR12]] = { nofree norecurse nosync nounwind null_pointer_is_valid readnone willreturn }
...
; IS__TUNIT____: attributes #[[ATTR17]] = { nofree nosync nounwind willreturn writeonly }
; IS__TUNIT____: attributes #[[ATTR18]] = { nofree nounwind readnone willreturn }
; IS__TUNIT____: attributes #[[ATTR19]] = { nofree nosync nounwind willreturn }
; IS__TUNIT____: attributes #[[ATTR20]] = { nounwind }
; IS__TUNIT____: attributes #[[ATTR21]] = { willreturn }
; IS__TUNIT____: attributes #[[ATTR22]] = { readnone willreturn }
;.

...
; CGSCC-NEXT:  entry:
; CGSCC-NEXT:    call void @level2Kernelall_early() #[[ATTR5]]
...
; CGSCC-NEXT:    br i1 [[TOBOOL]], label [[IF_THEN:%.*]], label [[IF_ELSE:%.*]]
; CGSCC:       if.then:
; CGSCC-NEXT:    call void @level2a(ptr noalias nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) [[LOCAL]]) #[[ATTR5]]
; CGSCC-NEXT:    br label [[IF_END:%.*]]
; CGSCC:       if.else:
; CGSCC-NEXT:    call void @level2b(ptr noalias nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) [[LOCAL]]) #[[ATTR5]]
; CGSCC-NEXT:    br label [[IF_END]]
; CGSCC:       if.end:

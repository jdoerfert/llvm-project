...
; IS__CGSCC____-SAME: (i32* nofree noundef nonnull readnone dereferenceable(4) "no-capture-maybe-returned" [[ARG:%.*]]) #[[ATTR1]] {
; IS__CGSCC____-NEXT:    [[CALL:%.*]] = call noalias noundef nonnull dereferenceable(4) i32* @test_inalloca(i32* noalias nofree noundef nonnull writeonly inalloca(i32) dereferenceable(4) "no-capture-maybe-returned" [[ARG]]) #[[ATTR6:[0-9]+]]
...
; IS__CGSCC____-NEXT:    [[CALL:%.*]] = call noundef nonnull align 4294967296 dereferenceable(4) i32* @test_preallocated(i32* noalias nocapture nofree noundef writeonly preallocated(i32) align 4294967296 null) #[[ATTR8:[0-9]+]] [ "preallocated"(token [[C]]) ]
; IS__CGSCC____-NEXT:    ret i32* [[CALL]]
;
...
; IS________NPM-LABEL: define {{[^@]+}}@test_liveness
; IS________NPM-SAME: (i1 [[C:%.*]]) #[[ATTR1]] {
; IS________NPM-NEXT:  entry:

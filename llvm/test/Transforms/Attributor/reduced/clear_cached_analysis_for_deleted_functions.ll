...
; CGSCC: Function Attrs: nofree noreturn nounwind memory(readwrite, inaccessiblemem: none)
...
;.
; CGSCC: attributes #[[ATTR0]] = { nofree noreturn nounwind memory(readwrite, inaccessiblemem: none) }
; CGSCC: attributes #[[ATTR1]] = { mustprogress nofree norecurse nosync nounwind willreturn memory(none) }
; CGSCC: attributes #[[ATTR2]] = { mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) }
; CGSCC: attributes #[[ATTR3]] = { nofree memory(argmem: read) }
;.

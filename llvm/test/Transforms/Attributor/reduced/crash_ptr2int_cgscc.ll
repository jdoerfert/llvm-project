...
; CHECK: Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none)
...
;.
; CHECK: attributes #[[ATTR0]] = { nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) }
;.

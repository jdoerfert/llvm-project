...
; RUN: opt -attributor  -attributor-max-iterations-verify -attributor-annotate-everything -attributor-max-iterations=1 -S < %s
; RUN: opt -attributor-cgscc  -attributor-annotate-everything -attributor-max-iterations=1 -S < %s
; RUN: opt -passes=attributor  -attributor-max-iterations-verify -attributor-annotate-everything -attributor-max-iterations=1 -S < %s
; RUN: opt -passes='attributor-cgscc'  -attributor-annotate-everything -attributor-max-iterations=1 -S < %s

...
; CHECK: Function Attrs: nofree norecurse nounwind memory(readwrite, argmem: write, inaccessiblemem: none)
...
;.
; CHECK: attributes #[[ATTR0]] = { nofree norecurse nounwind memory(readwrite, argmem: write, inaccessiblemem: none) }
;.

...
; CHECK-NEXT:    tail call void @usei8(ptr noalias nocapture nofree [[MALLOC_CAST]]) #[[ATTR9:[0-9]+]]
; CHECK-NEXT:    ret void
;
bb:
...
; CHECK:       not_entry:
; CHECK-NEXT:    [[MALLOC_CAST:%.*]] = addrspacecast ptr addrspace(5) [[I_H2S]] to ptr
; CHECK-NEXT:    tail call void @usei8(ptr noalias nocapture nofree [[MALLOC_CAST]]) #[[ATTR9]]
; CHECK-NEXT:    ret void
;
entry:
  br label %not_entry
...
; CHECK-NEXT:    call void @usei8(ptr nocapture nofree [[I]]) #[[ATTR10:[0-9]+]]
...
; CHECK-NEXT:    call void @usei8(ptr nocapture nofree [[MALLOC_CAST]]) #[[ATTR10]]
; CHECK-NEXT:    ret void
;
bb:
  %i = tail call noalias ptr @__kmpc_alloc_shared(i64 4)

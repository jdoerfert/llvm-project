...
; CHECK-SAME: (ptr nocapture nofree nonnull readnone align 4 dereferenceable(4) [[THREAD_LOCAL_PTR:%.*]], ptr nocapture nofree nonnull readnone align 4 dereferenceable(4) [[SHARED_PTR:%.*]]) #[[ATTR0:[0-9]+]] {
; CHECK-NEXT:  entry:
...
; CGSCC-NEXT:  entry:
; CGSCC-NEXT:    call void @broker(ptr noalias nocapture nofree noundef nonnull readnone align 4 dereferenceable(4) @gtl, ptr noundef nonnull @callee, ptr noalias nocapture nofree noundef nonnull readnone align 4 dereferenceable(4) @gsh)
; CGSCC-NEXT:    ret void
;
entry:

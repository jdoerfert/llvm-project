...
; TUNIT-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr noundef nonnull align 8 dereferenceable(24) @[[GLOB1]], i32 noundef 3, ptr noundef nonnull @.omp_outlined., ptr nocapture nofree nonnull align 4 dereferenceable(4) undef, ptr nocapture nofree nonnull align 4 dereferenceable(4) undef, i64 undef)
; TUNIT-NEXT:    ret void
;
...
; CGSCC-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr noundef nonnull align 8 dereferenceable(24) @[[GLOB1]], i32 noundef 3, ptr noundef nonnull @.omp_outlined., ptr nocapture nofree noundef nonnull align 4 dereferenceable(4) [[N_ADDR]], ptr nocapture nofree noundef nonnull align 4 dereferenceable(4) [[P]], i64 noundef 4617315517961601024)
; CGSCC-NEXT:    ret void
;
entry:
...
; TUNIT-SAME: (ptr noalias nocapture nofree readonly [[DOTGLOBAL_TID_:%.*]], ptr noalias nocapture nofree readnone [[DOTBOUND_TID_:%.*]], ptr nocapture nofree noundef nonnull readnone align 4 dereferenceable(4) [[N:%.*]], ptr nocapture nofree noundef nonnull readnone align 4 dereferenceable(4) [[P:%.*]], i64 [[Q:%.*]]) #[[ATTR0:[0-9]+]] {
; TUNIT-NEXT:  entry:
...
; CGSCC-SAME: (ptr noalias nocapture nofree readonly [[DOTGLOBAL_TID_:%.*]], ptr noalias nocapture nofree readnone [[DOTBOUND_TID_:%.*]], ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) [[N:%.*]], ptr nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) [[P:%.*]], i64 [[Q:%.*]]) #[[ATTR0:[0-9]+]] {
; CGSCC-NEXT:  entry:
...
!0 = !{!1}
;.
; CHECK: attributes #[[ATTR0:[0-9]+]] = { memory(readwrite, argmem: read) }
;.
; CHECK: [[META0:![0-9]+]] = !{!1}

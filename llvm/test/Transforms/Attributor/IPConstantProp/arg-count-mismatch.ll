...
; IS__TUNIT____-NEXT:    [[CALL:%.*]] = call noundef i16 bitcast (i16 (i16, i16)* @bar to i16 (i16)*)(i16 [[A]])
...
; IS__CGSCC_NPM-NEXT:    [[CALL:%.*]] = call noundef i16 bitcast (i16 (i16, i16)* @bar to i16 (i16)*)(i16 [[A]])

...
; RUN: opt -attributor -attributor-manifest-internal  -attributor-max-iterations-verify -attributor-annotate-everything -attributor-max-iterations=4 -S < %s | FileCheck %s --check-prefixes=CHECK,NOT_CGSCC_NPM,NOT_CGSCC_OPM,NOT_TUNIT_NPM,IS__TUNIT____,IS________OPM,IS__TUNIT_OPM
; RUN: opt -aa-pipeline=basic-aa -passes=attributor -attributor-manifest-internal  -attributor-max-iterations-verify -attributor-annotate-everything -attributor-max-iterations=4 -S < %s | FileCheck %s --check-prefixes=CHECK,NOT_CGSCC_OPM,NOT_CGSCC_NPM,NOT_TUNIT_OPM,IS__TUNIT____,IS________NPM,IS__TUNIT_NPM
...
; IS__CGSCC_OPM:       true:
; IS__CGSCC_OPM-NEXT:    [[CA:%.*]] = musttail call noalias align 536870912 i8* @side_effects(i8 [[V]])
...
; IS__CGSCC_OPM-NEXT:    [[CA1:%.*]] = musttail call noalias align 536870912 i8* @no_side_effects(i8 [[V]])
; IS__CGSCC_OPM-NEXT:    ret i8* [[CA1]]
; IS__CGSCC_OPM:       c2_false:
; IS__CGSCC_OPM-NEXT:    [[CA2:%.*]] = musttail call noalias align 536870912 i8* @dont_zap_me(i8 [[V]])
...
; IS__CGSCC_NPM:       true:
; IS__CGSCC_NPM-NEXT:    [[CA:%.*]] = musttail call noalias align 536870912 i8* @side_effects(i8 [[V]])
...
; IS__CGSCC_NPM-NEXT:    [[CA1:%.*]] = musttail call noalias nonnull align 536870912 i8* @no_side_effects(i8 [[V]])
; IS__CGSCC_NPM-NEXT:    ret i8* [[CA1]]
; IS__CGSCC_NPM:       c2_false:
; IS__CGSCC_NPM-NEXT:    [[CA2:%.*]] = musttail call noalias align 536870912 i8* @dont_zap_me(i8 [[V]])
...
; IS__CGSCC_OPM-NEXT:    [[CA:%.*]] = musttail call noalias align 536870912 i8* @start(i8 [[V]])
; IS__CGSCC_OPM-NEXT:    ret i8* [[CA]]
;
; IS__CGSCC_NPM-LABEL: define {{[^@]+}}@side_effects
; IS__CGSCC_NPM-SAME: (i8 [[V:%.*]])
; IS__CGSCC_NPM-NEXT:    [[I1:%.*]] = call i32 @external()
; IS__CGSCC_NPM-NEXT:    [[CA:%.*]] = musttail call noalias nonnull align 536870912 i8* @start(i8 [[V]])
; IS__CGSCC_NPM-NEXT:    ret i8* [[CA]]
;

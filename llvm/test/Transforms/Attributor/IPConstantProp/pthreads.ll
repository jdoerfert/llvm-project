...
; MODULE-SAME: (i8* nofree nonnull readnone returned align 8 dereferenceable(8) [[ARG:%.*]])
; MODULE-NEXT:  entry:
...
; MODULE-SAME: (i8* nofree nonnull readnone returned align 8 dereferenceable(1) [[ARG:%.*]])
; MODULE-NEXT:  entry:
; MODULE-NEXT:    ret i8* [[ARG]]
;

...
; TUNIT-NEXT:    call void @use_i8(ptr noalias nocapture noundef align 4294967296 null)
; TUNIT-NEXT:    ret void
;
; CGSCC: Function Attrs: memory(readwrite, argmem: none)
; CGSCC-LABEL: define {{[^@]+}}@test9a
; CGSCC-SAME: () #[[ATTR6:[0-9]+]] {
; CGSCC-NEXT:    call void @use_i8(ptr noalias nocapture noundef align 4294967296 null)
; CGSCC-NEXT:    ret void
;
...
; TUNIT-NEXT:    [[CALL:%.*]] = call i32 @ret(ptr nocapture nofree readonly align 4 [[I2P]]) #[[ATTR13]]
...
; CGSCC-NEXT:    [[C:%.*]] = call i32 @p2i(ptr noalias nofree [[ARG]])
...
; CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 noundef 144, ptr nocapture nofree noundef nonnull align 8 dereferenceable(240) [[F]])
...
; TUNIT:       if.end:
; TUNIT-NEXT:    tail call void @make_alias(ptr noalias nofree readnone [[P]]) #[[ATTR13]]
; TUNIT-NEXT:    ret void
;
...
; CGSCC:       if.end:
; CGSCC-NEXT:    tail call void @make_alias(ptr noalias nofree readnone [[P]]) #[[ATTR3]]
; CGSCC-NEXT:    ret void
;
...
; TUNIT:       if.then:
; TUNIT-NEXT:    tail call void @only_store(ptr noalias nocapture nofree writeonly align 4 [[P]]) #[[ATTR13]]
; TUNIT-NEXT:    tail call void @make_alias(ptr noalias nofree readnone align 4 [[P]]) #[[ATTR13]]
; TUNIT-NEXT:    br label [[IF_END]]
; TUNIT:       if.end:
...
; CGSCC:       if.then:
; CGSCC-NEXT:    tail call void @only_store(ptr nocapture nofree noundef nonnull writeonly align 4 dereferenceable(4) [[P]]) #[[ATTR3]]
; CGSCC-NEXT:    tail call void @make_alias(ptr noalias nofree nonnull readnone align 4 dereferenceable(4) [[P]]) #[[ATTR3]]
; CGSCC-NEXT:    br label [[IF_END]]
; CGSCC:       if.end:

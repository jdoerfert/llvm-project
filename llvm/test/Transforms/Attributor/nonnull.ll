...
; IS________NPM:       rec:
; IS________NPM-NEXT:    [[TMP1:%.*]] = call i8* @test3(i1 noundef true)
...
; NOT_CGSCC_NPM:       bb1:
; NOT_CGSCC_NPM-NEXT:    [[TMP2:%.*]] = load i32, i32* [[ARG]], align 4
; NOT_CGSCC_NPM-NEXT:    [[TMP3:%.*]] = icmp eq i32 [[TMP2]], 0
...
; NOT_CGSCC_NPM-NEXT:    ret i32* [[TMP10]]
;
...
; NOT_CGSCC_NPM:       cont:
; NOT_CGSCC_NPM-NEXT:    ret i1 false
; NOT_CGSCC_NPM:       exc:
; NOT_CGSCC_NPM-NEXT:    [[LP:%.*]] = landingpad { i8*, i32 }
; NOT_CGSCC_NPM-NEXT:    filter [0 x i8*] zeroinitializer
; NOT_CGSCC_NPM-NEXT:    unreachable
;
; IS__CGSCC_NPM: Function Attrs: nounwind
...
; IS__TUNIT____-SAME: (i32* nocapture readnone [[A:%.*]]) #[[ATTR4]] {
; IS__TUNIT____-NEXT:    call void @use_i32_ptr(i32* nocapture readnone [[A]]) #[[ATTR4]]
...
; IS__CGSCC_OPM-NEXT:    call void @use_i32_ptr(i32* noalias nocapture readnone [[A]]) #[[ATTR4]]
; IS__CGSCC_OPM-NEXT:    ret void
;
; IS__CGSCC_NPM: Function Attrs: nounwind
; IS__CGSCC_NPM-LABEL: define {{[^@]+}}@called_by_weak
; IS__CGSCC_NPM-SAME: (i32* noalias nocapture nonnull readnone [[A:%.*]]) #[[ATTR3]] {
; IS__CGSCC_NPM-NEXT:    call void @use_i32_ptr(i32* noalias nocapture readnone [[A]]) #[[ATTR3]]
; IS__CGSCC_NPM-NEXT:    ret void
;

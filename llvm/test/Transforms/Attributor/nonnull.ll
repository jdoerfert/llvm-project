...
; IS__TUNIT____: Function Attrs: inaccessiblememonly nofree nosync nounwind willreturn
; IS__TUNIT____-LABEL: define {{[^@]+}}@test2A
; IS__TUNIT____-SAME: (i1 [[C:%.*]], i8* nofree nonnull readnone returned "no-capture-maybe-returned" [[RET:%.*]]) #[[ATTR0:[0-9]+]] {
; IS__TUNIT____-NEXT:    br i1 [[C]], label [[A:%.*]], label [[B:%.*]]
; IS__TUNIT____:       A:
; IS__TUNIT____-NEXT:    call void @llvm.assume(i1 noundef true) #[[ATTR13:[0-9]+]] [ "nonnull"(i8* [[RET]]) ]
; IS__TUNIT____-NEXT:    ret i8* [[RET]]
; IS__TUNIT____:       B:
; IS__TUNIT____-NEXT:    call void @llvm.assume(i1 noundef true) #[[ATTR13]] [ "nonnull"(i8* [[RET]]) ]
; IS__TUNIT____-NEXT:    ret i8* [[RET]]
;
...
; IS__CGSCC_OPM:       A:
; IS__CGSCC_OPM-NEXT:    call void @llvm.assume(i1 noundef true) #[[ATTR14:[0-9]+]] [ "nonnull"(i8* [[RET]]) ]
; IS__CGSCC_OPM-NEXT:    ret i8* [[RET]]
; IS__CGSCC_OPM:       B:
; IS__CGSCC_OPM-NEXT:    call void @llvm.assume(i1 noundef true) #[[ATTR14]] [ "nonnull"(i8* [[RET]]) ]
; IS__CGSCC_OPM-NEXT:    ret i8* [[RET]]
;
...
; IS__TUNIT____-SAME: (i1 [[C:%.*]], i8* nofree nonnull readnone returned dereferenceable(4) "no-capture-maybe-returned" [[RET:%.*]]) #[[ATTR0]] {
; IS__TUNIT____-NEXT:    br i1 [[C]], label [[A:%.*]], label [[B:%.*]]
; IS__TUNIT____:       A:
; IS__TUNIT____-NEXT:    call void @llvm.assume(i1 noundef true) #[[ATTR13]] [ "dereferenceable"(i8* [[RET]], i32 4) ]
; IS__TUNIT____-NEXT:    ret i8* [[RET]]
; IS__TUNIT____:       B:
; IS__TUNIT____-NEXT:    call void @llvm.assume(i1 noundef true) #[[ATTR13]] [ "dereferenceable"(i8* [[RET]], i32 4) ]
; IS__TUNIT____-NEXT:    ret i8* [[RET]]
...
; IS__CGSCC_OPM-NEXT:    br i1 [[C]], label [[A:%.*]], label [[B:%.*]]
; IS__CGSCC_OPM:       A:
; IS__CGSCC_OPM-NEXT:    call void @llvm.assume(i1 noundef true) #[[ATTR14]] [ "dereferenceable"(i8* [[RET]], i32 4) ]
; IS__CGSCC_OPM-NEXT:    ret i8* [[RET]]
; IS__CGSCC_OPM:       B:
; IS__CGSCC_OPM-NEXT:    call void @llvm.assume(i1 noundef true) #[[ATTR14]] [ "dereferenceable"(i8* [[RET]], i32 4) ]
; IS__CGSCC_OPM-NEXT:    ret i8* [[RET]]
...
define i8* @test6a() {
;
; IS__TUNIT____: Function Attrs: noreturn
; IS__TUNIT____-LABEL: define {{[^@]+}}@test6a
...
; IS__TUNIT____-SAME: (i8* nofree readnone "no-capture-maybe-returned" [[A:%.*]], i64 [[N:%.*]]) #[[ATTR0]] {
; IS__TUNIT____-NEXT:    call void @llvm.assume(i1 noundef true) #[[ATTR13]]
; IS__TUNIT____-NEXT:    [[B:%.*]] = getelementptr inbounds i8, i8* [[A]], i64 [[N]]
; IS__TUNIT____-NEXT:    ret i8* [[B]]
;
; IS__CGSCC_OPM: Function Attrs: inaccessiblememonly nofree nosync nounwind willreturn
...
; IS__CGSCC_OPM-NEXT:    call void @llvm.assume(i1 noundef true) #[[ATTR14]]
...
; IS__TUNIT____-LABEL: define {{[^@]+}}@test13_helper() {
; IS__TUNIT____-NEXT:    [[NONNULLPTR:%.*]] = tail call nonnull i8* @ret_nonnull()
; IS__TUNIT____-NEXT:    [[MAYBENULLPTR:%.*]] = tail call i8* @unknown()
; IS__TUNIT____-NEXT:    tail call void @test13(i8* noalias nocapture nofree nonnull readnone [[NONNULLPTR]], i8* noalias nocapture nofree nonnull readnone [[NONNULLPTR]], i8* noalias nocapture nofree readnone [[MAYBENULLPTR]]) #[[ATTR5:[0-9]+]]
; IS__TUNIT____-NEXT:    tail call void @test13(i8* noalias nocapture nofree nonnull readnone [[NONNULLPTR]], i8* noalias nocapture nofree readnone [[MAYBENULLPTR]], i8* noalias nocapture nofree nonnull readnone [[NONNULLPTR]]) #[[ATTR5]]
...
; IS__CGSCC_OPM-NEXT:    tail call void @test13(i8* noalias nocapture nofree nonnull readnone [[NONNULLPTR]], i8* noalias nocapture nofree nonnull readnone [[NONNULLPTR]], i8* noalias nocapture nofree readnone [[MAYBENULLPTR]]) #[[ATTR6:[0-9]+]]
; IS__CGSCC_OPM-NEXT:    tail call void @test13(i8* noalias nocapture nofree nonnull readnone [[NONNULLPTR]], i8* noalias nocapture nofree readnone [[MAYBENULLPTR]], i8* noalias nocapture nofree nonnull readnone [[NONNULLPTR]]) #[[ATTR6]]
...
; IS__TUNIT____-SAME: (i8* noalias nocapture nofree nonnull readnone [[A:%.*]], i8* noalias nocapture nofree readnone [[B:%.*]], i8* noalias nocapture nofree readnone [[C:%.*]]) #[[ATTR5]] {
; IS__TUNIT____-NEXT:    call void @use_i8_ptr(i8* noalias nocapture nofree nonnull readnone [[A]]) #[[ATTR5]]
; IS__TUNIT____-NEXT:    call void @use_i8_ptr(i8* noalias nocapture nofree readnone [[B]]) #[[ATTR5]]
; IS__TUNIT____-NEXT:    call void @use_i8_ptr(i8* noalias nocapture nofree readnone [[C]]) #[[ATTR5]]
; IS__TUNIT____-NEXT:    ret void
;
; IS__CGSCC_OPM: Function Attrs: nounwind
; IS__CGSCC_OPM-LABEL: define {{[^@]+}}@test13
; IS__CGSCC_OPM-SAME: (i8* noalias nocapture nofree nonnull readnone [[A:%.*]], i8* noalias nocapture nofree readnone [[B:%.*]], i8* noalias nocapture nofree readnone [[C:%.*]]) #[[ATTR6]] {
; IS__CGSCC_OPM-NEXT:    call void @use_i8_ptr(i8* noalias nocapture nofree nonnull readnone [[A]]) #[[ATTR6]]
; IS__CGSCC_OPM-NEXT:    call void @use_i8_ptr(i8* noalias nocapture nofree readnone [[B]]) #[[ATTR6]]
; IS__CGSCC_OPM-NEXT:    call void @use_i8_ptr(i8* noalias nocapture nofree readnone [[C]]) #[[ATTR6]]
; IS__CGSCC_OPM-NEXT:    ret void
;
...
; IS__TUNIT____: Function Attrs: argmemonly nofree nosync nounwind readonly
; IS__TUNIT____-LABEL: define {{[^@]+}}@f1
; IS__TUNIT____-SAME: (i32* nofree readonly [[ARG:%.*]]) #[[ATTR6:[0-9]+]] {
; IS__TUNIT____-NEXT:  bb:
; IS__TUNIT____-NEXT:    [[TMP:%.*]] = icmp eq i32* [[ARG]], null
; IS__TUNIT____-NEXT:    br i1 [[TMP]], label [[BB9:%.*]], label [[BB1:%.*]]
; IS__TUNIT____:       bb1:
; IS__TUNIT____-NEXT:    [[TMP2:%.*]] = load i32, i32* [[ARG]], align 4
; IS__TUNIT____-NEXT:    [[TMP3:%.*]] = icmp eq i32 [[TMP2]], 0
; IS__TUNIT____-NEXT:    br i1 [[TMP3]], label [[BB6:%.*]], label [[BB4:%.*]]
; IS__TUNIT____:       bb4:
; IS__TUNIT____-NEXT:    [[TMP5:%.*]] = getelementptr inbounds i32, i32* [[ARG]], i64 1
; IS__TUNIT____-NEXT:    [[TMP5B:%.*]] = tail call i32* @f3(i32* nofree nonnull readonly [[TMP5]]) #[[ATTR14:[0-9]+]]
; IS__TUNIT____-NEXT:    [[TMP5C:%.*]] = getelementptr inbounds i32, i32* [[TMP5B]], i64 -1
; IS__TUNIT____-NEXT:    br label [[BB9]]
; IS__TUNIT____:       bb6:
; IS__TUNIT____-NEXT:    [[TMP7:%.*]] = tail call nonnull i32* @f2(i32* nofree nonnull readonly align 4 dereferenceable(4) [[ARG]]) #[[ATTR14]]
; IS__TUNIT____-NEXT:    ret i32* [[TMP7]]
; IS__TUNIT____:       bb9:
; IS__TUNIT____-NEXT:    [[TMP10:%.*]] = phi i32* [ [[TMP5C]], [[BB4]] ], [ inttoptr (i64 4 to i32*), [[BB:%.*]] ]
; IS__TUNIT____-NEXT:    ret i32* [[TMP10]]
;
; IS__CGSCC_OPM: Function Attrs: argmemonly nofree nosync nounwind readonly
; IS__CGSCC_OPM-LABEL: define {{[^@]+}}@f1
; IS__CGSCC_OPM-SAME: (i32* nofree readonly [[ARG:%.*]]) #[[ATTR7:[0-9]+]] {
...
; IS__CGSCC_OPM-NEXT:    [[TMP5B:%.*]] = tail call i32* @f3(i32* nofree nonnull readonly [[TMP5]]) #[[ATTR15:[0-9]+]]
; IS__CGSCC_OPM-NEXT:    [[TMP5C:%.*]] = getelementptr inbounds i32, i32* [[TMP5B]], i64 -1
; IS__CGSCC_OPM-NEXT:    br label [[BB9]]
; IS__CGSCC_OPM:       bb6:
; IS__CGSCC_OPM-NEXT:    [[TMP7:%.*]] = tail call nonnull i32* @f2(i32* nofree nonnull readonly align 4 dereferenceable(4) [[ARG]]) #[[ATTR15]]
...
; IS__CGSCC_NPM:       bb1:
; IS__CGSCC_NPM-NEXT:    [[TMP2:%.*]] = load i32, i32* [[ARG]], align 4
; IS__CGSCC_NPM-NEXT:    [[TMP3:%.*]] = icmp eq i32 [[TMP2]], 0
...
; IS__CGSCC_NPM:       bb6:
; IS__CGSCC_NPM-NEXT:    [[TMP7:%.*]] = tail call nonnull i32* @f2(i32* nofree nonnull readonly align 4 dereferenceable(4) [[ARG]]) #[[ATTR13]]
; IS__CGSCC_NPM-NEXT:    ret i32* [[TMP7]]
; IS__CGSCC_NPM:       bb9:
; IS__CGSCC_NPM-NEXT:    [[TMP10:%.*]] = phi i32* [ [[TMP5C]], [[BB4]] ], [ inttoptr (i64 4 to i32*), [[BB:%.*]] ]
; IS__CGSCC_NPM-NEXT:    ret i32* [[TMP10]]
;
...
; IS__TUNIT____-SAME: (i32* nofree nonnull readonly align 4 dereferenceable(4) [[ARG:%.*]]) #[[ATTR6]] {
; IS__TUNIT____-NEXT:  bb:
; IS__TUNIT____-NEXT:    [[TMP:%.*]] = tail call nonnull i32* @f1(i32* nofree nonnull readonly align 4 dereferenceable(4) [[ARG]]) #[[ATTR14]]
; IS__TUNIT____-NEXT:    ret i32* [[TMP]]
;
; IS__CGSCC_OPM: Function Attrs: argmemonly nofree nosync nounwind readonly
; IS__CGSCC_OPM-LABEL: define {{[^@]+}}@f2
; IS__CGSCC_OPM-SAME: (i32* nofree nonnull readonly align 4 dereferenceable(4) [[ARG:%.*]]) #[[ATTR7]] {
; IS__CGSCC_OPM-NEXT:  bb:
; IS__CGSCC_OPM-NEXT:    [[TMP:%.*]] = tail call nonnull i32* @f1(i32* nofree nonnull readonly align 4 dereferenceable(4) [[ARG]]) #[[ATTR15]]
...
; IS__CGSCC_NPM-NEXT:  bb:
; IS__CGSCC_NPM-NEXT:    [[TMP:%.*]] = tail call nonnull i32* @f1(i32* nofree nonnull readonly align 4 dereferenceable(4) [[ARG]]) #[[ATTR13]]
...
; IS__TUNIT____: Function Attrs: argmemonly nofree nosync nounwind readonly
; IS__TUNIT____-LABEL: define {{[^@]+}}@f3
; IS__TUNIT____-SAME: (i32* nofree readonly [[ARG:%.*]]) #[[ATTR6]] {
; IS__TUNIT____-NEXT:  bb:
; IS__TUNIT____-NEXT:    [[TMP:%.*]] = call nonnull i32* @f1(i32* nofree readonly [[ARG]]) #[[ATTR14]]
; IS__TUNIT____-NEXT:    ret i32* [[TMP]]
;
; IS__CGSCC_OPM: Function Attrs: argmemonly nofree nosync nounwind readonly
; IS__CGSCC_OPM-LABEL: define {{[^@]+}}@f3
; IS__CGSCC_OPM-SAME: (i32* nofree readonly [[ARG:%.*]]) #[[ATTR7]] {
; IS__CGSCC_OPM-NEXT:  bb:
; IS__CGSCC_OPM-NEXT:    [[TMP:%.*]] = call nonnull i32* @f1(i32* nofree readonly [[ARG]]) #[[ATTR15]]
; IS__CGSCC_OPM-NEXT:    ret i32* [[TMP]]
;
; IS__CGSCC_NPM: Function Attrs: argmemonly nofree nosync nounwind readonly
...
; IS__CGSCC_NPM-NEXT:  bb:
; IS__CGSCC_NPM-NEXT:    [[TMP:%.*]] = call nonnull i32* @f1(i32* nofree readonly [[ARG]]) #[[ATTR13]]
; IS__CGSCC_NPM-NEXT:    ret i32* [[TMP]]
;
bb:
...
; IS__TUNIT____-LABEL: define {{[^@]+}}@f16
; IS__TUNIT____-SAME: (i8* nonnull [[A:%.*]], i8* [[B:%.*]], i8 [[C:%.*]]) #[[ATTR7:[0-9]+]] {
; IS__TUNIT____-NEXT:    [[CMP:%.*]] = icmp eq i8 [[C]], 0
; IS__TUNIT____-NEXT:    br i1 [[CMP]], label [[IF_THEN:%.*]], label [[IF_ELSE:%.*]]
; IS__TUNIT____:       if.then:
; IS__TUNIT____-NEXT:    tail call void @fun2(i8* nonnull [[A]], i8* nonnull [[B]]) #[[ATTR7]]
; IS__TUNIT____-NEXT:    ret void
; IS__TUNIT____:       if.else:
; IS__TUNIT____-NEXT:    tail call void @fun2(i8* nonnull [[A]], i8* [[B]]) #[[ATTR7]]
; IS__TUNIT____-NEXT:    ret void
;
; IS__CGSCC_OPM: Function Attrs: nounwind willreturn
; IS__CGSCC_OPM-LABEL: define {{[^@]+}}@f16
; IS__CGSCC_OPM-SAME: (i8* nonnull [[A:%.*]], i8* [[B:%.*]], i8 [[C:%.*]]) #[[ATTR8:[0-9]+]] {
; IS__CGSCC_OPM-NEXT:    [[CMP:%.*]] = icmp eq i8 [[C]], 0
; IS__CGSCC_OPM-NEXT:    br i1 [[CMP]], label [[IF_THEN:%.*]], label [[IF_ELSE:%.*]]
; IS__CGSCC_OPM:       if.then:
; IS__CGSCC_OPM-NEXT:    tail call void @fun2(i8* nonnull [[A]], i8* nonnull [[B]]) #[[ATTR8]]
; IS__CGSCC_OPM-NEXT:    ret void
; IS__CGSCC_OPM:       if.else:
; IS__CGSCC_OPM-NEXT:    tail call void @fun2(i8* nonnull [[A]], i8* [[B]]) #[[ATTR8]]
; IS__CGSCC_OPM-NEXT:    ret void
;
...
;
; IS__TUNIT____: Function Attrs: nounwind willreturn
; IS__TUNIT____-LABEL: define {{[^@]+}}@f17
; IS__TUNIT____-SAME: (i8* nonnull [[A:%.*]], i8 [[C:%.*]]) #[[ATTR7]] {
; IS__TUNIT____-NEXT:    [[CMP:%.*]] = icmp eq i8 [[C]], 0
; IS__TUNIT____-NEXT:    br i1 [[CMP]], label [[IF_THEN:%.*]], label [[IF_ELSE:%.*]]
; IS__TUNIT____:       if.then:
; IS__TUNIT____-NEXT:    tail call void @fun0() #[[ATTR7]]
; IS__TUNIT____-NEXT:    br label [[CONT:%.*]]
; IS__TUNIT____:       if.else:
; IS__TUNIT____-NEXT:    tail call void @fun0() #[[ATTR7]]
; IS__TUNIT____-NEXT:    br label [[CONT]]
; IS__TUNIT____:       cont:
; IS__TUNIT____-NEXT:    tail call void @fun1(i8* nonnull [[A]]) #[[ATTR7]]
; IS__TUNIT____-NEXT:    ret void
;
; IS__CGSCC_OPM: Function Attrs: nounwind willreturn
; IS__CGSCC_OPM-LABEL: define {{[^@]+}}@f17
; IS__CGSCC_OPM-SAME: (i8* nonnull [[A:%.*]], i8 [[C:%.*]]) #[[ATTR8]] {
; IS__CGSCC_OPM-NEXT:    [[CMP:%.*]] = icmp eq i8 [[C]], 0
; IS__CGSCC_OPM-NEXT:    br i1 [[CMP]], label [[IF_THEN:%.*]], label [[IF_ELSE:%.*]]
; IS__CGSCC_OPM:       if.then:
; IS__CGSCC_OPM-NEXT:    tail call void @fun0() #[[ATTR8]]
; IS__CGSCC_OPM-NEXT:    br label [[CONT:%.*]]
; IS__CGSCC_OPM:       if.else:
; IS__CGSCC_OPM-NEXT:    tail call void @fun0() #[[ATTR8]]
; IS__CGSCC_OPM-NEXT:    br label [[CONT]]
; IS__CGSCC_OPM:       cont:
; IS__CGSCC_OPM-NEXT:    tail call void @fun1(i8* nonnull [[A]]) #[[ATTR8]]
; IS__CGSCC_OPM-NEXT:    ret void
;
; IS__CGSCC_NPM: Function Attrs: nounwind willreturn
...
; IS__TUNIT____: Function Attrs: nounwind willreturn
; IS__TUNIT____-LABEL: define {{[^@]+}}@f18
; IS__TUNIT____-SAME: (i8* nonnull [[A:%.*]], i8* [[B:%.*]], i8 [[C:%.*]]) #[[ATTR7]] {
; IS__TUNIT____-NEXT:    [[CMP1:%.*]] = icmp eq i8 [[C]], 0
; IS__TUNIT____-NEXT:    br i1 [[CMP1]], label [[IF_THEN:%.*]], label [[IF_ELSE:%.*]]
; IS__TUNIT____:       if.then:
; IS__TUNIT____-NEXT:    tail call void @fun0() #[[ATTR7]]
; IS__TUNIT____-NEXT:    br label [[CONT:%.*]]
; IS__TUNIT____:       if.else:
...
; IS__TUNIT____-NEXT:    br label [[CONT]]
; IS__TUNIT____:       cont:
; IS__TUNIT____-NEXT:    [[CMP2:%.*]] = icmp eq i8 [[C]], 1
; IS__TUNIT____-NEXT:    br i1 [[CMP2]], label [[CONT_THEN:%.*]], label [[CONT_ELSE:%.*]]
; IS__TUNIT____:       cont.then:
; IS__TUNIT____-NEXT:    tail call void @fun1(i8* nonnull [[B]]) #[[ATTR7]]
; IS__TUNIT____-NEXT:    br label [[CONT2:%.*]]
; IS__TUNIT____:       cont.else:
; IS__TUNIT____-NEXT:    tail call void @fun0() #[[ATTR7]]
; IS__TUNIT____-NEXT:    br label [[CONT2]]
; IS__TUNIT____:       cont2:
; IS__TUNIT____-NEXT:    tail call void @fun1(i8* nonnull [[A]]) #[[ATTR7]]
...
; IS__CGSCC_OPM-SAME: (i8* nonnull [[A:%.*]], i8* [[B:%.*]], i8 [[C:%.*]]) #[[ATTR8]] {
...
; IS__CGSCC_OPM-NEXT:    tail call void @fun1(i8* nonnull [[B]]) #[[ATTR8]]
...
; IS__TUNIT____: Function Attrs: nounwind
; IS__TUNIT____-LABEL: define {{[^@]+}}@f19
; IS__TUNIT____-SAME: (i8* [[A:%.*]], i8* nonnull [[B:%.*]], i8 [[C:%.*]]) #[[ATTR5]] {
; IS__TUNIT____-NEXT:    br label [[LOOP_HEADER:%.*]]
; IS__TUNIT____:       loop.header:
; IS__TUNIT____-NEXT:    [[CMP2:%.*]] = icmp eq i8 [[C]], 0
; IS__TUNIT____-NEXT:    br i1 [[CMP2]], label [[LOOP_BODY:%.*]], label [[LOOP_EXIT:%.*]]
; IS__TUNIT____:       loop.body:
; IS__TUNIT____-NEXT:    tail call void @fun1(i8* nonnull [[B]]) #[[ATTR5]]
; IS__TUNIT____-NEXT:    tail call void @fun1(i8* nonnull [[A]]) #[[ATTR5]]
; IS__TUNIT____-NEXT:    br label [[LOOP_HEADER]]
; IS__TUNIT____:       loop.exit:
; IS__TUNIT____-NEXT:    tail call void @fun1(i8* nonnull [[B]]) #[[ATTR5]]
; IS__TUNIT____-NEXT:    ret void
;
; IS__CGSCC_OPM: Function Attrs: nounwind
; IS__CGSCC_OPM-LABEL: define {{[^@]+}}@f19
; IS__CGSCC_OPM-SAME: (i8* [[A:%.*]], i8* nonnull [[B:%.*]], i8 [[C:%.*]]) #[[ATTR6]] {
...
; IS__TUNIT____-LABEL: define {{[^@]+}}@parent7
; IS__TUNIT____-SAME: (i8* nonnull [[A:%.*]]) {
; IS__TUNIT____-NEXT:    [[RET:%.*]] = call i8 @use1safecall(i8* nonnull readonly [[A]]) #[[ATTR15:[0-9]+]]
; IS__TUNIT____-NEXT:    call void @use1nonnull(i8* nonnull [[A]])
; IS__TUNIT____-NEXT:    ret i8 [[RET]]
;
; IS__CGSCC_OPM-LABEL: define {{[^@]+}}@parent7
; IS__CGSCC_OPM-SAME: (i8* nonnull [[A:%.*]]) {
; IS__CGSCC_OPM-NEXT:    [[RET:%.*]] = call i8 @use1safecall(i8* nonnull readonly [[A]]) #[[ATTR16:[0-9]+]]
...
; IS__TUNIT____: Function Attrs: nounwind
; IS__TUNIT____-LABEL: define {{[^@]+}}@parent8
; IS__TUNIT____-SAME: (i8* nonnull [[A:%.*]], i8* nocapture nofree readnone [[BOGUS1:%.*]], i8* nonnull [[B:%.*]]) #[[ATTR5]] personality i8* bitcast (i32 (...)* @esfp to i8*) {
; IS__TUNIT____-NEXT:  entry:
; IS__TUNIT____-NEXT:    invoke void @use2nonnull(i8* nonnull [[A]], i8* nonnull [[B]])
; IS__TUNIT____-NEXT:    to label [[CONT:%.*]] unwind label [[EXC:%.*]]
; IS__TUNIT____:       cont:
; IS__TUNIT____-NEXT:    ret i1 false
; IS__TUNIT____:       exc:
; IS__TUNIT____-NEXT:    [[LP:%.*]] = landingpad { i8*, i32 }
; IS__TUNIT____-NEXT:    filter [0 x i8*] zeroinitializer
; IS__TUNIT____-NEXT:    unreachable
;
; IS__CGSCC_OPM: Function Attrs: nounwind
; IS__CGSCC_OPM-LABEL: define {{[^@]+}}@parent8
; IS__CGSCC_OPM-SAME: (i8* nonnull [[A:%.*]], i8* nocapture nofree readnone [[BOGUS1:%.*]], i8* nonnull [[B:%.*]]) #[[ATTR6]] personality i8* bitcast (i32 (...)* @esfp to i8*) {
; IS__CGSCC_OPM-NEXT:  entry:
...
; IS__CGSCC_NPM:       exc:
; IS__CGSCC_NPM-NEXT:    [[LP:%.*]] = landingpad { i8*, i32 }
; IS__CGSCC_NPM-NEXT:    filter [0 x i8*] zeroinitializer
; IS__CGSCC_NPM-NEXT:    unreachable
;
...
; IS__TUNIT____-SAME: (i32* nofree readnone "no-capture-maybe-returned" [[P:%.*]]) #[[ATTR9:[0-9]+]] {
; IS__TUNIT____-NEXT:    [[Q:%.*]] = getelementptr inbounds i32, i32* [[P]], i32 1
; IS__TUNIT____-NEXT:    ret i32* [[Q]]
;
...
; IS__CGSCC_OPM-SAME: (i32* nofree readnone "no-capture-maybe-returned" [[P:%.*]]) #[[ATTR10:[0-9]+]] {
...
; IS__TUNIT____-SAME: (i32* noalias nocapture nonnull readnone [[A:%.*]]) #[[ATTR5]] {
; IS__TUNIT____-NEXT:    call void @use_i32_ptr(i32* noalias nocapture nonnull readnone [[A]]) #[[ATTR5]]
; IS__TUNIT____-NEXT:    ret void
;
; IS__CGSCC_OPM: Function Attrs: nounwind
; IS__CGSCC_OPM-LABEL: define {{[^@]+}}@called_by_weak
; IS__CGSCC_OPM-SAME: (i32* noalias nocapture nonnull readnone [[A:%.*]]) #[[ATTR6]] {
; IS__CGSCC_OPM-NEXT:    call void @use_i32_ptr(i32* noalias nocapture nonnull readnone [[A]]) #[[ATTR6]]
; IS__CGSCC_OPM-NEXT:    ret void
;
; IS__CGSCC_NPM: Function Attrs: nounwind
...
;
; IS__TUNIT____-LABEL: define {{[^@]+}}@weak_caller
; IS__TUNIT____-SAME: (i32* nonnull [[A:%.*]]) {
; IS__TUNIT____-NEXT:    call void @called_by_weak(i32* noalias nocapture nonnull readnone [[A]]) #[[ATTR5]]
; IS__TUNIT____-NEXT:    ret void
;
; IS__CGSCC_OPM-LABEL: define {{[^@]+}}@weak_caller
; IS__CGSCC_OPM-SAME: (i32* nonnull [[A:%.*]]) {
; IS__CGSCC_OPM-NEXT:    call void @called_by_weak(i32* noalias nocapture nonnull readnone [[A]]) #[[ATTR6]]
; IS__CGSCC_OPM-NEXT:    ret void
;
...
; IS__TUNIT____-SAME: (i32* noalias nocapture noundef nonnull readnone align 16 dereferenceable(8) [[A:%.*]]) #[[ATTR5]] {
; IS__TUNIT____-NEXT:    call void @use_i32_ptr(i32* noalias nocapture noundef nonnull readnone align 16 dereferenceable(8) [[A]]) #[[ATTR5]]
; IS__TUNIT____-NEXT:    ret void
;
; IS__CGSCC_OPM: Function Attrs: nounwind
; IS__CGSCC_OPM-LABEL: define {{[^@]+}}@control
; IS__CGSCC_OPM-SAME: (i32* noalias nocapture noundef nonnull readnone align 16 dereferenceable(8) [[A:%.*]]) #[[ATTR6]] {
; IS__CGSCC_OPM-NEXT:    call void @use_i32_ptr(i32* noalias nocapture noundef nonnull readnone align 16 dereferenceable(8) [[A]]) #[[ATTR6]]
; IS__CGSCC_OPM-NEXT:    ret void
;
; IS__CGSCC_NPM: Function Attrs: nounwind
...
; IS__TUNIT____: Function Attrs: naked
; IS__TUNIT____-LABEL: define {{[^@]+}}@naked
; IS__TUNIT____-SAME: (i32* dereferenceable(4) [[A:%.*]]) #[[ATTR10:[0-9]+]] {
; IS__TUNIT____-NEXT:    call void @use_i32_ptr(i32* [[A]])
; IS__TUNIT____-NEXT:    ret void
;
...
;
; IS__TUNIT____: Function Attrs: noinline optnone
; IS__TUNIT____-LABEL: define {{[^@]+}}@optnone
; IS__TUNIT____-SAME: (i32* dereferenceable(4) [[A:%.*]]) #[[ATTR11:[0-9]+]] {
; IS__TUNIT____-NEXT:    call void @use_i32_ptr(i32* [[A]])
; IS__TUNIT____-NEXT:    ret void
;
; IS__CGSCC_OPM: Function Attrs: noinline optnone
; IS__CGSCC_OPM-LABEL: define {{[^@]+}}@optnone
; IS__CGSCC_OPM-SAME: (i32* dereferenceable(4) [[A:%.*]]) #[[ATTR12:[0-9]+]] {
; IS__CGSCC_OPM-NEXT:    call void @use_i32_ptr(i32* [[A]])
; IS__CGSCC_OPM-NEXT:    ret void
;
...
; IS__TUNIT____-LABEL: define {{[^@]+}}@make_live
; IS__TUNIT____-SAME: (i32* noundef nonnull align 16 dereferenceable(8) [[A:%.*]]) {
; IS__TUNIT____-NEXT:    call void @naked(i32* noundef nonnull align 16 dereferenceable(8) [[A]])
; IS__TUNIT____-NEXT:    call void @control(i32* noalias nocapture noundef nonnull readnone align 16 dereferenceable(8) [[A]]) #[[ATTR5]]
; IS__TUNIT____-NEXT:    call void @optnone(i32* noundef nonnull align 16 dereferenceable(8) [[A]])
; IS__TUNIT____-NEXT:    ret void
;
...
; IS__CGSCC_OPM-NEXT:    call void @control(i32* noalias nocapture noundef nonnull readnone align 16 dereferenceable(8) [[A]]) #[[ATTR6]]
...
;
; IS__TUNIT____: Function Attrs: nounwind willreturn
; IS__TUNIT____-LABEL: define {{[^@]+}}@nonnull_exec_ctx_2
; IS__TUNIT____-SAME: (i32* nonnull [[A:%.*]], i32 [[B:%.*]]) #[[ATTR7]] {
; IS__TUNIT____-NEXT:  en:
; IS__TUNIT____-NEXT:    [[TMP3:%.*]] = icmp eq i32 [[B]], 0
; IS__TUNIT____-NEXT:    br i1 [[TMP3]], label [[EX:%.*]], label [[HD:%.*]]
; IS__TUNIT____:       ex:
; IS__TUNIT____-NEXT:    [[TMP5:%.*]] = tail call i32 @g(i32* nonnull [[A]]) #[[ATTR5]]
; IS__TUNIT____-NEXT:    ret i32 [[TMP5]]
; IS__TUNIT____:       hd:
; IS__TUNIT____-NEXT:    [[TMP7:%.*]] = phi i32 [ [[TMP8:%.*]], [[HD]] ], [ 0, [[EN:%.*]] ]
; IS__TUNIT____-NEXT:    tail call void @h(i32* nonnull [[A]]) #[[ATTR5]]
; IS__TUNIT____-NEXT:    [[TMP8]] = add nuw i32 [[TMP7]], 1
; IS__TUNIT____-NEXT:    [[TMP9:%.*]] = icmp eq i32 [[TMP8]], [[B]]
; IS__TUNIT____-NEXT:    br i1 [[TMP9]], label [[EX]], label [[HD]]
;
; IS__CGSCC_OPM: Function Attrs: nounwind willreturn
; IS__CGSCC_OPM-LABEL: define {{[^@]+}}@nonnull_exec_ctx_2
; IS__CGSCC_OPM-SAME: (i32* nonnull [[A:%.*]], i32 [[B:%.*]]) #[[ATTR8]] {
; IS__CGSCC_OPM-NEXT:  en:
; IS__CGSCC_OPM-NEXT:    [[TMP3:%.*]] = icmp eq i32 [[B]], 0
; IS__CGSCC_OPM-NEXT:    br i1 [[TMP3]], label [[EX:%.*]], label [[HD:%.*]]
; IS__CGSCC_OPM:       ex:
...
; IS__CGSCC_OPM:       hd:
; IS__CGSCC_OPM-NEXT:    [[TMP7:%.*]] = phi i32 [ [[TMP8:%.*]], [[HD]] ], [ 0, [[EN:%.*]] ]
; IS__CGSCC_OPM-NEXT:    tail call void @h(i32* nonnull [[A]]) #[[ATTR6]]
; IS__CGSCC_OPM-NEXT:    [[TMP8]] = add nuw i32 [[TMP7]], 1
; IS__CGSCC_OPM-NEXT:    [[TMP9:%.*]] = icmp eq i32 [[TMP8]], [[B]]
; IS__CGSCC_OPM-NEXT:    br i1 [[TMP9]], label [[EX]], label [[HD]]
;
...
;
; IS__TUNIT____: Function Attrs: nounwind willreturn
; IS__TUNIT____-LABEL: define {{[^@]+}}@nonnull_exec_ctx_2b
; IS__TUNIT____-SAME: (i32* nonnull [[A:%.*]], i32 [[B:%.*]]) #[[ATTR7]] {
; IS__TUNIT____-NEXT:  en:
; IS__TUNIT____-NEXT:    [[TMP3:%.*]] = icmp eq i32 [[B]], 0
; IS__TUNIT____-NEXT:    br i1 [[TMP3]], label [[EX:%.*]], label [[HD:%.*]]
...
; IS__TUNIT____-NEXT:    ret i32 [[TMP5]]
; IS__TUNIT____:       hd:
; IS__TUNIT____-NEXT:    [[TMP7:%.*]] = phi i32 [ [[TMP8:%.*]], [[HD2:%.*]] ], [ 0, [[EN:%.*]] ]
; IS__TUNIT____-NEXT:    tail call void @h(i32* nonnull [[A]]) #[[ATTR5]]
; IS__TUNIT____-NEXT:    br label [[HD2]]
; IS__TUNIT____:       hd2:
; IS__TUNIT____-NEXT:    [[TMP8]] = add nuw i32 [[TMP7]], 1
; IS__TUNIT____-NEXT:    [[TMP9:%.*]] = icmp eq i32 [[TMP8]], [[B]]
; IS__TUNIT____-NEXT:    br i1 [[TMP9]], label [[EX]], label [[HD]]
...
; IS__TUNIT____: Function Attrs: nofree nounwind readonly willreturn
; IS__TUNIT____-LABEL: define {{[^@]+}}@mybasename
; IS__TUNIT____-SAME: (i8* nofree readonly [[STR:%.*]]) #[[ATTR12:[0-9]+]] {
; IS__TUNIT____-NEXT:    [[CALL:%.*]] = call i8* @strrchr(i8* nofree readonly [[STR]], i32 noundef 47) #[[ATTR15]]
; IS__TUNIT____-NEXT:    [[TOBOOL:%.*]] = icmp ne i8* [[CALL]], null
; IS__TUNIT____-NEXT:    [[ADD_PTR:%.*]] = getelementptr inbounds i8, i8* [[CALL]], i64 1
; IS__TUNIT____-NEXT:    [[COND:%.*]] = select i1 [[TOBOOL]], i8* [[ADD_PTR]], i8* [[STR]]
; IS__TUNIT____-NEXT:    ret i8* [[COND]]
;
; IS__CGSCC_OPM: Function Attrs: nofree nounwind readonly willreturn
; IS__CGSCC_OPM-LABEL: define {{[^@]+}}@mybasename
; IS__CGSCC_OPM-SAME: (i8* nofree readonly [[STR:%.*]]) #[[ATTR13:[0-9]+]] {
...
; IS__TUNIT____-SAME: (i8* nocapture nofree nonnull readnone [[ARG:%.*]]) {
; IS__TUNIT____-NEXT:    call void @llvm.assume(i1 noundef true) #[[ATTR13]] [ "nonnull"(i8* [[ARG]]) ]
; IS__TUNIT____-NEXT:    call void @use_i8_ptr(i8* noalias nocapture nofree nonnull readnone [[ARG]]) #[[ATTR5]]
; IS__TUNIT____-NEXT:    [[TMP1:%.*]] = call i8* @unknown()
; IS__TUNIT____-NEXT:    ret void
;
; IS__CGSCC_OPM-LABEL: define {{[^@]+}}@nonnull_assume_pos
; IS__CGSCC_OPM-SAME: (i8* nocapture nofree nonnull readnone [[ARG:%.*]]) {
; IS__CGSCC_OPM-NEXT:    call void @llvm.assume(i1 noundef true) #[[ATTR14]] [ "nonnull"(i8* [[ARG]]) ]
; IS__CGSCC_OPM-NEXT:    call void @use_i8_ptr(i8* noalias nocapture nofree nonnull readnone [[ARG]]) #[[ATTR6]]
...
;
;
; IS__TUNIT____-LABEL: define {{[^@]+}}@nonnull_assume_neg
; IS__TUNIT____-SAME: (i8* nocapture nofree readnone [[ARG:%.*]]) {
; IS__TUNIT____-NEXT:    [[TMP1:%.*]] = call i8* @unknown()
; IS__TUNIT____-NEXT:    call void @use_i8_ptr(i8* noalias nocapture nofree readnone [[ARG]]) #[[ATTR5]]
; IS__TUNIT____-NEXT:    call void @llvm.assume(i1 noundef true) [ "nonnull"(i8* [[ARG]]) ]
; IS__TUNIT____-NEXT:    call void @use_i8_ptr(i8* noalias nocapture nofree nonnull readnone [[ARG]]) #[[ATTR5]]
; IS__TUNIT____-NEXT:    [[TMP2:%.*]] = call i8* @unknown()
; IS__TUNIT____-NEXT:    call void @use_i8_ptr_ret(i8* noalias nocapture nofree nonnull readnone [[ARG]]) #[[ATTR5]]
; IS__TUNIT____-NEXT:    call void @llvm.assume(i1 noundef true) [ "nonnull"(i8* [[ARG]]) ]
; IS__TUNIT____-NEXT:    call void @use_i8_ptr_ret(i8* noalias nocapture nofree nonnull readnone [[ARG]]) #[[ATTR5]]
; IS__TUNIT____-NEXT:    ret void
;
...
; IS__CGSCC_OPM-NEXT:    [[TMP1:%.*]] = call i8* @unknown()
; IS__CGSCC_OPM-NEXT:    call void @use_i8_ptr(i8* noalias nocapture nofree readnone [[ARG]]) #[[ATTR6]]
; IS__CGSCC_OPM-NEXT:    call void @llvm.assume(i1 noundef true) [ "nonnull"(i8* [[ARG]]) ]
; IS__CGSCC_OPM-NEXT:    call void @use_i8_ptr(i8* noalias nocapture nofree nonnull readnone [[ARG]]) #[[ATTR6]]
; IS__CGSCC_OPM-NEXT:    [[TMP2:%.*]] = call i8* @unknown()
; IS__CGSCC_OPM-NEXT:    call void @use_i8_ptr_ret(i8* noalias nocapture nofree nonnull readnone [[ARG]]) #[[ATTR6]]
; IS__CGSCC_OPM-NEXT:    call void @llvm.assume(i1 noundef true) [ "nonnull"(i8* [[ARG]]) ]
; IS__CGSCC_OPM-NEXT:    call void @use_i8_ptr_ret(i8* noalias nocapture nofree nonnull readnone [[ARG]]) #[[ATTR6]]
; IS__CGSCC_OPM-NEXT:    ret void
;
...
; IS__TUNIT____: attributes #[[ATTR9]] = { nofree nosync nounwind null_pointer_is_valid readnone willreturn }
...
; IS__CGSCC_OPM: attributes #[[ATTR4]] = { nofree nosync nounwind readnone }
; IS__CGSCC_OPM: attributes #[[ATTR5]] = { noreturn }
; IS__CGSCC_OPM: attributes #[[ATTR6]] = { nounwind }
; IS__CGSCC_OPM: attributes #[[ATTR7]] = { argmemonly nofree nosync nounwind readonly }
; IS__CGSCC_OPM: attributes #[[ATTR8]] = { nounwind willreturn }
; IS__CGSCC_OPM: attributes #[[ATTR9:[0-9]+]] = { nounwind readonly willreturn }
; IS__CGSCC_OPM: attributes #[[ATTR10]] = { nofree norecurse nosync nounwind null_pointer_is_valid readnone willreturn }
; IS__CGSCC_OPM: attributes #[[ATTR11]] = { naked }
; IS__CGSCC_OPM: attributes #[[ATTR12]] = { noinline optnone }
; IS__CGSCC_OPM: attributes #[[ATTR13]] = { nofree nounwind readonly willreturn }
; IS__CGSCC_OPM: attributes #[[ATTR14]] = { willreturn }
; IS__CGSCC_OPM: attributes #[[ATTR15]] = { nofree nosync nounwind readonly }
; IS__CGSCC_OPM: attributes #[[ATTR16]] = { readonly willreturn }
;.

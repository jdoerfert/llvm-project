...
; CHECK-SAME: (i32* nocapture writeonly [[P:%.*]]) {
; CHECK-NEXT:  entry:
...
; IS__TUNIT_OPM-NEXT:    call void @write_arg(i32* nocapture nofree noundef nonnull writeonly align 4 dereferenceable(24) getelementptr inbounds ([[STRUCT_S]], %struct.S* @Gs1, i64 0, i32 0), i32 noundef 1) #[[ATTR6]]
...
; IS__TUNIT_NPM-NEXT:    call void @write_arg(i32* nocapture nofree noundef nonnull writeonly align 4 dereferenceable(24) getelementptr inbounds ([[STRUCT_S]], %struct.S* @Gs1, i64 0, i32 0), i32 noundef 1) #[[ATTR5]]
...
; IS__CGSCC____-NEXT:    call void @write_arg(i32* nocapture nofree noundef nonnull writeonly align 4 dereferenceable(24) getelementptr inbounds ([[STRUCT_S]], %struct.S* @Gs1, i64 0, i32 0), i32 noundef 1) #[[ATTR9]]
...
; IS__TUNIT_OPM-NEXT:    call void @write_random(i32* noalias nocapture noundef nonnull writeonly align 4 dereferenceable(4) [[Y]])
...
; IS__TUNIT_NPM-NEXT:    call void @write_random(i32* noalias nocapture noundef nonnull writeonly align 4 dereferenceable(4) [[Y]])
...
; IS__CGSCC____-NEXT:    call void @write_random(i32* noalias nocapture noundef nonnull writeonly align 4 dereferenceable(4) [[Y]])

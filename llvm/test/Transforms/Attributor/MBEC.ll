...
; RUN: opt -attributor -enable-new-pm=0 -attributor-manifest-internal -attributor-max-iterations-verify -attributor-annotate-decl-cs -attributor-max-iterations=4 -S < %s | FileCheck %s --check-prefixes=CHECK,CHECK_NO_MBEC,NOT_CGSCC_NPM_NO_MBEC,NOT_CGSCC_OPM_NO_MBEC,NOT_TUNIT_NPM_NO_MBEC,IS__TUNIT_____NO_MBEC,IS________OPM_NO_MBEC,IS__TUNIT_OPM_NO_MBEC
; RUN: opt -aa-pipeline=basic-aa -passes=attributor -attributor-manifest-internal -attributor-max-iterations-verify -attributor-annotate-decl-cs -attributor-max-iterations=4 -S < %s | FileCheck %s --check-prefixes=CHECK,CHECK_NO_MBEC,NOT_CGSCC_OPM_NO_MBEC,NOT_CGSCC_NPM_NO_MBEC,NOT_TUNIT_OPM_NO_MBEC,IS__TUNIT_____NO_MBEC,IS________NPM_NO_MBEC,IS__TUNIT_NPM_NO_MBEC
...
;
; RUN: opt -attributor -enable-new-pm=0 -attributor-manifest-internal -attributor-use-must-be-executed-context  -attributor-max-iterations-verify -attributor-annotate-decl-cs -attributor-max-iterations=4 -S < %s | FileCheck %s --check-prefixes=CHECK,CHECK_MBEC,NOT_CGSCC_NPM_MBEC,NOT_CGSCC_OPM_MBEC,NOT_TUNIT_NPM_MBEC,IS__TUNIT_____MBEC,IS________OPM_MBEC,IS__TUNIT_OPM_MBEC
; RUN: opt -aa-pipeline=basic-aa -passes=attributor -attributor-manifest-internal -attributor-use-must-be-executed-context  -attributor-max-iterations-verify -attributor-annotate-decl-cs -attributor-max-iterations=4 -S < %s | FileCheck %s --check-prefixes=CHECK,CHECK_MBEC,NOT_CGSCC_OPM_MBEC,NOT_CGSCC_NPM_MBEC,NOT_TUNIT_OPM_MBEC,IS__TUNIT_____MBEC,IS________NPM_MBEC,IS__TUNIT_NPM_MBEC

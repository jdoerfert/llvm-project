...
; IS__CGSCC____-SAME: () #[[ATTR6]] {
; IS__CGSCC____-NEXT:    call void @write_global_via_arg_internal(i32* noalias nocapture nofree noundef nonnull readnone align 4 dereferenceable(4) @G) #[[ATTR10]]
; IS__CGSCC____-NEXT:    ret void
;
...
; IS__CGSCC____-NEXT:    [[R:%.*]] = call i8 @recursive_not_readnone_internal(i8* noalias nocapture nofree noundef nonnull writeonly dereferenceable(1) [[A]], i1 [[C]]) #[[ATTR12:[0-9]+]]
; IS__CGSCC____-NEXT:    ret i8 [[R]]
;
  %a = alloca i8
...
; IS__CGSCC____-NEXT:    br i1 [[C]], label [[T:%.*]], label [[F:%.*]]
; IS__CGSCC____:       t:
; IS__CGSCC____-NEXT:    [[TMP1:%.*]] = call i8 @recursive_not_readnone_internal2(i8* noalias nocapture nofree noundef nonnull readnone dereferenceable(1) [[ALLOC]], i1 noundef false) #[[ATTR9]]
; IS__CGSCC____-NEXT:    [[R:%.*]] = load i8, i8* [[ALLOC]], align 1
; IS__CGSCC____-NEXT:    ret i8 [[R]]
; IS__CGSCC____:       f:
...
; IS__CGSCC____-SAME: () #[[ATTR6]] {
; IS__CGSCC____-NEXT:    call void @argmemonly_before_ipconstprop(i32* noalias nocapture nofree noundef nonnull readnone align 4 dereferenceable(4) @G) #[[ATTR10]]
; IS__CGSCC____-NEXT:    ret void
;

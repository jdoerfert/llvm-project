...
; IS__CGSCC____-SAME: (i32* noalias nocapture nofree noundef nonnull readnone align 4 dereferenceable(4) [[GPTR:%.*]]) #[[ATTR6]] {
; IS__CGSCC____-NEXT:    store i32 0, i32* @G, align 4
; IS__CGSCC____-NEXT:    ret void
;
  store i32 0, i32* %GPtr, align 4
...
; IS__CGSCC____-SAME: () #[[ATTR6]] {
; IS__CGSCC____-NEXT:    call void @write_global_via_arg_internal(i32* noalias nocapture nofree noundef nonnull readnone align 4 dereferenceable(4) @G) #[[ATTR11]]
; IS__CGSCC____-NEXT:    ret void
;
...
; IS__CGSCC____-SAME: (i8* noalias nocapture nofree noundef nonnull writeonly dereferenceable(1) [[PTR:%.*]], i1 [[C:%.*]]) #[[ATTR9:[0-9]+]] {
; IS__CGSCC____-NEXT:    [[ALLOC:%.*]] = alloca i8, align 1
; IS__CGSCC____-NEXT:    br i1 [[C]], label [[T:%.*]], label [[F:%.*]]
; IS__CGSCC____:       t:
; IS__CGSCC____-NEXT:    [[TMP1:%.*]] = call i8 @recursive_not_readnone_internal(i8* noalias nocapture nofree noundef nonnull writeonly dereferenceable(1) [[ALLOC]], i1 noundef false) #[[ATTR13:[0-9]+]]
; IS__CGSCC____-NEXT:    ret i8 1
; IS__CGSCC____:       f:
; IS__CGSCC____-NEXT:    store i8 1, i8* [[PTR]], align 1
; IS__CGSCC____-NEXT:    ret i8 0
...
; IS__CGSCC____-NEXT:    [[R:%.*]] = call noundef i8 @recursive_not_readnone_internal(i8* noalias nocapture nofree noundef nonnull writeonly dereferenceable(1) [[A]], i1 [[C]]) #[[ATTR14:[0-9]+]], !range [[RNG0:![0-9]+]]
...
; IS__CGSCC____-SAME: (i8* noalias nocapture nofree nonnull readnone [[PTR:%.*]], i1 [[C:%.*]]) #[[ATTR10]] {
; IS__CGSCC____-NEXT:    [[ALLOC:%.*]] = alloca i8, align 1
; IS__CGSCC____-NEXT:    br i1 [[C]], label [[T:%.*]], label [[F:%.*]]
; IS__CGSCC____:       t:
; IS__CGSCC____-NEXT:    [[TMP1:%.*]] = call i8 @recursive_not_readnone_internal2(i8* noalias nocapture nofree noundef nonnull readnone dereferenceable(1) [[ALLOC]], i1 noundef false) #[[ATTR10]]
; IS__CGSCC____-NEXT:    ret i8 1
; IS__CGSCC____:       f:
...
; IS__CGSCC____-NEXT:    [[R:%.*]] = call noundef i8 @recursive_not_readnone_internal2(i8* undef, i1 [[C]]) #[[ATTR15:[0-9]+]], !range [[RNG0]]
; IS__CGSCC____-NEXT:    ret i8 [[R]]
;
...
; IS__CGSCC____-SAME: (i32* noalias nocapture nofree noundef nonnull readnone align 4 dereferenceable(4) [[P:%.*]]) #[[ATTR6]] {
; IS__CGSCC____-NEXT:    store i32 0, i32* @G, align 4
; IS__CGSCC____-NEXT:    ret void
;
  store i32 0, i32* %p
...
; IS__CGSCC____-SAME: () #[[ATTR6]] {
; IS__CGSCC____-NEXT:    call void @argmemonly_before_ipconstprop(i32* noalias nocapture nofree noundef nonnull readnone align 4 dereferenceable(4) @G) #[[ATTR11]]
; IS__CGSCC____-NEXT:    ret void
;
...
; IS__TUNIT____: attributes #[[ATTR8]] = { argmemonly nofree nosync nounwind }
; IS__TUNIT____: attributes #[[ATTR9]] = { nofree nosync nounwind readnone }
; IS__TUNIT____: attributes #[[ATTR10]] = { nofree nosync nounwind }
;.
...
; IS__CGSCC____: attributes #[[ATTR8]] = { argmemonly nofree nosync nounwind }
...
; IS__CGSCC____: attributes #[[ATTR12]] = { nofree nosync nounwind }
; IS__CGSCC____: attributes #[[ATTR13]] = { nofree nosync nounwind writeonly }
; IS__CGSCC____: attributes #[[ATTR14]] = { nounwind writeonly }
; IS__CGSCC____: attributes #[[ATTR15]] = { nounwind readnone }
;.

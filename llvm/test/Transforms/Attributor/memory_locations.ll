...
; IS__CGSCC____-SAME: () [[ATTR6]]
; IS__CGSCC____-NEXT:    call void @write_global() [[ATTR12:#.*]]
; IS__CGSCC____-NEXT:    ret void
;
...
; IS__CGSCC____-SAME: () [[ATTR6]]
; IS__CGSCC____-NEXT:    call void @write_global_via_arg(i32* nocapture nofree noundef nonnull writeonly align 4 dereferenceable(4) @G) [[ATTR12]]
; IS__CGSCC____-NEXT:    ret void
;
...
; IS__CGSCC____-SAME: () [[ATTR6]]
; IS__CGSCC____-NEXT:    call void @write_global_via_arg_internal() [[ATTR12]]
; IS__CGSCC____-NEXT:    ret void
;
...
; CHECK-SAME: (i8* nocapture nofree writeonly [[PTR:%.*]], i1 [[C:%.*]]) [[ATTR8:#.*]]
; CHECK-NEXT:    [[ALLOC:%.*]] = alloca i8, align 1
; CHECK-NEXT:    br i1 [[C]], label [[T:%.*]], label [[F:%.*]]
; CHECK:       t:
; CHECK-NEXT:    [[TMP1:%.*]] = call i8 @recursive_not_readnone(i8* noalias nocapture nofree noundef nonnull writeonly dereferenceable(1) [[ALLOC]], i1 false) [[ATTR13:#.*]]
...
; IS__TUNIT____:       t:
; IS__TUNIT____-NEXT:    [[TMP1:%.*]] = call i8 @recursive_not_readnone_internal(i8* noalias nocapture nofree noundef nonnull writeonly dereferenceable(1) [[ALLOC]], i1 false) [[ATTR12:#.*]]
...
; IS__CGSCC____:       t:
; IS__CGSCC____-NEXT:    [[TMP1:%.*]] = call i8 @recursive_not_readnone_internal(i8* noalias nocapture nofree noundef nonnull writeonly dereferenceable(1) [[ALLOC]], i1 false) [[ATTR13:#.*]]
...
; CHECK-SAME: (i1 [[C:%.*]]) [[ATTR9:#.*]]
; CHECK-NEXT:    [[A:%.*]] = alloca i8, align 1
; CHECK-NEXT:    [[R:%.*]] = call i8 @recursive_not_readnone_internal(i8* noalias nocapture nofree noundef nonnull writeonly dereferenceable(1) [[A]], i1 [[C]]) [[ATTR14:#.*]]
; CHECK-NEXT:    ret i8 [[R]]
;
  %a = alloca i8
...
; IS__TUNIT____-NEXT:    br i1 [[C]], label [[T:%.*]], label [[F:%.*]]
; IS__TUNIT____:       t:
; IS__TUNIT____-NEXT:    [[TMP1:%.*]] = call i8 @recursive_not_readnone_internal2(i8* noalias nocapture nofree noundef nonnull writeonly dereferenceable(1) [[ALLOC]], i1 false) [[ATTR12]]
; IS__TUNIT____-NEXT:    [[R:%.*]] = load i8, i8* [[ALLOC]], align 1
; IS__TUNIT____-NEXT:    ret i8 [[R]]
; IS__TUNIT____:       f:
; IS__TUNIT____-NEXT:    store i8 1, i8* [[PTR]], align 1
...
; IS__CGSCC____-NEXT:    br i1 [[C]], label [[T:%.*]], label [[F:%.*]]
; IS__CGSCC____:       t:
; IS__CGSCC____-NEXT:    [[TMP1:%.*]] = call i8 @recursive_not_readnone_internal2(i8* noalias nocapture nofree noundef nonnull writeonly dereferenceable(1) [[ALLOC]], i1 false) [[ATTR13]]
; IS__CGSCC____-NEXT:    [[R:%.*]] = load i8, i8* [[ALLOC]], align 1
; IS__CGSCC____-NEXT:    ret i8 [[R]]
; IS__CGSCC____:       f:
; IS__CGSCC____-NEXT:    store i8 1, i8* [[PTR]], align 1
...
; CHECK-SAME: (i1 [[C:%.*]]) [[ATTR9]]
; CHECK-NEXT:    [[R:%.*]] = call i8 @recursive_not_readnone_internal2(i8* undef, i1 [[C]]) [[ATTR14]]
; CHECK-NEXT:    ret i8 [[R]]
;
...
; IS__CGSCC____-SAME: () [[ATTR6]]
; IS__CGSCC____-NEXT:    call void @argmemonly_before_ipconstprop() [[ATTR12]]
; IS__CGSCC____-NEXT:    ret void
;
...
; IS__TUNIT____-SAME: (i32* nocapture nofree nonnull writeonly align 4 dereferenceable(4) [[P:%.*]], i32* nocapture nofree nonnull readonly align 4 dereferenceable(4) [[Q:%.*]]) [[ATTR10:#.*]]
...
; IS__CGSCC____-SAME: (i32* nocapture nofree nonnull writeonly align 4 dereferenceable(4) [[P:%.*]], i32* nocapture nofree nonnull readonly align 4 dereferenceable(4) [[Q:%.*]]) [[ATTR10:#.*]]
...
; IS__TUNIT_OPM-NEXT:    call void @argmemonly_callee(i32* nocapture nofree noundef nonnull writeonly align 4 dereferenceable(4) [[L]], i32* nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) @G) [[ATTR11]]
...
; IS__TUNIT_NPM-SAME: () [[ATTR11:#.*]]
; IS__TUNIT_NPM-NEXT:    [[L:%.*]] = alloca i32, align 4
; IS__TUNIT_NPM-NEXT:    call void @argmemonly_callee(i32* noalias nocapture nofree noundef nonnull writeonly align 4 dereferenceable(4) [[L]], i32* nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) @G) [[ATTR11]]
...
; IS__CGSCC_OPM-NEXT:    call void @argmemonly_callee(i32* nocapture nofree noundef nonnull writeonly align 4 dereferenceable(4) [[L]], i32* nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) @G) [[ATTR15:#.*]]
; IS__CGSCC_OPM-NEXT:    ret void
;
...
; IS__CGSCC_NPM-NEXT:    call void @argmemonly_callee(i32* noalias nocapture nofree noundef nonnull writeonly align 4 dereferenceable(4) [[L]], i32* nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) @G) [[ATTR15:#.*]]
; IS__CGSCC_NPM-NEXT:    ret void
;
  %l = alloca i32

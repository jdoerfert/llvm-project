...
; IS________OPM: Function Attrs: inaccessiblememonly
; IS________OPM-LABEL: define {{[^@]+}}@internal_only
; IS________OPM-SAME: (i32 [[ARG:%.*]]) #[[ATTR0:[0-9]+]] {
; IS________OPM-NEXT:  entry:
; IS________OPM-NEXT:    [[CONV:%.*]] = sext i32 [[ARG]] to i64
; IS________OPM-NEXT:    [[CALL:%.*]] = call noalias i8* @malloc(i64 [[CONV]])
; IS________OPM-NEXT:    ret i8* [[CALL]]
;
; IS________NPM: Function Attrs: inaccessiblememonly
; IS________NPM-LABEL: define {{[^@]+}}@internal_only
; IS________NPM-SAME: (i32 [[ARG:%.*]]) #[[ATTR0:[0-9]+]] {
; IS________NPM-NEXT:  entry:
; IS________NPM-NEXT:    [[CONV:%.*]] = sext i32 [[ARG]] to i64
; IS________NPM-NEXT:    [[CALL:%.*]] = call i8* @malloc(i64 [[CONV]])
...
; CHECK-NEXT:    [[CALL:%.*]] = call i8* @internal_only_rec(i32 [[DIV]])
; CHECK-NEXT:    br label [[RETURN:%.*]]
; CHECK:       if.end:
; CHECK-NEXT:    [[CONV:%.*]] = sext i32 [[ARG]] to i64
; CHECK-NEXT:    [[CALL1:%.*]] = call i8* @malloc(i64 [[CONV]])
; CHECK-NEXT:    br label [[RETURN]]
; CHECK:       return:
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[CALL:%.*]] = call i8* @internal_only_rec_static(i32 [[ARG]])
...
; IS__TUNIT____-NEXT:    [[CALL:%.*]] = call i8* @internal_only_rec_static_malloc_noescape(i32 [[ARG]])
...
; IS__CGSCC____-NEXT:    [[CALL:%.*]] = call i8* @internal_only_rec_static_malloc_noescape(i32 [[ARG]])
...
; IS________OPM: Function Attrs: inaccessiblemem_or_argmemonly
; IS________OPM-LABEL: define {{[^@]+}}@internal_argmem_only_read
; IS________OPM-SAME: (i32* nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) [[ARG:%.*]]) #[[ATTR1:[0-9]+]] {
; IS________OPM-NEXT:  entry:
; IS________OPM-NEXT:    [[TMP:%.*]] = load i32, i32* [[ARG]], align 4
; IS________OPM-NEXT:    [[CONV:%.*]] = sext i32 [[TMP]] to i64
; IS________OPM-NEXT:    [[CALL:%.*]] = call noalias i8* @malloc(i64 [[CONV]])
; IS________OPM-NEXT:    ret i8* [[CALL]]
;
; IS________NPM: Function Attrs: inaccessiblemem_or_argmemonly
; IS________NPM-LABEL: define {{[^@]+}}@internal_argmem_only_read
; IS________NPM-SAME: (i32* nocapture nofree noundef nonnull readonly align 4 dereferenceable(4) [[ARG:%.*]]) #[[ATTR1:[0-9]+]] {
; IS________NPM-NEXT:  entry:
; IS________NPM-NEXT:    [[TMP:%.*]] = load i32, i32* [[ARG]], align 4
; IS________NPM-NEXT:    [[CONV:%.*]] = sext i32 [[TMP]] to i64
; IS________NPM-NEXT:    [[CALL:%.*]] = call i8* @malloc(i64 [[CONV]])
; IS________NPM-NEXT:    ret i8* [[CALL]]
;
entry:
...
; IS________OPM: Function Attrs: inaccessiblemem_or_argmemonly
; IS________OPM-LABEL: define {{[^@]+}}@internal_argmem_only_write
; IS________OPM-SAME: (i32* nocapture nofree noundef nonnull writeonly align 4 dereferenceable(4) [[ARG:%.*]]) #[[ATTR1]] {
; IS________OPM-NEXT:  entry:
; IS________OPM-NEXT:    store i32 10, i32* [[ARG]], align 4
; IS________OPM-NEXT:    [[CALL:%.*]] = call noalias dereferenceable_or_null(10) i8* @malloc(i64 noundef 10)
; IS________OPM-NEXT:    ret i8* [[CALL]]
;
; IS________NPM: Function Attrs: inaccessiblemem_or_argmemonly
; IS________NPM-LABEL: define {{[^@]+}}@internal_argmem_only_write
; IS________NPM-SAME: (i32* nocapture nofree noundef nonnull writeonly align 4 dereferenceable(4) [[ARG:%.*]]) #[[ATTR1]] {
; IS________NPM-NEXT:  entry:
; IS________NPM-NEXT:    store i32 10, i32* [[ARG]], align 4
; IS________NPM-NEXT:    [[CALL:%.*]] = call dereferenceable_or_null(10) i8* @malloc(i64 noundef 10)
; IS________NPM-NEXT:    ret i8* [[CALL]]
;
entry:
...
; IS__TUNIT____-SAME: (i32* nocapture nofree [[ARG:%.*]]) #[[ATTR1:[0-9]+]] {
; IS__TUNIT____-NEXT:  entry:
; IS__TUNIT____-NEXT:    [[CALL:%.*]] = call i8* @internal_argmem_only_rec_1(i32* nocapture nofree align 4 [[ARG]])
; IS__TUNIT____-NEXT:    ret i8* [[CALL]]
;
; IS__CGSCC____: Function Attrs: inaccessiblemem_or_argmemonly
; IS__CGSCC____-LABEL: define {{[^@]+}}@internal_argmem_only_rec
; IS__CGSCC____-SAME: (i32* nocapture nofree noundef nonnull align 4 dereferenceable(4) [[ARG:%.*]]) #[[ATTR1:[0-9]+]] {
; IS__CGSCC____-NEXT:  entry:
; IS__CGSCC____-NEXT:    [[CALL:%.*]] = call i8* @internal_argmem_only_rec_1(i32* nocapture nofree noundef nonnull align 4 dereferenceable(4) [[ARG]])
; IS__CGSCC____-NEXT:    ret i8* [[CALL]]
;
entry:
...
; CHECK-SAME: (i32* nocapture nofree noundef nonnull align 4 dereferenceable(4) [[ARG:%.*]]) #[[ATTR1:[0-9]+]] {
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    [[CALL:%.*]] = call i8* @internal_argmem_only_rec_2(i32* nocapture nofree nonnull align 4 dereferenceable(4) [[ADD_PTR]])
; CHECK-NEXT:    br label [[RETURN]]
; CHECK:       if.end3:
; CHECK-NEXT:    [[TMP2:%.*]] = load i32, i32* [[ARG]], align 4
; CHECK-NEXT:    [[CONV:%.*]] = sext i32 [[TMP2]] to i64
; CHECK-NEXT:    [[CALL4:%.*]] = call i8* @malloc(i64 [[CONV]])
; CHECK-NEXT:    br label [[RETURN]]
; CHECK:       return:
...
; CHECK-NEXT:    [[ADD_PTR:%.*]] = getelementptr inbounds i32, i32* [[ARG]], i64 -1
; CHECK-NEXT:    [[CALL:%.*]] = call i8* @internal_argmem_only_rec_1(i32* nocapture nofree nonnull align 4 dereferenceable(4) [[ADD_PTR]])
; CHECK-NEXT:    ret i8* [[CALL]]
;
entry:
...
; IS__TUNIT____: attributes #[[ATTR10]] = { nofree nosync nounwind willreturn writeonly }
; IS__TUNIT____: attributes #[[ATTR11]] = { nofree nosync nounwind writeonly }
;.

...
; RUN: opt -attributor -enable-new-pm=0 -attributor-manifest-internal  -attributor-max-iterations-verify -attributor-annotate-decl-cs -attributor-max-iterations=26 -S < %s | FileCheck %s --check-prefixes=CHECK,NOT_CGSCC_NPM,NOT_CGSCC_OPM,NOT_TUNIT_NPM,IS__TUNIT____,IS________OPM,IS__TUNIT_OPM
...
; NOT_CGSCC_NPM-NEXT:    call void @non_dead_b0() #[[ATTR2]]
; NOT_CGSCC_NPM-NEXT:    call void @non_dead_b1() #[[ATTR2]]
; NOT_CGSCC_NPM-NEXT:    call void @non_dead_b2() #[[ATTR2]]
; NOT_CGSCC_NPM-NEXT:    call void @non_dead_b3() #[[ATTR2]]
...
; NOT_CGSCC_NPM-NEXT:    call void @sink() #[[ATTR2]]
; NOT_CGSCC_NPM-NEXT:    ret void
;
...
; NOT_CGSCC_NPM: Function Attrs: nofree nounwind
...
; NOT_CGSCC_NPM: attributes #[[ATTR11]] = { nofree nounwind }

...
; TUNIT-SAME: () #[[ATTR13]] {
; TUNIT-NEXT:    call void @useless_arg_sink() #[[ATTR11]]
; TUNIT-NEXT:    ret void
;
; CGSCC: Function Attrs: mustprogress nofree nosync nounwind willreturn memory(readwrite, argmem: none)
...
; TUNIT-NEXT:    call void @call_via_pointer_with_dead_args(ptr [[A]], ptr noundef nonnull align 128 dereferenceable(4) [[PTR1]], ptr noalias nocapture nofree noundef readnone @called_via_pointer)
; TUNIT-NEXT:    call void @call_via_pointer_with_dead_args(ptr [[A]], ptr noundef nonnull align 128 dereferenceable(4) [[PTR2]], ptr noalias nocapture nofree noundef readnone @called_via_pointer_internal_1)
...
; CGSCC-NEXT:    call void @call_via_pointer_with_dead_args(ptr [[A]], ptr noundef nonnull align 128 dereferenceable(4) [[PTR1]], ptr noalias nocapture nofree noundef nonnull readnone @called_via_pointer)
; CGSCC-NEXT:    call void @call_via_pointer_with_dead_args(ptr [[A]], ptr noundef nonnull align 128 dereferenceable(4) [[PTR2]], ptr noalias nocapture nofree noundef nonnull readnone @called_via_pointer_internal_1)

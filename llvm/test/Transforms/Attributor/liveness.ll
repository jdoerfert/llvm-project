...
; MODULE-SAME: (i32* [[A:%.*]], void (i32*, i32*, i32*, i64, i32**)* nocapture nofree nonnull [[FP:%.*]])
; MODULE-NEXT:    call void @called_via_pointer(i32* [[A]], i32* nonnull align 128 dereferenceable(4) undef, i32* undef, i64 -1, i32** null)
...
; MODULE-SAME: (i32* [[A:%.*]], void (i32*, i32*, i32*, i64, i32**)* nocapture nofree nonnull [[FP:%.*]])
; MODULE-NEXT:    call void @called_via_pointer_internal_2(i32* [[A]], i32* nonnull align 128 dereferenceable(4) undef, i32* undef, i64 -1, i32** null)
; MODULE-NEXT:    ret void
;
...
; MODULE-NEXT:    call void @call_via_pointer_with_dead_args_internal_a(i32* [[B]], void (i32*, i32*, i32*, i64, i32**)* nofree nonnull @called_via_pointer)
; MODULE-NEXT:    call void @call_via_pointer_with_dead_args_internal_b(i32* [[B]], void (i32*, i32*, i32*, i64, i32**)* nofree nonnull @called_via_pointer_internal_2)
; MODULE-NEXT:    ret void
;

...
; IS________OPM-NEXT:    br i1 [[C1]], label [[EXIT2:%.*]], label [[EXIT]]
; IS________OPM:       cont:
; IS________OPM-NEXT:    call void @dummy(i1 [[F]]) #[[ATTR2:[0-9]+]]
; IS________OPM-NEXT:    br label [[EXIT2]]
; IS________OPM:       do:
; IS________OPM-NEXT:    call void @dummy(i1 [[F]]) #[[ATTR2]]
; IS________OPM-NEXT:    [[CONSUME:%.*]] = call i32 @exit()
; IS________OPM-NEXT:    call void @llvm.assume(i1 noundef [[F]])
; IS________OPM-NEXT:    [[COND:%.*]] = icmp eq i1 [[F]], false
; IS________OPM-NEXT:    br i1 [[COND]], label [[EXIT]], label [[CONT:%.*]]
; IS________OPM:       exit2:
; IS________OPM-NEXT:    ret i32 30
;
...
; IS________NPM-NEXT:    br i1 [[C1]], label [[EXIT2:%.*]], label [[EXIT]]
; IS________NPM:       cont:
; IS________NPM-NEXT:    call void @dummy(i1 true) #[[ATTR2:[0-9]+]]
; IS________NPM-NEXT:    br label [[EXIT2]]
; IS________NPM:       do:
; IS________NPM-NEXT:    call void @dummy(i1 [[F]]) #[[ATTR2]]
; IS________NPM-NEXT:    [[CONSUME:%.*]] = call i32 @exit()
; IS________NPM-NEXT:    call void @llvm.assume(i1 noundef [[F]])
; IS________NPM-NEXT:    [[COND:%.*]] = icmp eq i1 [[F]], false
; IS________NPM-NEXT:    br i1 [[COND]], label [[EXIT]], label [[CONT:%.*]]
; IS________NPM:       exit2:
; IS________NPM-NEXT:    ret i32 30
;
entry:

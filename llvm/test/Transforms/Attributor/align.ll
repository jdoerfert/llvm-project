...
; IS__CGSCC_NPM:       4:
; IS__CGSCC_NPM-NEXT:    [[TMP5:%.*]] = tail call i8* @f3(i8* nonnull @a2)
; IS__CGSCC_NPM-NEXT:    br label [[TMP6]]
; IS__CGSCC_NPM:       6:
...
; IS__CGSCC_NPM-NEXT:    [[TMP2:%.*]] = icmp eq i8* [[TMP0]], null
; IS__CGSCC_NPM-NEXT:    br i1 [[TMP2]], label [[TMP3:%.*]], label [[TMP4:%.*]]
; IS__CGSCC_NPM:       3:
; IS__CGSCC_NPM-NEXT:    br label [[TMP4]]
; IS__CGSCC_NPM:       4:
; IS__CGSCC_NPM-NEXT:    [[TMP5:%.*]] = phi i8* [ @a2, [[TMP3]] ], [ @a1, [[TMP1:%.*]] ]
; IS__CGSCC_NPM-NEXT:    ret i8* [[TMP5]]
;
  %2 = icmp eq i8* %0, null
  br i1 %2, label %3, label %5
...
; IS__CGSCC____:       mt:
; IS__CGSCC____-NEXT:    [[V:%.*]] = musttail call i32 @musttail_callee_1(i32* nocapture nofree noundef nonnull readonly dereferenceable(4) [[P]]) #[[ATTR12:[0-9]+]]
; IS__CGSCC____-NEXT:    ret i32 [[V]]
; IS__CGSCC____:       exit:

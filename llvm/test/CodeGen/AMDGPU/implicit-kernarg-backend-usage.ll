...
; GFX8V3:       ; %bb.0:
; GFX8V3-NEXT:    s_mov_b64 s[14:15], s[2:3]
; GFX8V3-NEXT:    s_mov_b64 s[12:13], s[0:1]
; GFX8V3-NEXT:    s_load_dwordx2 s[0:1], s[6:7], 0x0
; GFX8V3-NEXT:    s_add_u32 s12, s12, s9
; GFX8V3-NEXT:    s_addc_u32 s13, s13, 0
; GFX8V3-NEXT:    v_mov_b32_e32 v0, 1
; GFX8V3-NEXT:    v_mov_b32_e32 v1, 2
; GFX8V3-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8V3-NEXT:    v_mov_b32_e32 v2, s0
; GFX8V3-NEXT:    v_mov_b32_e32 v3, s1
; GFX8V3-NEXT:    s_mov_b32 m0, -1
; GFX8V3-NEXT:    buffer_store_dword v0, v2, s[12:15], 0 offen
; GFX8V3-NEXT:    s_waitcnt vmcnt(0)
; GFX8V3-NEXT:    ds_write_b32 v3, v1
; GFX8V3-NEXT:    s_endpgm
;
; GFX8V4-LABEL: addrspacecast:
; GFX8V4:       ; %bb.0:
; GFX8V4-NEXT:    s_mov_b64 s[14:15], s[2:3]
; GFX8V4-NEXT:    s_mov_b64 s[12:13], s[0:1]
; GFX8V4-NEXT:    s_load_dwordx2 s[0:1], s[6:7], 0x0
; GFX8V4-NEXT:    s_add_u32 s12, s12, s9
; GFX8V4-NEXT:    s_addc_u32 s13, s13, 0
; GFX8V4-NEXT:    v_mov_b32_e32 v0, 1
; GFX8V4-NEXT:    v_mov_b32_e32 v1, 2
; GFX8V4-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8V4-NEXT:    v_mov_b32_e32 v2, s0
; GFX8V4-NEXT:    v_mov_b32_e32 v3, s1
; GFX8V4-NEXT:    s_mov_b32 m0, -1
; GFX8V4-NEXT:    buffer_store_dword v0, v2, s[12:15], 0 offen
; GFX8V4-NEXT:    s_waitcnt vmcnt(0)
; GFX8V4-NEXT:    ds_write_b32 v3, v1
; GFX8V4-NEXT:    s_endpgm
;
; GFX8V5-LABEL: addrspacecast:
; GFX8V5:       ; %bb.0:
; GFX8V5-NEXT:    s_mov_b64 s[10:11], s[2:3]
; GFX8V5-NEXT:    s_mov_b64 s[8:9], s[0:1]
; GFX8V5-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
; GFX8V5-NEXT:    s_add_u32 s8, s8, s7
; GFX8V5-NEXT:    s_addc_u32 s9, s9, 0
; GFX8V5-NEXT:    v_mov_b32_e32 v0, 1
; GFX8V5-NEXT:    v_mov_b32_e32 v1, 2
; GFX8V5-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8V5-NEXT:    v_mov_b32_e32 v2, s0
; GFX8V5-NEXT:    v_mov_b32_e32 v3, s1
; GFX8V5-NEXT:    s_mov_b32 m0, -1
; GFX8V5-NEXT:    buffer_store_dword v0, v2, s[8:11], 0 offen
; GFX8V5-NEXT:    s_waitcnt vmcnt(0)
; GFX8V5-NEXT:    ds_write_b32 v3, v1
; GFX8V5-NEXT:    s_endpgm
;
; GFX9V3-LABEL: addrspacecast:
; GFX9V3:       ; %bb.0:
; GFX9V3-NEXT:    s_mov_b64 s[10:11], s[2:3]
; GFX9V3-NEXT:    s_mov_b64 s[8:9], s[0:1]
; GFX9V3-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
; GFX9V3-NEXT:    s_add_u32 s8, s8, s7
; GFX9V3-NEXT:    s_addc_u32 s9, s9, 0
; GFX9V3-NEXT:    v_mov_b32_e32 v0, 1
; GFX9V3-NEXT:    v_mov_b32_e32 v1, 2
; GFX9V3-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9V3-NEXT:    v_mov_b32_e32 v2, s0
; GFX9V3-NEXT:    v_mov_b32_e32 v3, s1
; GFX9V3-NEXT:    buffer_store_dword v0, v2, s[8:11], 0 offen
; GFX9V3-NEXT:    s_waitcnt vmcnt(0)
; GFX9V3-NEXT:    ds_write_b32 v3, v1
; GFX9V3-NEXT:    s_endpgm
;
; GFX9V4-LABEL: addrspacecast:
; GFX9V4:       ; %bb.0:
; GFX9V4-NEXT:    s_mov_b64 s[10:11], s[2:3]
; GFX9V4-NEXT:    s_mov_b64 s[8:9], s[0:1]
; GFX9V4-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
; GFX9V4-NEXT:    s_add_u32 s8, s8, s7
; GFX9V4-NEXT:    s_addc_u32 s9, s9, 0
; GFX9V4-NEXT:    v_mov_b32_e32 v0, 1
; GFX9V4-NEXT:    v_mov_b32_e32 v1, 2
; GFX9V4-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9V4-NEXT:    v_mov_b32_e32 v2, s0
; GFX9V4-NEXT:    v_mov_b32_e32 v3, s1
; GFX9V4-NEXT:    buffer_store_dword v0, v2, s[8:11], 0 offen
; GFX9V4-NEXT:    s_waitcnt vmcnt(0)
; GFX9V4-NEXT:    ds_write_b32 v3, v1
; GFX9V4-NEXT:    s_endpgm
;
; GFX9V5-LABEL: addrspacecast:
; GFX9V5:       ; %bb.0:
; GFX9V5-NEXT:    s_mov_b64 s[10:11], s[2:3]
; GFX9V5-NEXT:    s_mov_b64 s[8:9], s[0:1]
; GFX9V5-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
; GFX9V5-NEXT:    s_add_u32 s8, s8, s7
; GFX9V5-NEXT:    s_addc_u32 s9, s9, 0
; GFX9V5-NEXT:    v_mov_b32_e32 v0, 1
; GFX9V5-NEXT:    v_mov_b32_e32 v1, 2
; GFX9V5-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9V5-NEXT:    v_mov_b32_e32 v2, s0
; GFX9V5-NEXT:    v_mov_b32_e32 v3, s1
; GFX9V5-NEXT:    buffer_store_dword v0, v2, s[8:11], 0 offen
; GFX9V5-NEXT:    s_waitcnt vmcnt(0)
; GFX9V5-NEXT:    ds_write_b32 v3, v1

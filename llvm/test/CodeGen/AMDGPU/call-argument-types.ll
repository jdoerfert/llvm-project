...
; HSA-NEXT:    s_waitcnt vmcnt(0)
; HSA-NEXT:    v_mov_b32_e32 v4, v0
; HSA-NEXT:    v_mov_b32_e32 v5, v1
; HSA-NEXT:    v_mov_b32_e32 v6, v2
; HSA-NEXT:    v_mov_b32_e32 v7, v3
; HSA-NEXT:    s_swappc_b64 s[30:31], s[8:9]
; HSA-NEXT:    s_endpgm
...
; CI-NEXT:    v_mov_b32_e32 v12, v0
; CI-NEXT:    v_mov_b32_e32 v13, v1
; CI-NEXT:    v_mov_b32_e32 v14, v2
; CI-NEXT:    v_mov_b32_e32 v15, v3
; CI-NEXT:    s_swappc_b64 s[30:31], s[4:5]
; CI-NEXT:    s_endpgm
;
...
; HSA-NEXT:    v_mov_b32_e32 v6, v2
; HSA-NEXT:    v_mov_b32_e32 v7, v3
; HSA-NEXT:    v_mov_b32_e32 v8, v0
; HSA-NEXT:    v_mov_b32_e32 v9, v1
; HSA-NEXT:    v_mov_b32_e32 v10, v2
; HSA-NEXT:    v_mov_b32_e32 v11, v3
; HSA-NEXT:    v_mov_b32_e32 v12, v0
; HSA-NEXT:    v_mov_b32_e32 v13, v1
; HSA-NEXT:    v_mov_b32_e32 v14, v2
; HSA-NEXT:    v_mov_b32_e32 v15, v3
; HSA-NEXT:    s_swappc_b64 s[30:31], s[8:9]
; HSA-NEXT:    s_endpgm
  %ptr = load ptr addrspace(1), ptr addrspace(4) undef
...
; VI-NEXT:    s_mov_b64 s[2:3], s[38:39]
; VI-NEXT:    s_getpc_b64 s[4:5]
; VI-NEXT:    s_add_u32 s4, s4, external_void_func_v32i32@rel32@lo+4
; VI-NEXT:    s_addc_u32 s5, s5, external_void_func_v32i32@rel32@hi+12
; VI-NEXT:    s_waitcnt vmcnt(0)
; VI-NEXT:    v_mov_b32_e32 v4, v0
; VI-NEXT:    v_mov_b32_e32 v5, v1
; VI-NEXT:    v_mov_b32_e32 v6, v2
...
; VI-NEXT:    v_mov_b32_e32 v24, v0
; VI-NEXT:    v_mov_b32_e32 v25, v1
; VI-NEXT:    v_mov_b32_e32 v26, v2
; VI-NEXT:    v_mov_b32_e32 v27, v3
; VI-NEXT:    v_mov_b32_e32 v28, v0
; VI-NEXT:    v_mov_b32_e32 v29, v1
; VI-NEXT:    v_mov_b32_e32 v30, v2
; VI-NEXT:    buffer_store_dword v3, off, s[36:39], s32
; VI-NEXT:    s_swappc_b64 s[30:31], s[4:5]
; VI-NEXT:    s_endpgm
;
...
; CI-NEXT:    s_mov_b64 s[2:3], s[38:39]
; CI-NEXT:    s_getpc_b64 s[4:5]
; CI-NEXT:    s_add_u32 s4, s4, external_void_func_v32i32@rel32@lo+4
; CI-NEXT:    s_addc_u32 s5, s5, external_void_func_v32i32@rel32@hi+12
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    v_mov_b32_e32 v4, v0
; CI-NEXT:    v_mov_b32_e32 v5, v1
; CI-NEXT:    v_mov_b32_e32 v6, v2
...
; CI-NEXT:    v_mov_b32_e32 v20, v0
; CI-NEXT:    v_mov_b32_e32 v21, v1
; CI-NEXT:    v_mov_b32_e32 v22, v2
; CI-NEXT:    v_mov_b32_e32 v23, v3
; CI-NEXT:    v_mov_b32_e32 v24, v0
; CI-NEXT:    v_mov_b32_e32 v25, v1
; CI-NEXT:    v_mov_b32_e32 v26, v2
; CI-NEXT:    v_mov_b32_e32 v27, v3
; CI-NEXT:    v_mov_b32_e32 v28, v0
; CI-NEXT:    v_mov_b32_e32 v29, v1
; CI-NEXT:    v_mov_b32_e32 v30, v2
; CI-NEXT:    buffer_store_dword v3, off, s[36:39], s32
; CI-NEXT:    s_swappc_b64 s[30:31], s[4:5]
; CI-NEXT:    s_endpgm
;
...
; GFX9-NEXT:    buffer_store_dword v3, off, s[36:39], s32
; GFX9-NEXT:    s_swappc_b64 s[30:31], s[4:5]
; GFX9-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    scratch_store_b32 off, v3, s32
; GFX11-NEXT:    s_swappc_b64 s[30:31], s[2:3]
; GFX11-NEXT:    s_endpgm
;
...
; HSA-NEXT:    v_mov_b32_e32 v14, v2
; HSA-NEXT:    v_mov_b32_e32 v15, v3
; HSA-NEXT:    v_mov_b32_e32 v16, v0
; HSA-NEXT:    v_mov_b32_e32 v17, v1
; HSA-NEXT:    v_mov_b32_e32 v18, v2
; HSA-NEXT:    v_mov_b32_e32 v19, v3
; HSA-NEXT:    v_mov_b32_e32 v20, v0
; HSA-NEXT:    v_mov_b32_e32 v21, v1
; HSA-NEXT:    v_mov_b32_e32 v22, v2
; HSA-NEXT:    v_mov_b32_e32 v23, v3
; HSA-NEXT:    v_mov_b32_e32 v24, v0
; HSA-NEXT:    v_mov_b32_e32 v25, v1
; HSA-NEXT:    v_mov_b32_e32 v26, v2
; HSA-NEXT:    v_mov_b32_e32 v27, v3
; HSA-NEXT:    v_mov_b32_e32 v28, v0
; HSA-NEXT:    v_mov_b32_e32 v29, v1
; HSA-NEXT:    v_mov_b32_e32 v30, v2
; HSA-NEXT:    buffer_store_dword v3, off, s[0:3], s32
; HSA-NEXT:    s_swappc_b64 s[30:31], s[8:9]
; HSA-NEXT:    s_endpgm
  %ptr = load ptr addrspace(1), ptr addrspace(4) undef
...
; VI-NEXT:    s_mov_b32 s2, -1
; VI-NEXT:    buffer_load_dwordx4 v[0:3], off, s[0:3], 0
; VI-NEXT:    buffer_load_dword v4, off, s[0:3], 0
; VI-NEXT:    s_mov_b32 s36, SCRATCH_RSRC_DWORD0
; VI-NEXT:    s_mov_b32 s37, SCRATCH_RSRC_DWORD1
; VI-NEXT:    s_mov_b32 s38, -1
; VI-NEXT:    s_mov_b32 s39, 0xe80000
...
; VI-NEXT:    buffer_store_dword v3, off, s[36:39], s32
; VI-NEXT:    s_waitcnt vmcnt(1)
; VI-NEXT:    buffer_store_dword v4, off, s[36:39], s32 offset:4
; VI-NEXT:    v_mov_b32_e32 v4, v0
; VI-NEXT:    v_mov_b32_e32 v5, v1
; VI-NEXT:    v_mov_b32_e32 v6, v2
; VI-NEXT:    v_mov_b32_e32 v7, v3
...
; CI-NEXT:    s_mov_b32 s2, -1
; CI-NEXT:    buffer_load_dwordx4 v[0:3], off, s[0:3], 0
; CI-NEXT:    buffer_load_dword v4, off, s[0:3], 0
; CI-NEXT:    s_mov_b32 s36, SCRATCH_RSRC_DWORD0
; CI-NEXT:    s_mov_b32 s37, SCRATCH_RSRC_DWORD1
; CI-NEXT:    s_mov_b32 s38, -1
; CI-NEXT:    s_mov_b32 s39, 0xe8f000
...
; CI-NEXT:    buffer_store_dword v3, off, s[36:39], s32
; CI-NEXT:    s_waitcnt vmcnt(1)
; CI-NEXT:    buffer_store_dword v4, off, s[36:39], s32 offset:4
; CI-NEXT:    v_mov_b32_e32 v4, v0
; CI-NEXT:    v_mov_b32_e32 v5, v1
; CI-NEXT:    v_mov_b32_e32 v6, v2
; CI-NEXT:    v_mov_b32_e32 v7, v3
...
; GFX9-NEXT:    s_mov_b32 s2, -1
; GFX9-NEXT:    buffer_load_dwordx4 v[0:3], off, s[0:3], 0
; GFX9-NEXT:    buffer_load_dword v4, off, s[0:3], 0
; GFX9-NEXT:    s_mov_b32 s36, SCRATCH_RSRC_DWORD0
; GFX9-NEXT:    s_mov_b32 s37, SCRATCH_RSRC_DWORD1
; GFX9-NEXT:    s_mov_b32 s38, -1
; GFX9-NEXT:    s_mov_b32 s39, 0xe00000
...
; GFX9-NEXT:    buffer_store_dword v3, off, s[36:39], s32
; GFX9-NEXT:    s_waitcnt vmcnt(1)
; GFX9-NEXT:    buffer_store_dword v4, off, s[36:39], s32 offset:4
; GFX9-NEXT:    v_mov_b32_e32 v4, v0
; GFX9-NEXT:    v_mov_b32_e32 v5, v1
; GFX9-NEXT:    v_mov_b32_e32 v6, v2
; GFX9-NEXT:    v_mov_b32_e32 v7, v3
...
; GFX11-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], 0
; GFX11-NEXT:    buffer_load_b32 v4, off, s[0:3], 0
; GFX11-NEXT:    s_mov_b32 s32, 0
; GFX11-NEXT:    s_getpc_b64 s[2:3]
...
; GFX11-NEXT:    scratch_store_b32 off, v3, s32
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    scratch_store_b32 off, v4, s4
; GFX11-NEXT:    v_dual_mov_b32 v4, v0 :: v_dual_mov_b32 v5, v1
; GFX11-NEXT:    v_dual_mov_b32 v6, v2 :: v_dual_mov_b32 v7, v3
; GFX11-NEXT:    v_dual_mov_b32 v8, v0 :: v_dual_mov_b32 v9, v1
; GFX11-NEXT:    v_dual_mov_b32 v10, v2 :: v_dual_mov_b32 v11, v3
...
; HSA-NEXT:    s_mov_b32 s6, -1
; HSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[4:7], 0
; HSA-NEXT:    buffer_load_dword v4, off, s[4:7], 0
; HSA-NEXT:    s_add_i32 s8, s8, s11
; HSA-NEXT:    s_lshr_b32 flat_scratch_hi, s8, 8
; HSA-NEXT:    s_add_u32 s0, s0, s11
; HSA-NEXT:    s_mov_b32 s32, 0
...
; HSA-NEXT:    buffer_store_dword v3, off, s[0:3], s32
; HSA-NEXT:    s_waitcnt vmcnt(1)
; HSA-NEXT:    buffer_store_dword v4, off, s[0:3], s32 offset:4
; HSA-NEXT:    v_mov_b32_e32 v4, v0
; HSA-NEXT:    v_mov_b32_e32 v5, v1
; HSA-NEXT:    v_mov_b32_e32 v6, v2
; HSA-NEXT:    v_mov_b32_e32 v7, v3
...
; HSA-NEXT:    buffer_load_dword v1, off, s[4:7], 0
; HSA-NEXT:    s_add_u32 s0, s0, s9
; HSA-NEXT:    s_addc_u32 s1, s1, 0
; HSA-NEXT:    s_mov_b64 s[6:7], s[4:5]
; HSA-NEXT:    s_mov_b32 s32, 0

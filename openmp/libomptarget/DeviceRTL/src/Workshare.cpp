...
void __kmpc_for_static_init_4u_simple_spmd(IdentTy *loc, int32_t global_tid,
                                           int32_t schedtype,
...
void __kmpc_for_static_init_8u_simple_spmd(IdentTy *loc, int32_t global_tid,
                                           int32_t schedtype,
...
void __kmpc_for_static_init_4_simple_generic(IdentTy *loc, int32_t global_tid,
                                             int32_t schedtype,
                                             int32_t *plastiter,
                                             int32_t *plower, int32_t *pupper,
                                             int32_t *pstride, int32_t incr,
...
void __kmpc_for_static_init_8_simple_generic(IdentTy *loc, int32_t global_tid,
                                             int32_t schedtype,
                                             int32_t *plastiter,
                                             int64_t *plower, int64_t *pupper,
                                             int64_t *pstride, int64_t incr,
